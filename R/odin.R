...
tbmod0_ <- R6::R6Class(
  ...
  private = list(
    ...
    dll = "ecrins",
    user = c("CDR", "CFR", "drn", "eps", "inflow", "long_release",
             "long_short", "mHR", "open_release", "parm_frac_ATT",
             "parm_frac_CD", "parm_frac_E", "parm_frac_epTB", "parm_frac_L",
             "parm_frac_lpTB", "parm_frac_SD", "parm_frac_U",
             "parm_ifrac_ATT", "parm_ifrac_CD", "parm_ifrac_E",
             "parm_ifrac_epTB", "parm_ifrac_L", "parm_ifrac_lpTB",
             "parm_ifrac_prevTPT", "parm_ifrac_SD", "parm_ifrac_U",
             "parm_init_PPD", "previous_remand", "prg", "ptn", "rel",
             "remand_long", "remand_release", "remand_short", "short_open",
             "short_release", "stb", "txf", "wsn", "att_time", "disc_rate",
             "foi", "inflow_toATT_P", "inflow_toATT_rest", "inflow_toATT_TB",
             "inflow_toTPT_L", "late_post_time", "mort"),
