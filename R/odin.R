...
tbmod0_ <- R6::R6Class(
  ...
  private = list(
    ...
    user = c("CDR", "CFR", "drn", "eps", "inflow", "int_time",
             ...
             "hrqol", "hrqolptb", "inflow_notx_L0", "inflow_notx_L1",
             "inflow_notx_no0", "inflow_notx_no1", "inflow_notx_TB0",
             "inflow_notx_TB1", "inflow_toATT_L0", "inflow_toATT_L1",
             "inflow_toATT_no0", "inflow_toATT_no1", "inflow_toATT_TB0",
             "inflow_toATT_TB1", "inflow_toTPT_L0", "inflow_toTPT_L1",
             "inflow_toTPT_no0", "inflow_toTPT_no1", "inflow_toTPT_TB0",
             "inflow_toTPT_TB1", "late_post_time", "LifeExp", "m", "mort",
             "staticfoi", "tptHR", "uc_attout", "uc_attppd",
             "uc_entry_att_L", "uc_entry_att_no", "uc_entry_att_TB",
             "uc_entry_notx_L", "uc_entry_notx_no", "uc_entry_notx_TB",
             "uc_entry_tpt_L", "uc_entry_tpt_no", "uc_entry_tpt_TB"),
