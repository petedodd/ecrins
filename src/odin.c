...
SEXP tbmod0_create(SEXP user) {
  ...
  internal->offset_variable_ATT = internal->dim_CD + internal->dim_E + internal->dim_L + internal->dim_SD + internal->dim_U + 8;
  internal->offset_variable_CD = internal->dim_E + internal->dim_L + internal->dim_SD + internal->dim_U + 8;
  internal->offset_variable_E = internal->dim_U + 8;
  internal->offset_variable_epTB = internal->dim_ATT + internal->dim_CD + internal->dim_E + internal->dim_L + internal->dim_SD + internal->dim_U + 8;
  internal->offset_variable_L = internal->dim_E + internal->dim_U + 8;
  internal->offset_variable_lpTB = internal->dim_ATT + internal->dim_CD + internal->dim_E + internal->dim_epTB + internal->dim_L + internal->dim_SD + internal->dim_U + 8;
  internal->offset_variable_SD = internal->dim_E + internal->dim_L + internal->dim_U + 8;
  for (int i = 1; i <= 4; ++i) {
    internal->rfv[i - 1] = 1;
  }
  {
...
SEXP tbmod0_contents(SEXP internal_p) {
  ...
  SEXP contents = PROTECT(allocVector(VECSXP, 283));
  ...
  SET_VECTOR_ELT(contents, 179, ScalarReal(internal->initial_cATTfp));
  SET_VECTOR_ELT(contents, 180, ScalarReal(internal->initial_cATTtp));
  SET_VECTOR_ELT(contents, 181, ScalarReal(internal->initial_CC));
  SET_VECTOR_ELT(contents, 182, ScalarReal(internal->initial_CC0));
  ...
  SET_VECTOR_ELT(contents, 183, initial_CD);
  SET_VECTOR_ELT(contents, 184, ScalarReal(internal->initial_cTPT));
  SET_VECTOR_ELT(contents, 185, ScalarReal(internal->initial_deaths));
  SET_VECTOR_ELT(contents, 186, ScalarReal(internal->initial_dLYL));
  ...
  SET_VECTOR_ELT(contents, 187, initial_E);
  ...
  SET_VECTOR_ELT(contents, 188, initial_epTB);
  ...
  SET_VECTOR_ELT(contents, 189, initial_L);
  ...
  SET_VECTOR_ELT(contents, 190, initial_lpTB);
  SET_VECTOR_ELT(contents, 191, ScalarReal(internal->initial_qoldec));
  ...
  SET_VECTOR_ELT(contents, 192, initial_SD);
  ...
  SET_VECTOR_ELT(contents, 193, initial_U);
  SET_VECTOR_ELT(contents, 194, ScalarReal(internal->int_time));
  SET_VECTOR_ELT(contents, 195, ScalarReal(internal->late_post_time));
  SET_VECTOR_ELT(contents, 196, ScalarReal(internal->LifeExp));
  SET_VECTOR_ELT(contents, 197, ScalarReal(internal->long_release));
  SET_VECTOR_ELT(contents, 198, ScalarReal(internal->long_short));
  ...
  SET_VECTOR_ELT(contents, 199, Lreinfections);
  SET_VECTOR_ELT(contents, 200, ScalarReal(internal->m));
  SET_VECTOR_ELT(contents, 201, ScalarReal(internal->mHR));
  SET_VECTOR_ELT(contents, 202, ScalarReal(internal->mort));
  ...
  SET_VECTOR_ELT(contents, 203, moves_ATT);
  ...
  SET_VECTOR_ELT(contents, 204, moves_CD);
  ...
  SET_VECTOR_ELT(contents, 205, moves_E);
  ...
  SET_VECTOR_ELT(contents, 206, moves_epTB);
  ...
  SET_VECTOR_ELT(contents, 207, moves_L);
  ...
  SET_VECTOR_ELT(contents, 208, moves_lpTB);
  ...
  SET_VECTOR_ELT(contents, 209, moves_SD);
  ...
  SET_VECTOR_ELT(contents, 210, moves_U);
  ...
  SET_VECTOR_ELT(contents, 239, ppop);
  ...
  SET_VECTOR_ELT(contents, 240, Preinfections);
  SET_VECTOR_ELT(contents, 241, ScalarReal(internal->previous_remand));
  SET_VECTOR_ELT(contents, 242, ScalarReal(internal->prg));
  SET_VECTOR_ELT(contents, 243, ScalarReal(internal->ptn));
  ...
  SET_VECTOR_ELT(contents, 244, qolrate);
  ...
  SET_VECTOR_ELT(contents, 245, reinfections);
  SET_VECTOR_ELT(contents, 246, ScalarReal(internal->rel));
  ...
  SET_VECTOR_ELT(contents, 247, relapses);
  SET_VECTOR_ELT(contents, 248, ScalarReal(internal->remand_long));
  SET_VECTOR_ELT(contents, 249, ScalarReal(internal->remand_release));
  SET_VECTOR_ELT(contents, 250, ScalarReal(internal->remand_short));
  SEXP rfv = PROTECT(allocVector(REALSXP, internal->dim_rfv));
  memcpy(REAL(rfv), internal->rfv, internal->dim_rfv * sizeof(double));
  SET_VECTOR_ELT(contents, 251, rfv);
  ...
  SET_VECTOR_ELT(contents, 252, selfcures);
  SET_VECTOR_ELT(contents, 253, ScalarReal(internal->short_open));
  SET_VECTOR_ELT(contents, 254, ScalarReal(internal->short_release));
  ...
  SET_VECTOR_ELT(contents, 255, slowprogs);
  ...
  SET_VECTOR_ELT(contents, 256, stabilizations);
  SET_VECTOR_ELT(contents, 257, ScalarReal(internal->staticfoi));
  SET_VECTOR_ELT(contents, 258, ScalarReal(internal->stb));
  ...
  SET_VECTOR_ELT(contents, 259, tbmort);
  ...
  SET_VECTOR_ELT(contents, 260, tbstops);
  SET_VECTOR_ELT(contents, 261, ScalarReal(internal->tpt_drn));
  ...
  SET_VECTOR_ELT(contents, 262, tpt_E);
  ...
  SET_VECTOR_ELT(contents, 263, tpt_epTB);
  ...
  SET_VECTOR_ELT(contents, 264, tpt_L);
  ...
  SET_VECTOR_ELT(contents, 265, tpt_lpTB);
  ...
  SET_VECTOR_ELT(contents, 266, TPT_mid);
  ...
  SET_VECTOR_ELT(contents, 267, TPT_top);
  SET_VECTOR_ELT(contents, 268, ScalarReal(internal->tptHR));
  SET_VECTOR_ELT(contents, 269, ScalarReal(internal->txf));
  SET_VECTOR_ELT(contents, 270, ScalarReal(internal->uc_attout));
  SET_VECTOR_ELT(contents, 271, ScalarReal(internal->uc_attppd));
  SET_VECTOR_ELT(contents, 272, ScalarReal(internal->uc_entry_att_L));
  SET_VECTOR_ELT(contents, 273, ScalarReal(internal->uc_entry_att_no));
  SET_VECTOR_ELT(contents, 274, ScalarReal(internal->uc_entry_att_TB));
  SET_VECTOR_ELT(contents, 275, ScalarReal(internal->uc_entry_notx_L));
  SET_VECTOR_ELT(contents, 276, ScalarReal(internal->uc_entry_notx_no));
  SET_VECTOR_ELT(contents, 277, ScalarReal(internal->uc_entry_notx_TB));
  SET_VECTOR_ELT(contents, 278, ScalarReal(internal->uc_entry_tpt_L));
  SET_VECTOR_ELT(contents, 279, ScalarReal(internal->uc_entry_tpt_no));
  SET_VECTOR_ELT(contents, 280, ScalarReal(internal->uc_entry_tpt_TB));
  ...
  SET_VECTOR_ELT(contents, 281, worsens);
  SET_VECTOR_ELT(contents, 282, ScalarReal(internal->wsn));
  SEXP nms = PROTECT(allocVector(STRSXP, 283));
  ...
  SET_STRING_ELT(nms, 179, mkChar("initial_cATTfp"));
  SET_STRING_ELT(nms, 180, mkChar("initial_cATTtp"));
  SET_STRING_ELT(nms, 181, mkChar("initial_CC"));
  SET_STRING_ELT(nms, 182, mkChar("initial_CC0"));
  SET_STRING_ELT(nms, 183, mkChar("initial_CD"));
  SET_STRING_ELT(nms, 184, mkChar("initial_cTPT"));
  SET_STRING_ELT(nms, 185, mkChar("initial_deaths"));
  SET_STRING_ELT(nms, 186, mkChar("initial_dLYL"));
  SET_STRING_ELT(nms, 187, mkChar("initial_E"));
  SET_STRING_ELT(nms, 188, mkChar("initial_epTB"));
  SET_STRING_ELT(nms, 189, mkChar("initial_L"));
  SET_STRING_ELT(nms, 190, mkChar("initial_lpTB"));
  SET_STRING_ELT(nms, 191, mkChar("initial_qoldec"));
  SET_STRING_ELT(nms, 192, mkChar("initial_SD"));
  SET_STRING_ELT(nms, 193, mkChar("initial_U"));
  SET_STRING_ELT(nms, 194, mkChar("int_time"));
  SET_STRING_ELT(nms, 195, mkChar("late_post_time"));
  SET_STRING_ELT(nms, 196, mkChar("LifeExp"));
  SET_STRING_ELT(nms, 197, mkChar("long_release"));
  SET_STRING_ELT(nms, 198, mkChar("long_short"));
  SET_STRING_ELT(nms, 199, mkChar("Lreinfections"));
  SET_STRING_ELT(nms, 200, mkChar("m"));
  SET_STRING_ELT(nms, 201, mkChar("mHR"));
  SET_STRING_ELT(nms, 202, mkChar("mort"));
  SET_STRING_ELT(nms, 203, mkChar("moves_ATT"));
  SET_STRING_ELT(nms, 204, mkChar("moves_CD"));
  SET_STRING_ELT(nms, 205, mkChar("moves_E"));
  SET_STRING_ELT(nms, 206, mkChar("moves_epTB"));
  SET_STRING_ELT(nms, 207, mkChar("moves_L"));
  SET_STRING_ELT(nms, 208, mkChar("moves_lpTB"));
  SET_STRING_ELT(nms, 209, mkChar("moves_SD"));
  SET_STRING_ELT(nms, 210, mkChar("moves_U"));
  ...
  SET_STRING_ELT(nms, 239, mkChar("ppop"));
  SET_STRING_ELT(nms, 240, mkChar("Preinfections"));
  SET_STRING_ELT(nms, 241, mkChar("previous_remand"));
  SET_STRING_ELT(nms, 242, mkChar("prg"));
  SET_STRING_ELT(nms, 243, mkChar("ptn"));
  SET_STRING_ELT(nms, 244, mkChar("qolrate"));
  SET_STRING_ELT(nms, 245, mkChar("reinfections"));
  SET_STRING_ELT(nms, 246, mkChar("rel"));
  SET_STRING_ELT(nms, 247, mkChar("relapses"));
  SET_STRING_ELT(nms, 248, mkChar("remand_long"));
  SET_STRING_ELT(nms, 249, mkChar("remand_release"));
  SET_STRING_ELT(nms, 250, mkChar("remand_short"));
  SET_STRING_ELT(nms, 251, mkChar("rfv"));
  SET_STRING_ELT(nms, 252, mkChar("selfcures"));
  SET_STRING_ELT(nms, 253, mkChar("short_open"));
  SET_STRING_ELT(nms, 254, mkChar("short_release"));
  SET_STRING_ELT(nms, 255, mkChar("slowprogs"));
  SET_STRING_ELT(nms, 256, mkChar("stabilizations"));
  SET_STRING_ELT(nms, 257, mkChar("staticfoi"));
  SET_STRING_ELT(nms, 258, mkChar("stb"));
  SET_STRING_ELT(nms, 259, mkChar("tbmort"));
  SET_STRING_ELT(nms, 260, mkChar("tbstops"));
  SET_STRING_ELT(nms, 261, mkChar("tpt_drn"));
  SET_STRING_ELT(nms, 262, mkChar("tpt_E"));
  SET_STRING_ELT(nms, 263, mkChar("tpt_epTB"));
  SET_STRING_ELT(nms, 264, mkChar("tpt_L"));
  SET_STRING_ELT(nms, 265, mkChar("tpt_lpTB"));
  SET_STRING_ELT(nms, 266, mkChar("TPT_mid"));
  SET_STRING_ELT(nms, 267, mkChar("TPT_top"));
  SET_STRING_ELT(nms, 268, mkChar("tptHR"));
  SET_STRING_ELT(nms, 269, mkChar("txf"));
  SET_STRING_ELT(nms, 270, mkChar("uc_attout"));
  SET_STRING_ELT(nms, 271, mkChar("uc_attppd"));
  SET_STRING_ELT(nms, 272, mkChar("uc_entry_att_L"));
  SET_STRING_ELT(nms, 273, mkChar("uc_entry_att_no"));
  SET_STRING_ELT(nms, 274, mkChar("uc_entry_att_TB"));
  SET_STRING_ELT(nms, 275, mkChar("uc_entry_notx_L"));
  SET_STRING_ELT(nms, 276, mkChar("uc_entry_notx_no"));
  SET_STRING_ELT(nms, 277, mkChar("uc_entry_notx_TB"));
  SET_STRING_ELT(nms, 278, mkChar("uc_entry_tpt_L"));
  SET_STRING_ELT(nms, 279, mkChar("uc_entry_tpt_no"));
  SET_STRING_ELT(nms, 280, mkChar("uc_entry_tpt_TB"));
  SET_STRING_ELT(nms, 281, mkChar("worsens"));
  SET_STRING_ELT(nms, 282, mkChar("wsn"));
...
SEXP tbmod0_metadata(SEXP internal_p) {
  ...
  SET_STRING_ELT(variable_names, 8, mkChar("U"));
  SET_STRING_ELT(variable_names, 9, mkChar("E"));
  SET_STRING_ELT(variable_names, 10, mkChar("L"));
  SET_STRING_ELT(variable_names, 11, mkChar("SD"));
  SET_STRING_ELT(variable_names, 12, mkChar("CD"));
  SET_STRING_ELT(variable_names, 13, mkChar("ATT"));
  SET_STRING_ELT(variable_names, 14, mkChar("epTB"));
  SET_STRING_ELT(variable_names, 15, mkChar("lpTB"));
...
SEXP tbmod0_initial_conditions(SEXP internal_p, SEXP t_ptr) {
  tbmod0_internal *internal = tbmod0_get_internal(internal_p, 1);
  SEXP r_state = PROTECT(allocVector(REALSXP, internal->dim_ATT + internal->dim_CD + internal->dim_E + internal->dim_epTB + internal->dim_L + internal->dim_lpTB + internal->dim_SD + internal->dim_U + 8));
  ...
  memcpy(state + 8, internal->initial_U, internal->dim_U * sizeof(double));
...
void tbmod0_rhs(tbmod0_internal* internal, double t, double * state, double * dstatedt, double * output) {
  ...
  for (int i = 1; i <= internal->dim_U_1; ++i) {
    for (int j = 1; j <= internal->dim_U_2; ++j) {
      dstatedt[8 + i - 1 + internal->dim_U_1 * (j - 1)] = -(internal->infections[internal->dim_infections_1 * (j - 1) + i - 1]) - internal->mort * U[internal->dim_U_1 * (j - 1) + i - 1] + internal->inflow * internal->frac_U[internal->dim_frac_U_1 * (j - 1) + i - 1] + internal->moves_U[internal->dim_moves_U_1 * (j - 1) + i - 1];
    }
  }
