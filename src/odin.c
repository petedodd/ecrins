...
SEXP tbmod0_contents(SEXP internal_p) {
  ...
  SEXP contents = PROTECT(allocVector(VECSXP, 285));
  ...
  SET_VECTOR_ELT(contents, 164, ScalarReal(internal->inflow_toATT_L0));
  SET_VECTOR_ELT(contents, 165, ScalarReal(internal->inflow_toATT_L1));
  SET_VECTOR_ELT(contents, 166, ScalarReal(internal->inflow_toATT_no0));
  SET_VECTOR_ELT(contents, 167, ScalarReal(internal->inflow_toATT_no1));
  SET_VECTOR_ELT(contents, 168, ScalarReal(internal->inflow_toATT_TB0));
  SET_VECTOR_ELT(contents, 169, ScalarReal(internal->inflow_toATT_TB1));
  ...
  SET_VECTOR_ELT(contents, 170, inflow_top);
  SET_VECTOR_ELT(contents, 171, ScalarReal(internal->inflow_toTPT_L0));
  SET_VECTOR_ELT(contents, 172, ScalarReal(internal->inflow_toTPT_L1));
  SET_VECTOR_ELT(contents, 173, ScalarReal(internal->inflow_toTPT_no0));
  SET_VECTOR_ELT(contents, 174, ScalarReal(internal->inflow_toTPT_no1));
  SET_VECTOR_ELT(contents, 175, ScalarReal(internal->inflow_toTPT_TB0));
  SET_VECTOR_ELT(contents, 176, ScalarReal(internal->inflow_toTPT_TB1));
  ...
  SET_VECTOR_ELT(contents, 177, inflow_TPTv);
  ...
  SET_VECTOR_ELT(contents, 178, initial_ATT);
  SET_VECTOR_ELT(contents, 179, ScalarReal(internal->initial_cases));
  SET_VECTOR_ELT(contents, 180, ScalarReal(internal->initial_casesout));
  SET_VECTOR_ELT(contents, 181, ScalarReal(internal->initial_cATTfp));
  SET_VECTOR_ELT(contents, 182, ScalarReal(internal->initial_cATTtp));
  SET_VECTOR_ELT(contents, 183, ScalarReal(internal->initial_CC));
  SET_VECTOR_ELT(contents, 184, ScalarReal(internal->initial_CC0));
  ...
  SET_VECTOR_ELT(contents, 185, initial_CD);
  SET_VECTOR_ELT(contents, 186, ScalarReal(internal->initial_cTPT));
  SET_VECTOR_ELT(contents, 187, ScalarReal(internal->initial_deaths));
  SET_VECTOR_ELT(contents, 188, ScalarReal(internal->initial_dLYL));
  ...
  SET_VECTOR_ELT(contents, 189, initial_E);
  ...
  SET_VECTOR_ELT(contents, 190, initial_epTB);
  ...
  SET_VECTOR_ELT(contents, 191, initial_L);
  ...
  SET_VECTOR_ELT(contents, 192, initial_lpTB);
  SET_VECTOR_ELT(contents, 193, ScalarReal(internal->initial_qoldec));
  ...
  SET_VECTOR_ELT(contents, 194, initial_SD);
  ...
  SET_VECTOR_ELT(contents, 195, initial_U);
  SET_VECTOR_ELT(contents, 196, ScalarReal(internal->int_time));
  SET_VECTOR_ELT(contents, 197, ScalarReal(internal->late_post_time));
  SET_VECTOR_ELT(contents, 198, ScalarReal(internal->LifeExp));
  SET_VECTOR_ELT(contents, 199, ScalarReal(internal->long_release));
  SET_VECTOR_ELT(contents, 200, ScalarReal(internal->long_short));
  ...
  SET_VECTOR_ELT(contents, 201, Lreinfections);
  SET_VECTOR_ELT(contents, 202, ScalarReal(internal->m));
  SET_VECTOR_ELT(contents, 203, ScalarReal(internal->mHR));
  SET_VECTOR_ELT(contents, 204, ScalarReal(internal->mort));
  ...
  SET_VECTOR_ELT(contents, 205, moves_ATT);
  ...
  SET_VECTOR_ELT(contents, 206, moves_CD);
  ...
  SET_VECTOR_ELT(contents, 207, moves_E);
  ...
  SET_VECTOR_ELT(contents, 208, moves_epTB);
  ...
  SET_VECTOR_ELT(contents, 209, moves_L);
  ...
  SET_VECTOR_ELT(contents, 210, moves_lpTB);
  ...
  SET_VECTOR_ELT(contents, 211, moves_SD);
  ...
  SET_VECTOR_ELT(contents, 212, moves_U);
  SET_VECTOR_ELT(contents, 213, ScalarInteger(internal->NP));
  SET_VECTOR_ELT(contents, 214, ScalarInteger(internal->NT));
  SET_VECTOR_ELT(contents, 215, ScalarInteger(internal->offset_variable_ATT));
  SET_VECTOR_ELT(contents, 216, ScalarInteger(internal->offset_variable_CD));
  SET_VECTOR_ELT(contents, 217, ScalarInteger(internal->offset_variable_E));
  SET_VECTOR_ELT(contents, 218, ScalarInteger(internal->offset_variable_epTB));
  SET_VECTOR_ELT(contents, 219, ScalarInteger(internal->offset_variable_L));
  SET_VECTOR_ELT(contents, 220, ScalarInteger(internal->offset_variable_lpTB));
  SET_VECTOR_ELT(contents, 221, ScalarInteger(internal->offset_variable_SD));
  SET_VECTOR_ELT(contents, 222, ScalarReal(internal->open_release));
  SET_VECTOR_ELT(contents, 223, ScalarReal(internal->parm_frac_ATT));
  SET_VECTOR_ELT(contents, 224, ScalarReal(internal->parm_frac_CD));
  SET_VECTOR_ELT(contents, 225, ScalarReal(internal->parm_frac_E));
  SET_VECTOR_ELT(contents, 226, ScalarReal(internal->parm_frac_epTB));
  SET_VECTOR_ELT(contents, 227, ScalarReal(internal->parm_frac_L));
  SET_VECTOR_ELT(contents, 228, ScalarReal(internal->parm_frac_lpTB));
  SET_VECTOR_ELT(contents, 229, ScalarReal(internal->parm_frac_SD));
  SET_VECTOR_ELT(contents, 230, ScalarReal(internal->parm_frac_U));
  SET_VECTOR_ELT(contents, 231, ScalarReal(internal->parm_ifrac_ATT));
  SET_VECTOR_ELT(contents, 232, ScalarReal(internal->parm_ifrac_CD));
  SET_VECTOR_ELT(contents, 233, ScalarReal(internal->parm_ifrac_E));
  SET_VECTOR_ELT(contents, 234, ScalarReal(internal->parm_ifrac_epTB));
  SET_VECTOR_ELT(contents, 235, ScalarReal(internal->parm_ifrac_L));
  SET_VECTOR_ELT(contents, 236, ScalarReal(internal->parm_ifrac_lpTB));
  ...
  SET_VECTOR_ELT(contents, 237, parm_ifrac_prevTPT);
  SET_VECTOR_ELT(contents, 238, ScalarReal(internal->parm_ifrac_SD));
  SET_VECTOR_ELT(contents, 239, ScalarReal(internal->parm_ifrac_U));
  ...
  SET_VECTOR_ELT(contents, 240, parm_init_PPD);
  ...
  SET_VECTOR_ELT(contents, 241, ppop);
  ...
  SET_VECTOR_ELT(contents, 242, Preinfections);
  SET_VECTOR_ELT(contents, 243, ScalarReal(internal->previous_remand));
  SET_VECTOR_ELT(contents, 244, ScalarReal(internal->prg));
  SET_VECTOR_ELT(contents, 245, ScalarReal(internal->ptn));
  ...
  SET_VECTOR_ELT(contents, 246, qolrate);
  ...
  SET_VECTOR_ELT(contents, 247, reinfections);
  SET_VECTOR_ELT(contents, 248, ScalarReal(internal->rel));
  ...
  SET_VECTOR_ELT(contents, 249, relapses);
  SET_VECTOR_ELT(contents, 250, ScalarReal(internal->remand_long));
  SET_VECTOR_ELT(contents, 251, ScalarReal(internal->remand_release));
  SET_VECTOR_ELT(contents, 252, ScalarReal(internal->remand_short));
  SEXP rfv = PROTECT(allocVector(REALSXP, internal->dim_rfv));
  memcpy(REAL(rfv), internal->rfv, internal->dim_rfv * sizeof(double));
  SET_VECTOR_ELT(contents, 253, rfv);
  ...
  SET_VECTOR_ELT(contents, 254, selfcures);
  SET_VECTOR_ELT(contents, 255, ScalarReal(internal->short_open));
  SET_VECTOR_ELT(contents, 256, ScalarReal(internal->short_release));
  ...
  SET_VECTOR_ELT(contents, 257, slowprogs);
  ...
  SET_VECTOR_ELT(contents, 258, stabilizations);
  SET_VECTOR_ELT(contents, 259, ScalarReal(internal->staticfoi));
  SET_VECTOR_ELT(contents, 260, ScalarReal(internal->stb));
  ...
  SET_VECTOR_ELT(contents, 261, tbmort);
  ...
  SET_VECTOR_ELT(contents, 262, tbstops);
  SET_VECTOR_ELT(contents, 263, ScalarReal(internal->tpt_drn));
  ...
  SET_VECTOR_ELT(contents, 264, tpt_E);
  ...
  SET_VECTOR_ELT(contents, 265, tpt_epTB);
  ...
  SET_VECTOR_ELT(contents, 266, tpt_L);
  ...
  SET_VECTOR_ELT(contents, 267, tpt_lpTB);
  ...
  SET_VECTOR_ELT(contents, 268, TPT_mid);
  ...
  SET_VECTOR_ELT(contents, 269, TPT_top);
  SET_VECTOR_ELT(contents, 270, ScalarReal(internal->tptHR));
  SET_VECTOR_ELT(contents, 271, ScalarReal(internal->txf));
  SET_VECTOR_ELT(contents, 272, ScalarReal(internal->uc_attout));
  SET_VECTOR_ELT(contents, 273, ScalarReal(internal->uc_attppd));
  SET_VECTOR_ELT(contents, 274, ScalarReal(internal->uc_entry_att_L));
  SET_VECTOR_ELT(contents, 275, ScalarReal(internal->uc_entry_att_no));
  SET_VECTOR_ELT(contents, 276, ScalarReal(internal->uc_entry_att_TB));
  SET_VECTOR_ELT(contents, 277, ScalarReal(internal->uc_entry_notx_L));
  SET_VECTOR_ELT(contents, 278, ScalarReal(internal->uc_entry_notx_no));
  SET_VECTOR_ELT(contents, 279, ScalarReal(internal->uc_entry_notx_TB));
  SET_VECTOR_ELT(contents, 280, ScalarReal(internal->uc_entry_tpt_L));
  SET_VECTOR_ELT(contents, 281, ScalarReal(internal->uc_entry_tpt_no));
  SET_VECTOR_ELT(contents, 282, ScalarReal(internal->uc_entry_tpt_TB));
  ...
  SET_VECTOR_ELT(contents, 283, worsens);
  SET_VECTOR_ELT(contents, 284, ScalarReal(internal->wsn));
  SEXP nms = PROTECT(allocVector(STRSXP, 285));
  ...
  SET_STRING_ELT(nms, 164, mkChar("inflow_toATT_L0"));
  SET_STRING_ELT(nms, 165, mkChar("inflow_toATT_L1"));
  SET_STRING_ELT(nms, 166, mkChar("inflow_toATT_no0"));
  SET_STRING_ELT(nms, 167, mkChar("inflow_toATT_no1"));
  SET_STRING_ELT(nms, 168, mkChar("inflow_toATT_TB0"));
  SET_STRING_ELT(nms, 169, mkChar("inflow_toATT_TB1"));
  SET_STRING_ELT(nms, 170, mkChar("inflow_top"));
  SET_STRING_ELT(nms, 171, mkChar("inflow_toTPT_L0"));
  SET_STRING_ELT(nms, 172, mkChar("inflow_toTPT_L1"));
  SET_STRING_ELT(nms, 173, mkChar("inflow_toTPT_no0"));
  SET_STRING_ELT(nms, 174, mkChar("inflow_toTPT_no1"));
  SET_STRING_ELT(nms, 175, mkChar("inflow_toTPT_TB0"));
  SET_STRING_ELT(nms, 176, mkChar("inflow_toTPT_TB1"));
  SET_STRING_ELT(nms, 177, mkChar("inflow_TPTv"));
  SET_STRING_ELT(nms, 178, mkChar("initial_ATT"));
  SET_STRING_ELT(nms, 179, mkChar("initial_cases"));
  SET_STRING_ELT(nms, 180, mkChar("initial_casesout"));
  SET_STRING_ELT(nms, 181, mkChar("initial_cATTfp"));
  SET_STRING_ELT(nms, 182, mkChar("initial_cATTtp"));
  SET_STRING_ELT(nms, 183, mkChar("initial_CC"));
  SET_STRING_ELT(nms, 184, mkChar("initial_CC0"));
  SET_STRING_ELT(nms, 185, mkChar("initial_CD"));
  SET_STRING_ELT(nms, 186, mkChar("initial_cTPT"));
  SET_STRING_ELT(nms, 187, mkChar("initial_deaths"));
  SET_STRING_ELT(nms, 188, mkChar("initial_dLYL"));
  SET_STRING_ELT(nms, 189, mkChar("initial_E"));
  SET_STRING_ELT(nms, 190, mkChar("initial_epTB"));
  SET_STRING_ELT(nms, 191, mkChar("initial_L"));
  SET_STRING_ELT(nms, 192, mkChar("initial_lpTB"));
  SET_STRING_ELT(nms, 193, mkChar("initial_qoldec"));
  SET_STRING_ELT(nms, 194, mkChar("initial_SD"));
  SET_STRING_ELT(nms, 195, mkChar("initial_U"));
  SET_STRING_ELT(nms, 196, mkChar("int_time"));
  SET_STRING_ELT(nms, 197, mkChar("late_post_time"));
  SET_STRING_ELT(nms, 198, mkChar("LifeExp"));
  SET_STRING_ELT(nms, 199, mkChar("long_release"));
  SET_STRING_ELT(nms, 200, mkChar("long_short"));
  SET_STRING_ELT(nms, 201, mkChar("Lreinfections"));
  SET_STRING_ELT(nms, 202, mkChar("m"));
  SET_STRING_ELT(nms, 203, mkChar("mHR"));
  SET_STRING_ELT(nms, 204, mkChar("mort"));
  SET_STRING_ELT(nms, 205, mkChar("moves_ATT"));
  SET_STRING_ELT(nms, 206, mkChar("moves_CD"));
  SET_STRING_ELT(nms, 207, mkChar("moves_E"));
  SET_STRING_ELT(nms, 208, mkChar("moves_epTB"));
  SET_STRING_ELT(nms, 209, mkChar("moves_L"));
  SET_STRING_ELT(nms, 210, mkChar("moves_lpTB"));
  SET_STRING_ELT(nms, 211, mkChar("moves_SD"));
  SET_STRING_ELT(nms, 212, mkChar("moves_U"));
  SET_STRING_ELT(nms, 213, mkChar("NP"));
  SET_STRING_ELT(nms, 214, mkChar("NT"));
  SET_STRING_ELT(nms, 215, mkChar("offset_variable_ATT"));
  SET_STRING_ELT(nms, 216, mkChar("offset_variable_CD"));
  SET_STRING_ELT(nms, 217, mkChar("offset_variable_E"));
  SET_STRING_ELT(nms, 218, mkChar("offset_variable_epTB"));
  SET_STRING_ELT(nms, 219, mkChar("offset_variable_L"));
  SET_STRING_ELT(nms, 220, mkChar("offset_variable_lpTB"));
  SET_STRING_ELT(nms, 221, mkChar("offset_variable_SD"));
  SET_STRING_ELT(nms, 222, mkChar("open_release"));
  SET_STRING_ELT(nms, 223, mkChar("parm_frac_ATT"));
  SET_STRING_ELT(nms, 224, mkChar("parm_frac_CD"));
  SET_STRING_ELT(nms, 225, mkChar("parm_frac_E"));
  SET_STRING_ELT(nms, 226, mkChar("parm_frac_epTB"));
  SET_STRING_ELT(nms, 227, mkChar("parm_frac_L"));
  SET_STRING_ELT(nms, 228, mkChar("parm_frac_lpTB"));
  SET_STRING_ELT(nms, 229, mkChar("parm_frac_SD"));
  SET_STRING_ELT(nms, 230, mkChar("parm_frac_U"));
  SET_STRING_ELT(nms, 231, mkChar("parm_ifrac_ATT"));
  SET_STRING_ELT(nms, 232, mkChar("parm_ifrac_CD"));
  SET_STRING_ELT(nms, 233, mkChar("parm_ifrac_E"));
  SET_STRING_ELT(nms, 234, mkChar("parm_ifrac_epTB"));
  SET_STRING_ELT(nms, 235, mkChar("parm_ifrac_L"));
  SET_STRING_ELT(nms, 236, mkChar("parm_ifrac_lpTB"));
  SET_STRING_ELT(nms, 237, mkChar("parm_ifrac_prevTPT"));
  SET_STRING_ELT(nms, 238, mkChar("parm_ifrac_SD"));
  SET_STRING_ELT(nms, 239, mkChar("parm_ifrac_U"));
  SET_STRING_ELT(nms, 240, mkChar("parm_init_PPD"));
  SET_STRING_ELT(nms, 241, mkChar("ppop"));
  SET_STRING_ELT(nms, 242, mkChar("Preinfections"));
  SET_STRING_ELT(nms, 243, mkChar("previous_remand"));
  SET_STRING_ELT(nms, 244, mkChar("prg"));
  SET_STRING_ELT(nms, 245, mkChar("ptn"));
  SET_STRING_ELT(nms, 246, mkChar("qolrate"));
  SET_STRING_ELT(nms, 247, mkChar("reinfections"));
  SET_STRING_ELT(nms, 248, mkChar("rel"));
  SET_STRING_ELT(nms, 249, mkChar("relapses"));
  SET_STRING_ELT(nms, 250, mkChar("remand_long"));
  SET_STRING_ELT(nms, 251, mkChar("remand_release"));
  SET_STRING_ELT(nms, 252, mkChar("remand_short"));
  SET_STRING_ELT(nms, 253, mkChar("rfv"));
  SET_STRING_ELT(nms, 254, mkChar("selfcures"));
  SET_STRING_ELT(nms, 255, mkChar("short_open"));
  SET_STRING_ELT(nms, 256, mkChar("short_release"));
  SET_STRING_ELT(nms, 257, mkChar("slowprogs"));
  SET_STRING_ELT(nms, 258, mkChar("stabilizations"));
  SET_STRING_ELT(nms, 259, mkChar("staticfoi"));
  SET_STRING_ELT(nms, 260, mkChar("stb"));
  SET_STRING_ELT(nms, 261, mkChar("tbmort"));
  SET_STRING_ELT(nms, 262, mkChar("tbstops"));
  SET_STRING_ELT(nms, 263, mkChar("tpt_drn"));
  SET_STRING_ELT(nms, 264, mkChar("tpt_E"));
  SET_STRING_ELT(nms, 265, mkChar("tpt_epTB"));
  SET_STRING_ELT(nms, 266, mkChar("tpt_L"));
  SET_STRING_ELT(nms, 267, mkChar("tpt_lpTB"));
  SET_STRING_ELT(nms, 268, mkChar("TPT_mid"));
  SET_STRING_ELT(nms, 269, mkChar("TPT_top"));
  SET_STRING_ELT(nms, 270, mkChar("tptHR"));
  SET_STRING_ELT(nms, 271, mkChar("txf"));
  SET_STRING_ELT(nms, 272, mkChar("uc_attout"));
  SET_STRING_ELT(nms, 273, mkChar("uc_attppd"));
  SET_STRING_ELT(nms, 274, mkChar("uc_entry_att_L"));
  SET_STRING_ELT(nms, 275, mkChar("uc_entry_att_no"));
  SET_STRING_ELT(nms, 276, mkChar("uc_entry_att_TB"));
  SET_STRING_ELT(nms, 277, mkChar("uc_entry_notx_L"));
  SET_STRING_ELT(nms, 278, mkChar("uc_entry_notx_no"));
  SET_STRING_ELT(nms, 279, mkChar("uc_entry_notx_TB"));
  SET_STRING_ELT(nms, 280, mkChar("uc_entry_tpt_L"));
  SET_STRING_ELT(nms, 281, mkChar("uc_entry_tpt_no"));
  SET_STRING_ELT(nms, 282, mkChar("uc_entry_tpt_TB"));
  SET_STRING_ELT(nms, 283, mkChar("worsens"));
  SET_STRING_ELT(nms, 284, mkChar("wsn"));
...
void tbmod0_rhs(tbmod0_internal* internal, double t, double * state, double * dstatedt, double * output) {
  ...
  double inflow_toNOTX_L = 1 - inflow_toATT_L - inflow_toTPT_L;
  double inflow_toNOTX_no = 1 - inflow_toATT_no - inflow_toTPT_no;
  double inflow_toNOTX_TB = 1 - inflow_toATT_TB - inflow_toTPT_TB;
  ...
  for (int i = 1; i <= internal->dim_frac_CD_1; ++i) {
    for (int j = 1; j <= internal->dim_frac_CD_2; ++j) {
      internal->frac_CD[i - 1 + internal->dim_frac_CD_1 * (j - 1)] = internal->parm_frac_CD * internal->inflow_top[i - 1] * (1 - inflow_toATT_TB) * ((1 - inflow_toTPT_TB) * internal->TPT_top[j - 1] + (inflow_toTPT_TB) * internal->TPT_mid[j - 1]);
    }
  }
  ...
  for (int i = 1; i <= internal->dim_frac_SD_1; ++i) {
    for (int j = 1; j <= internal->dim_frac_SD_2; ++j) {
      internal->frac_SD[i - 1 + internal->dim_frac_SD_1 * (j - 1)] = internal->parm_frac_SD * internal->inflow_top[i - 1] * (1 - inflow_toATT_TB) * ((1 - inflow_toTPT_TB) * internal->TPT_top[j - 1] + (inflow_toTPT_TB) * internal->TPT_mid[j - 1]);
    }
  }
  for (int i = 1; i <= internal->dim_frac_U_1; ++i) {
    for (int j = 1; j <= internal->dim_frac_U_2; ++j) {
      internal->frac_U[i - 1 + internal->dim_frac_U_1 * (j - 1)] = internal->parm_frac_U * internal->inflow_top[i - 1] * ((1 - inflow_toTPT_no) * internal->TPT_top[j - 1] + inflow_toTPT_no * internal->TPT_mid[j - 1]);
    }
  }
  {
     int i = 1;
