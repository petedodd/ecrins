...
typedef struct tbmod0_internal {
  ...
  double *infections;
  double inflow;
  double inflow_notx_L0;
  double inflow_notx_L1;
  double inflow_notx_no0;
  double inflow_notx_no1;
  double inflow_notx_TB0;
  double inflow_notx_TB1;
  double inflow_toATT_L0;
  double inflow_toATT_L1;
  double inflow_toATT_no0;
  double inflow_toATT_no1;
  double inflow_toATT_TB0;
  double inflow_toATT_TB1;
  double *inflow_top;
  double inflow_toTPT_L0;
  double inflow_toTPT_L1;
  double inflow_toTPT_no0;
  double inflow_toTPT_no1;
  double inflow_toTPT_TB0;
  double inflow_toTPT_TB1;
  double *inflow_TPTv;
  double *inFM;
  double *initial_ATT;
  double *initial_C0inFM;
  double initial_cases;
  double initial_casesout;
  double initial_cATTfp;
  double initial_cATTtp;
  double initial_CC;
  double initial_CC0;
  double initial_CC0inflow;
  double initial_CC0inside;
  double initial_CC0outside;
  double *initial_CD;
  double initial_cTPT;
  double initial_deaths;
  double initial_dLYL;
  double *initial_E;
  double *initial_epTB;
  double *initial_L;
  double *initial_lpTB;
  double initial_qoldec;
  double *initial_SD;
  double *initial_U;
  double int_time;
  ...
  double uc_attout;
  double uc_attppd;
  double uc_entry_att_L;
  double uc_entry_att_no;
  double uc_entry_att_TB;
  double uc_entry_notx_L;
  double uc_entry_notx_no;
  double uc_entry_notx_TB;
  double uc_entry_tpt_L;
  double uc_entry_tpt_no;
  double uc_entry_tpt_TB;
  double *worsens;
  double wsn;
} tbmod0_internal;
...
void tbmod0_output_dde(size_t n_eq, double t, double * state, size_t n_output, double * output, void * internal_p);
...
void tbmod0_finalise(SEXP internal_p) {
  ...
  if (internal_p) {
    ...
    R_Free(internal->inFM);
    R_Free(internal->initial_ATT);
    R_Free(internal->initial_C0inFM);
...
SEXP tbmod0_create(SEXP user) {
  ...
  internal->TPT_mid = NULL;
  internal->TPT_top = NULL;
  internal->worsens = NULL;
  internal->dim_C0inFM_1 = 3;
  internal->dim_C0inFM_2 = 3;
  internal->dim_hrv = 3;
  internal->dim_inFM_1 = 3;
  internal->dim_inFM_2 = 3;
  internal->dim_TPT_mid = 3;
  internal->dim_TPT_top = 3;
  internal->initial_cases = 0;
  internal->initial_casesout = 0;
  internal->initial_cATTfp = 0;
  internal->initial_cATTtp = 0;
  internal->initial_CC = 0;
  internal->initial_CC0 = 0;
  internal->initial_CC0inflow = 0;
  internal->initial_CC0inside = 0;
  internal->initial_CC0outside = 0;
  internal->initial_cTPT = 0;
  internal->initial_deaths = 0;
  internal->initial_dLYL = 0;
  internal->initial_qoldec = 0;
  internal->NP = 5;
  internal->NT = 3;
  R_Free(internal->hrv);
  internal->hrv = (double*) R_Calloc(internal->dim_hrv, double);
  R_Free(internal->TPT_mid);
  internal->TPT_mid = (double*) R_Calloc(internal->dim_TPT_mid, double);
  R_Free(internal->TPT_top);
  internal->TPT_top = (double*) R_Calloc(internal->dim_TPT_top, double);
  internal->dim_ATT_1 = internal->NP;
  internal->dim_ATT_2 = internal->NT;
  internal->dim_C0inFM = internal->dim_C0inFM_1 * internal->dim_C0inFM_2;
  ...
  internal->dim_inFM = internal->dim_inFM_1 * internal->dim_inFM_2;
  ...
  internal->dim_qolrate_1 = internal->NP;
  internal->dim_qolrate_2 = internal->NT;
  ...
  R_Free(internal->inFM);
  internal->inFM = (double*) R_Calloc(internal->dim_inFM, double);
  R_Free(internal->initial_C0inFM);
  internal->initial_C0inFM = (double*) R_Calloc(internal->dim_C0inFM, double);
  R_Free(internal->rfv);
  ...
  internal->dim_qolrate = internal->dim_qolrate_1 * internal->dim_qolrate_2;
  ...
  for (int i = 1; i <= internal->dim_C0inFM_1; ++i) {
    for (int j = 1; j <= internal->dim_C0inFM_2; ++j) {
      internal->initial_C0inFM[i - 1 + internal->dim_C0inFM_1 * (j - 1)] = 0;
    }
  }
  {
     int i = 1;
     internal->TPT_mid[i - 1] = 0;
  }
  {
     int i = 2;
     internal->TPT_mid[i - 1] = 1;
  }
  {
     int i = 3;
     internal->TPT_mid[i - 1] = 0;
  ...
  R_Free(internal->qolrate);
  internal->qolrate = (double*) R_Calloc(internal->dim_qolrate, double);
  R_Free(internal->reinfections);
  ...
  internal->offset_variable_ATT = internal->dim_CD + internal->dim_E + internal->dim_L + internal->dim_SD + internal->dim_U + 13;
  internal->offset_variable_C0inFM = internal->dim_ATT + internal->dim_CD + internal->dim_E + internal->dim_epTB + internal->dim_L + internal->dim_lpTB + internal->dim_SD + internal->dim_U + 13;
  internal->offset_variable_CD = internal->dim_E + internal->dim_L + internal->dim_SD + internal->dim_U + 13;
  internal->offset_variable_E = internal->dim_U + 13;
  internal->offset_variable_epTB = internal->dim_ATT + internal->dim_CD + internal->dim_E + internal->dim_L + internal->dim_SD + internal->dim_U + 13;
  internal->offset_variable_L = internal->dim_E + internal->dim_U + 13;
  internal->offset_variable_lpTB = internal->dim_ATT + internal->dim_CD + internal->dim_E + internal->dim_epTB + internal->dim_L + internal->dim_SD + internal->dim_U + 13;
  internal->offset_variable_SD = internal->dim_E + internal->dim_L + internal->dim_U + 13;
  for (int i = 1; i <= 4; ++i) {
    internal->rfv[i - 1] = 1;
  }
  {
  ...
  internal->disc_rate = 0.035000000000000003;
  internal->foi = 0.01;
  internal->hrqol = 0.29999999999999999;
  internal->hrqolptb = 0.050000000000000003;
  internal->inflow_notx_L0 = 0;
  internal->inflow_notx_L1 = 0;
  internal->inflow_notx_no0 = 0;
  internal->inflow_notx_no1 = 0;
  internal->inflow_notx_TB0 = 0;
  internal->inflow_notx_TB1 = 0;
  internal->inflow_toATT_L0 = 0;
  internal->inflow_toATT_L1 = 0;
  internal->inflow_toATT_no0 = 0;
  internal->inflow_toATT_no1 = 0;
  internal->inflow_toATT_TB0 = 0;
  internal->inflow_toATT_TB1 = 0;
  internal->inflow_toTPT_L0 = 0;
  internal->inflow_toTPT_L1 = 0;
  internal->inflow_toTPT_no0 = 0;
  internal->inflow_toTPT_no1 = 0;
  internal->inflow_toTPT_TB0 = 0;
  internal->inflow_toTPT_TB1 = 0;
  ...
  internal->uc_attout = 1;
  internal->uc_attppd = 1;
  internal->uc_entry_att_L = 0;
  internal->uc_entry_att_no = 0;
  internal->uc_entry_att_TB = 0;
  internal->uc_entry_notx_L = 0;
  internal->uc_entry_notx_no = 0;
  internal->uc_entry_notx_TB = 0;
  internal->uc_entry_tpt_L = 0;
  internal->uc_entry_tpt_no = 0;
  internal->uc_entry_tpt_TB = 0;
...
SEXP tbmod0_contents(SEXP internal_p) {
  ...
  SEXP contents = PROTECT(allocVector(VECSXP, 303));
  ...
  SET_VECTOR_ELT(contents, 8, ScalarInteger(internal->dim_C0inFM));
  SET_VECTOR_ELT(contents, 9, ScalarInteger(internal->dim_C0inFM_1));
  SET_VECTOR_ELT(contents, 10, ScalarInteger(internal->dim_C0inFM_2));
  SET_VECTOR_ELT(contents, 11, ScalarInteger(internal->dim_CD));
  SET_VECTOR_ELT(contents, 12, ScalarInteger(internal->dim_CD_1));
  SET_VECTOR_ELT(contents, 13, ScalarInteger(internal->dim_CD_2));
  SET_VECTOR_ELT(contents, 14, ScalarInteger(internal->dim_detects));
  SET_VECTOR_ELT(contents, 15, ScalarInteger(internal->dim_detects_1));
  SET_VECTOR_ELT(contents, 16, ScalarInteger(internal->dim_detects_2));
  SET_VECTOR_ELT(contents, 17, ScalarInteger(internal->dim_E));
  SET_VECTOR_ELT(contents, 18, ScalarInteger(internal->dim_E_1));
  SET_VECTOR_ELT(contents, 19, ScalarInteger(internal->dim_E_2));
  SET_VECTOR_ELT(contents, 20, ScalarInteger(internal->dim_epTB));
  SET_VECTOR_ELT(contents, 21, ScalarInteger(internal->dim_epTB_1));
  SET_VECTOR_ELT(contents, 22, ScalarInteger(internal->dim_epTB_2));
  SET_VECTOR_ELT(contents, 23, ScalarInteger(internal->dim_Ereinfections));
  SET_VECTOR_ELT(contents, 24, ScalarInteger(internal->dim_Ereinfections_1));
  SET_VECTOR_ELT(contents, 25, ScalarInteger(internal->dim_Ereinfections_2));
  SET_VECTOR_ELT(contents, 26, ScalarInteger(internal->dim_fastprogs));
  SET_VECTOR_ELT(contents, 27, ScalarInteger(internal->dim_fastprogs_1));
  SET_VECTOR_ELT(contents, 28, ScalarInteger(internal->dim_fastprogs_2));
  SET_VECTOR_ELT(contents, 29, ScalarInteger(internal->dim_frac_ATT));
  SET_VECTOR_ELT(contents, 30, ScalarInteger(internal->dim_frac_ATT_1));
  SET_VECTOR_ELT(contents, 31, ScalarInteger(internal->dim_frac_ATT_2));
  SET_VECTOR_ELT(contents, 32, ScalarInteger(internal->dim_frac_CD));
  SET_VECTOR_ELT(contents, 33, ScalarInteger(internal->dim_frac_CD_1));
  SET_VECTOR_ELT(contents, 34, ScalarInteger(internal->dim_frac_CD_2));
  SET_VECTOR_ELT(contents, 35, ScalarInteger(internal->dim_frac_E));
  SET_VECTOR_ELT(contents, 36, ScalarInteger(internal->dim_frac_E_1));
  SET_VECTOR_ELT(contents, 37, ScalarInteger(internal->dim_frac_E_2));
  SET_VECTOR_ELT(contents, 38, ScalarInteger(internal->dim_frac_epTB));
  SET_VECTOR_ELT(contents, 39, ScalarInteger(internal->dim_frac_epTB_1));
  SET_VECTOR_ELT(contents, 40, ScalarInteger(internal->dim_frac_epTB_2));
  SET_VECTOR_ELT(contents, 41, ScalarInteger(internal->dim_frac_L));
  SET_VECTOR_ELT(contents, 42, ScalarInteger(internal->dim_frac_L_1));
  SET_VECTOR_ELT(contents, 43, ScalarInteger(internal->dim_frac_L_2));
  SET_VECTOR_ELT(contents, 44, ScalarInteger(internal->dim_frac_lpTB));
  SET_VECTOR_ELT(contents, 45, ScalarInteger(internal->dim_frac_lpTB_1));
  SET_VECTOR_ELT(contents, 46, ScalarInteger(internal->dim_frac_lpTB_2));
  SET_VECTOR_ELT(contents, 47, ScalarInteger(internal->dim_frac_SD));
  SET_VECTOR_ELT(contents, 48, ScalarInteger(internal->dim_frac_SD_1));
  SET_VECTOR_ELT(contents, 49, ScalarInteger(internal->dim_frac_SD_2));
  SET_VECTOR_ELT(contents, 50, ScalarInteger(internal->dim_frac_U));
  SET_VECTOR_ELT(contents, 51, ScalarInteger(internal->dim_frac_U_1));
  SET_VECTOR_ELT(contents, 52, ScalarInteger(internal->dim_frac_U_2));
  SET_VECTOR_ELT(contents, 53, ScalarInteger(internal->dim_hrv));
  SET_VECTOR_ELT(contents, 54, ScalarInteger(internal->dim_infections));
  SET_VECTOR_ELT(contents, 55, ScalarInteger(internal->dim_infections_1));
  SET_VECTOR_ELT(contents, 56, ScalarInteger(internal->dim_infections_2));
  SET_VECTOR_ELT(contents, 57, ScalarInteger(internal->dim_inflow_top));
  SET_VECTOR_ELT(contents, 58, ScalarInteger(internal->dim_inflow_TPTv));
  SET_VECTOR_ELT(contents, 59, ScalarInteger(internal->dim_inFM));
  SET_VECTOR_ELT(contents, 60, ScalarInteger(internal->dim_inFM_1));
  SET_VECTOR_ELT(contents, 61, ScalarInteger(internal->dim_inFM_2));
  SET_VECTOR_ELT(contents, 62, ScalarInteger(internal->dim_L));
  SET_VECTOR_ELT(contents, 63, ScalarInteger(internal->dim_L_1));
  SET_VECTOR_ELT(contents, 64, ScalarInteger(internal->dim_L_2));
  SET_VECTOR_ELT(contents, 65, ScalarInteger(internal->dim_lpTB));
  SET_VECTOR_ELT(contents, 66, ScalarInteger(internal->dim_lpTB_1));
  SET_VECTOR_ELT(contents, 67, ScalarInteger(internal->dim_lpTB_2));
  SET_VECTOR_ELT(contents, 68, ScalarInteger(internal->dim_Lreinfections));
  SET_VECTOR_ELT(contents, 69, ScalarInteger(internal->dim_Lreinfections_1));
  SET_VECTOR_ELT(contents, 70, ScalarInteger(internal->dim_Lreinfections_2));
  SET_VECTOR_ELT(contents, 71, ScalarInteger(internal->dim_moves_ATT));
  SET_VECTOR_ELT(contents, 72, ScalarInteger(internal->dim_moves_ATT_1));
  SET_VECTOR_ELT(contents, 73, ScalarInteger(internal->dim_moves_ATT_2));
  SET_VECTOR_ELT(contents, 74, ScalarInteger(internal->dim_moves_CD));
  SET_VECTOR_ELT(contents, 75, ScalarInteger(internal->dim_moves_CD_1));
  SET_VECTOR_ELT(contents, 76, ScalarInteger(internal->dim_moves_CD_2));
  SET_VECTOR_ELT(contents, 77, ScalarInteger(internal->dim_moves_E));
  SET_VECTOR_ELT(contents, 78, ScalarInteger(internal->dim_moves_E_1));
  SET_VECTOR_ELT(contents, 79, ScalarInteger(internal->dim_moves_E_2));
  SET_VECTOR_ELT(contents, 80, ScalarInteger(internal->dim_moves_epTB));
  SET_VECTOR_ELT(contents, 81, ScalarInteger(internal->dim_moves_epTB_1));
  SET_VECTOR_ELT(contents, 82, ScalarInteger(internal->dim_moves_epTB_2));
  SET_VECTOR_ELT(contents, 83, ScalarInteger(internal->dim_moves_L));
  SET_VECTOR_ELT(contents, 84, ScalarInteger(internal->dim_moves_L_1));
  SET_VECTOR_ELT(contents, 85, ScalarInteger(internal->dim_moves_L_2));
  SET_VECTOR_ELT(contents, 86, ScalarInteger(internal->dim_moves_lpTB));
  SET_VECTOR_ELT(contents, 87, ScalarInteger(internal->dim_moves_lpTB_1));
  SET_VECTOR_ELT(contents, 88, ScalarInteger(internal->dim_moves_lpTB_2));
  SET_VECTOR_ELT(contents, 89, ScalarInteger(internal->dim_moves_SD));
  SET_VECTOR_ELT(contents, 90, ScalarInteger(internal->dim_moves_SD_1));
  SET_VECTOR_ELT(contents, 91, ScalarInteger(internal->dim_moves_SD_2));
  SET_VECTOR_ELT(contents, 92, ScalarInteger(internal->dim_moves_U));
  SET_VECTOR_ELT(contents, 93, ScalarInteger(internal->dim_moves_U_1));
  SET_VECTOR_ELT(contents, 94, ScalarInteger(internal->dim_moves_U_2));
  SET_VECTOR_ELT(contents, 95, ScalarInteger(internal->dim_parm_ifrac_prevTPT));
  SET_VECTOR_ELT(contents, 96, ScalarInteger(internal->dim_parm_init_PPD));
  SET_VECTOR_ELT(contents, 97, ScalarInteger(internal->dim_ppop));
  SET_VECTOR_ELT(contents, 98, ScalarInteger(internal->dim_ppop_1));
  SET_VECTOR_ELT(contents, 99, ScalarInteger(internal->dim_ppop_2));
  SET_VECTOR_ELT(contents, 100, ScalarInteger(internal->dim_Preinfections));
  SET_VECTOR_ELT(contents, 101, ScalarInteger(internal->dim_Preinfections_1));
  SET_VECTOR_ELT(contents, 102, ScalarInteger(internal->dim_Preinfections_2));
  SET_VECTOR_ELT(contents, 103, ScalarInteger(internal->dim_qolrate));
  SET_VECTOR_ELT(contents, 104, ScalarInteger(internal->dim_qolrate_1));
  SET_VECTOR_ELT(contents, 105, ScalarInteger(internal->dim_qolrate_2));
  SET_VECTOR_ELT(contents, 106, ScalarInteger(internal->dim_reinfections));
  SET_VECTOR_ELT(contents, 107, ScalarInteger(internal->dim_reinfections_1));
  SET_VECTOR_ELT(contents, 108, ScalarInteger(internal->dim_reinfections_2));
  SET_VECTOR_ELT(contents, 109, ScalarInteger(internal->dim_relapses));
  SET_VECTOR_ELT(contents, 110, ScalarInteger(internal->dim_relapses_1));
  SET_VECTOR_ELT(contents, 111, ScalarInteger(internal->dim_relapses_2));
  SET_VECTOR_ELT(contents, 112, ScalarInteger(internal->dim_rfv));
  SET_VECTOR_ELT(contents, 113, ScalarInteger(internal->dim_SD));
  SET_VECTOR_ELT(contents, 114, ScalarInteger(internal->dim_SD_1));
  SET_VECTOR_ELT(contents, 115, ScalarInteger(internal->dim_SD_2));
  SET_VECTOR_ELT(contents, 116, ScalarInteger(internal->dim_selfcures));
  SET_VECTOR_ELT(contents, 117, ScalarInteger(internal->dim_selfcures_1));
  SET_VECTOR_ELT(contents, 118, ScalarInteger(internal->dim_selfcures_2));
  SET_VECTOR_ELT(contents, 119, ScalarInteger(internal->dim_slowprogs));
  SET_VECTOR_ELT(contents, 120, ScalarInteger(internal->dim_slowprogs_1));
  SET_VECTOR_ELT(contents, 121, ScalarInteger(internal->dim_slowprogs_2));
  SET_VECTOR_ELT(contents, 122, ScalarInteger(internal->dim_stabilizations));
  SET_VECTOR_ELT(contents, 123, ScalarInteger(internal->dim_stabilizations_1));
  SET_VECTOR_ELT(contents, 124, ScalarInteger(internal->dim_stabilizations_2));
  SET_VECTOR_ELT(contents, 125, ScalarInteger(internal->dim_tbmort));
  SET_VECTOR_ELT(contents, 126, ScalarInteger(internal->dim_tbmort_1));
  SET_VECTOR_ELT(contents, 127, ScalarInteger(internal->dim_tbmort_2));
  SET_VECTOR_ELT(contents, 128, ScalarInteger(internal->dim_tbstops));
  SET_VECTOR_ELT(contents, 129, ScalarInteger(internal->dim_tbstops_1));
  SET_VECTOR_ELT(contents, 130, ScalarInteger(internal->dim_tbstops_2));
  SET_VECTOR_ELT(contents, 131, ScalarInteger(internal->dim_tpt_E));
  SET_VECTOR_ELT(contents, 132, ScalarInteger(internal->dim_tpt_E_1));
  SET_VECTOR_ELT(contents, 133, ScalarInteger(internal->dim_tpt_E_2));
  SET_VECTOR_ELT(contents, 134, ScalarInteger(internal->dim_tpt_epTB));
  SET_VECTOR_ELT(contents, 135, ScalarInteger(internal->dim_tpt_epTB_1));
  SET_VECTOR_ELT(contents, 136, ScalarInteger(internal->dim_tpt_epTB_2));
  SET_VECTOR_ELT(contents, 137, ScalarInteger(internal->dim_tpt_L));
  SET_VECTOR_ELT(contents, 138, ScalarInteger(internal->dim_tpt_L_1));
  SET_VECTOR_ELT(contents, 139, ScalarInteger(internal->dim_tpt_L_2));
  SET_VECTOR_ELT(contents, 140, ScalarInteger(internal->dim_tpt_lpTB));
  SET_VECTOR_ELT(contents, 141, ScalarInteger(internal->dim_tpt_lpTB_1));
  SET_VECTOR_ELT(contents, 142, ScalarInteger(internal->dim_tpt_lpTB_2));
  SET_VECTOR_ELT(contents, 143, ScalarInteger(internal->dim_TPT_mid));
  SET_VECTOR_ELT(contents, 144, ScalarInteger(internal->dim_TPT_top));
  SET_VECTOR_ELT(contents, 145, ScalarInteger(internal->dim_U));
  SET_VECTOR_ELT(contents, 146, ScalarInteger(internal->dim_U_1));
  SET_VECTOR_ELT(contents, 147, ScalarInteger(internal->dim_U_2));
  SET_VECTOR_ELT(contents, 148, ScalarInteger(internal->dim_worsens));
  SET_VECTOR_ELT(contents, 149, ScalarInteger(internal->dim_worsens_1));
  SET_VECTOR_ELT(contents, 150, ScalarInteger(internal->dim_worsens_2));
  SET_VECTOR_ELT(contents, 151, ScalarReal(internal->disc_rate));
  SET_VECTOR_ELT(contents, 152, ScalarReal(internal->drn));
  SET_VECTOR_ELT(contents, 153, ScalarReal(internal->eps));
  ...
  SET_VECTOR_ELT(contents, 154, Ereinfections);
  ...
  SET_VECTOR_ELT(contents, 155, fastprogs);
  SET_VECTOR_ELT(contents, 156, ScalarReal(internal->foi));
  ...
  SET_VECTOR_ELT(contents, 165, ScalarReal(internal->hrqol));
  SET_VECTOR_ELT(contents, 166, ScalarReal(internal->hrqolptb));
  SEXP hrv = PROTECT(allocVector(REALSXP, internal->dim_hrv));
  memcpy(REAL(hrv), internal->hrv, internal->dim_hrv * sizeof(double));
  SET_VECTOR_ELT(contents, 167, hrv);
  ...
  SET_VECTOR_ELT(contents, 168, infections);
  SET_VECTOR_ELT(contents, 169, ScalarReal(internal->inflow));
  SET_VECTOR_ELT(contents, 170, ScalarReal(internal->inflow_notx_L0));
  SET_VECTOR_ELT(contents, 171, ScalarReal(internal->inflow_notx_L1));
  SET_VECTOR_ELT(contents, 172, ScalarReal(internal->inflow_notx_no0));
  SET_VECTOR_ELT(contents, 173, ScalarReal(internal->inflow_notx_no1));
  SET_VECTOR_ELT(contents, 174, ScalarReal(internal->inflow_notx_TB0));
  SET_VECTOR_ELT(contents, 175, ScalarReal(internal->inflow_notx_TB1));
  SET_VECTOR_ELT(contents, 176, ScalarReal(internal->inflow_toATT_L0));
  SET_VECTOR_ELT(contents, 177, ScalarReal(internal->inflow_toATT_L1));
  SET_VECTOR_ELT(contents, 178, ScalarReal(internal->inflow_toATT_no0));
  SET_VECTOR_ELT(contents, 179, ScalarReal(internal->inflow_toATT_no1));
  SET_VECTOR_ELT(contents, 180, ScalarReal(internal->inflow_toATT_TB0));
  SET_VECTOR_ELT(contents, 181, ScalarReal(internal->inflow_toATT_TB1));
  ...
  SET_VECTOR_ELT(contents, 182, inflow_top);
  SET_VECTOR_ELT(contents, 183, ScalarReal(internal->inflow_toTPT_L0));
  SET_VECTOR_ELT(contents, 184, ScalarReal(internal->inflow_toTPT_L1));
  SET_VECTOR_ELT(contents, 185, ScalarReal(internal->inflow_toTPT_no0));
  SET_VECTOR_ELT(contents, 186, ScalarReal(internal->inflow_toTPT_no1));
  SET_VECTOR_ELT(contents, 187, ScalarReal(internal->inflow_toTPT_TB0));
  SET_VECTOR_ELT(contents, 188, ScalarReal(internal->inflow_toTPT_TB1));
  ...
  SET_VECTOR_ELT(contents, 189, inflow_TPTv);
  SEXP inFM = PROTECT(allocVector(REALSXP, internal->dim_inFM));
  memcpy(REAL(inFM), internal->inFM, internal->dim_inFM * sizeof(double));
  odin_set_dim(inFM, 2, internal->dim_inFM_1, internal->dim_inFM_2);
  SET_VECTOR_ELT(contents, 190, inFM);
  ...
  SET_VECTOR_ELT(contents, 191, initial_ATT);
  SEXP initial_C0inFM = PROTECT(allocVector(REALSXP, internal->dim_C0inFM));
  memcpy(REAL(initial_C0inFM), internal->initial_C0inFM, internal->dim_C0inFM * sizeof(double));
  odin_set_dim(initial_C0inFM, 2, internal->dim_C0inFM_1, internal->dim_C0inFM_2);
  SET_VECTOR_ELT(contents, 192, initial_C0inFM);
  SET_VECTOR_ELT(contents, 193, ScalarReal(internal->initial_cases));
  SET_VECTOR_ELT(contents, 194, ScalarReal(internal->initial_casesout));
  SET_VECTOR_ELT(contents, 195, ScalarReal(internal->initial_cATTfp));
  SET_VECTOR_ELT(contents, 196, ScalarReal(internal->initial_cATTtp));
  SET_VECTOR_ELT(contents, 197, ScalarReal(internal->initial_CC));
  SET_VECTOR_ELT(contents, 198, ScalarReal(internal->initial_CC0));
  SET_VECTOR_ELT(contents, 199, ScalarReal(internal->initial_CC0inflow));
  SET_VECTOR_ELT(contents, 200, ScalarReal(internal->initial_CC0inside));
  SET_VECTOR_ELT(contents, 201, ScalarReal(internal->initial_CC0outside));
  ...
  SET_VECTOR_ELT(contents, 202, initial_CD);
  SET_VECTOR_ELT(contents, 203, ScalarReal(internal->initial_cTPT));
  SET_VECTOR_ELT(contents, 204, ScalarReal(internal->initial_deaths));
  SET_VECTOR_ELT(contents, 205, ScalarReal(internal->initial_dLYL));
  ...
  SET_VECTOR_ELT(contents, 206, initial_E);
  ...
  SET_VECTOR_ELT(contents, 207, initial_epTB);
  ...
  SET_VECTOR_ELT(contents, 208, initial_L);
  ...
  SET_VECTOR_ELT(contents, 209, initial_lpTB);
  SET_VECTOR_ELT(contents, 210, ScalarReal(internal->initial_qoldec));
  ...
  SET_VECTOR_ELT(contents, 211, initial_SD);
  ...
  SET_VECTOR_ELT(contents, 212, initial_U);
  SET_VECTOR_ELT(contents, 213, ScalarReal(internal->int_time));
  SET_VECTOR_ELT(contents, 214, ScalarReal(internal->late_post_time));
  SET_VECTOR_ELT(contents, 215, ScalarReal(internal->LifeExp));
  SET_VECTOR_ELT(contents, 216, ScalarReal(internal->long_release));
  SET_VECTOR_ELT(contents, 217, ScalarReal(internal->long_short));
  ...
  SET_VECTOR_ELT(contents, 218, Lreinfections);
  SET_VECTOR_ELT(contents, 219, ScalarReal(internal->m));
  SET_VECTOR_ELT(contents, 220, ScalarReal(internal->mHR));
  SET_VECTOR_ELT(contents, 221, ScalarReal(internal->mort));
  ...
  SET_VECTOR_ELT(contents, 222, moves_ATT);
  ...
  SET_VECTOR_ELT(contents, 223, moves_CD);
  ...
  SET_VECTOR_ELT(contents, 224, moves_E);
  ...
  SET_VECTOR_ELT(contents, 225, moves_epTB);
  ...
  SET_VECTOR_ELT(contents, 226, moves_L);
  ...
  SET_VECTOR_ELT(contents, 227, moves_lpTB);
  ...
  SET_VECTOR_ELT(contents, 228, moves_SD);
  ...
  SET_VECTOR_ELT(contents, 229, moves_U);
  SET_VECTOR_ELT(contents, 230, ScalarInteger(internal->NP));
  SET_VECTOR_ELT(contents, 231, ScalarInteger(internal->NT));
  SET_VECTOR_ELT(contents, 232, ScalarInteger(internal->offset_variable_ATT));
  SET_VECTOR_ELT(contents, 233, ScalarInteger(internal->offset_variable_C0inFM));
  SET_VECTOR_ELT(contents, 234, ScalarInteger(internal->offset_variable_CD));
  SET_VECTOR_ELT(contents, 235, ScalarInteger(internal->offset_variable_E));
  SET_VECTOR_ELT(contents, 236, ScalarInteger(internal->offset_variable_epTB));
  SET_VECTOR_ELT(contents, 237, ScalarInteger(internal->offset_variable_L));
  SET_VECTOR_ELT(contents, 238, ScalarInteger(internal->offset_variable_lpTB));
  SET_VECTOR_ELT(contents, 239, ScalarInteger(internal->offset_variable_SD));
  SET_VECTOR_ELT(contents, 240, ScalarReal(internal->open_release));
  SET_VECTOR_ELT(contents, 241, ScalarReal(internal->parm_frac_ATT));
  SET_VECTOR_ELT(contents, 242, ScalarReal(internal->parm_frac_CD));
  SET_VECTOR_ELT(contents, 243, ScalarReal(internal->parm_frac_E));
  SET_VECTOR_ELT(contents, 244, ScalarReal(internal->parm_frac_epTB));
  SET_VECTOR_ELT(contents, 245, ScalarReal(internal->parm_frac_L));
  SET_VECTOR_ELT(contents, 246, ScalarReal(internal->parm_frac_lpTB));
  SET_VECTOR_ELT(contents, 247, ScalarReal(internal->parm_frac_SD));
  SET_VECTOR_ELT(contents, 248, ScalarReal(internal->parm_frac_U));
  SET_VECTOR_ELT(contents, 249, ScalarReal(internal->parm_ifrac_ATT));
  SET_VECTOR_ELT(contents, 250, ScalarReal(internal->parm_ifrac_CD));
  SET_VECTOR_ELT(contents, 251, ScalarReal(internal->parm_ifrac_E));
  SET_VECTOR_ELT(contents, 252, ScalarReal(internal->parm_ifrac_epTB));
  SET_VECTOR_ELT(contents, 253, ScalarReal(internal->parm_ifrac_L));
  SET_VECTOR_ELT(contents, 254, ScalarReal(internal->parm_ifrac_lpTB));
  ...
  SET_VECTOR_ELT(contents, 255, parm_ifrac_prevTPT);
  SET_VECTOR_ELT(contents, 256, ScalarReal(internal->parm_ifrac_SD));
  SET_VECTOR_ELT(contents, 257, ScalarReal(internal->parm_ifrac_U));
  ...
  SET_VECTOR_ELT(contents, 258, parm_init_PPD);
  ...
  SET_VECTOR_ELT(contents, 259, ppop);
  ...
  SET_VECTOR_ELT(contents, 260, Preinfections);
  SET_VECTOR_ELT(contents, 261, ScalarReal(internal->previous_remand));
  SET_VECTOR_ELT(contents, 262, ScalarReal(internal->prg));
  SET_VECTOR_ELT(contents, 263, ScalarReal(internal->ptn));
  SEXP qolrate = PROTECT(allocVector(REALSXP, internal->dim_qolrate));
  memcpy(REAL(qolrate), internal->qolrate, internal->dim_qolrate * sizeof(double));
  odin_set_dim(qolrate, 2, internal->dim_qolrate_1, internal->dim_qolrate_2);
  SET_VECTOR_ELT(contents, 264, qolrate);
  ...
  SET_VECTOR_ELT(contents, 265, reinfections);
  SET_VECTOR_ELT(contents, 266, ScalarReal(internal->rel));
  ...
  SET_VECTOR_ELT(contents, 267, relapses);
  SET_VECTOR_ELT(contents, 268, ScalarReal(internal->remand_long));
  SET_VECTOR_ELT(contents, 269, ScalarReal(internal->remand_release));
  SET_VECTOR_ELT(contents, 270, ScalarReal(internal->remand_short));
  SEXP rfv = PROTECT(allocVector(REALSXP, internal->dim_rfv));
  memcpy(REAL(rfv), internal->rfv, internal->dim_rfv * sizeof(double));
  SET_VECTOR_ELT(contents, 271, rfv);
  ...
  SET_VECTOR_ELT(contents, 272, selfcures);
  SET_VECTOR_ELT(contents, 273, ScalarReal(internal->short_open));
  SET_VECTOR_ELT(contents, 274, ScalarReal(internal->short_release));
  ...
  SET_VECTOR_ELT(contents, 275, slowprogs);
  ...
  SET_VECTOR_ELT(contents, 276, stabilizations);
  SET_VECTOR_ELT(contents, 277, ScalarReal(internal->staticfoi));
  SET_VECTOR_ELT(contents, 278, ScalarReal(internal->stb));
  ...
  SET_VECTOR_ELT(contents, 279, tbmort);
  ...
  SET_VECTOR_ELT(contents, 280, tbstops);
  SET_VECTOR_ELT(contents, 281, ScalarReal(internal->tpt_drn));
  ...
  SET_VECTOR_ELT(contents, 282, tpt_E);
  ...
  SET_VECTOR_ELT(contents, 283, tpt_epTB);
  ...
  SET_VECTOR_ELT(contents, 284, tpt_L);
  ...
  SET_VECTOR_ELT(contents, 285, tpt_lpTB);
  SEXP TPT_mid = PROTECT(allocVector(REALSXP, internal->dim_TPT_mid));
  memcpy(REAL(TPT_mid), internal->TPT_mid, internal->dim_TPT_mid * sizeof(double));
  SET_VECTOR_ELT(contents, 286, TPT_mid);
  ...
  SET_VECTOR_ELT(contents, 287, TPT_top);
  SET_VECTOR_ELT(contents, 288, ScalarReal(internal->tptHR));
  SET_VECTOR_ELT(contents, 289, ScalarReal(internal->txf));
  SET_VECTOR_ELT(contents, 290, ScalarReal(internal->uc_attout));
  SET_VECTOR_ELT(contents, 291, ScalarReal(internal->uc_attppd));
  SET_VECTOR_ELT(contents, 292, ScalarReal(internal->uc_entry_att_L));
  SET_VECTOR_ELT(contents, 293, ScalarReal(internal->uc_entry_att_no));
  SET_VECTOR_ELT(contents, 294, ScalarReal(internal->uc_entry_att_TB));
  SET_VECTOR_ELT(contents, 295, ScalarReal(internal->uc_entry_notx_L));
  SET_VECTOR_ELT(contents, 296, ScalarReal(internal->uc_entry_notx_no));
  SET_VECTOR_ELT(contents, 297, ScalarReal(internal->uc_entry_notx_TB));
  SET_VECTOR_ELT(contents, 298, ScalarReal(internal->uc_entry_tpt_L));
  SET_VECTOR_ELT(contents, 299, ScalarReal(internal->uc_entry_tpt_no));
  SET_VECTOR_ELT(contents, 300, ScalarReal(internal->uc_entry_tpt_TB));
  ...
  SET_VECTOR_ELT(contents, 301, worsens);
  SET_VECTOR_ELT(contents, 302, ScalarReal(internal->wsn));
  SEXP nms = PROTECT(allocVector(STRSXP, 303));
  ...
  SET_STRING_ELT(nms, 8, mkChar("dim_C0inFM"));
  SET_STRING_ELT(nms, 9, mkChar("dim_C0inFM_1"));
  SET_STRING_ELT(nms, 10, mkChar("dim_C0inFM_2"));
  SET_STRING_ELT(nms, 11, mkChar("dim_CD"));
  SET_STRING_ELT(nms, 12, mkChar("dim_CD_1"));
  SET_STRING_ELT(nms, 13, mkChar("dim_CD_2"));
  SET_STRING_ELT(nms, 14, mkChar("dim_detects"));
  SET_STRING_ELT(nms, 15, mkChar("dim_detects_1"));
  SET_STRING_ELT(nms, 16, mkChar("dim_detects_2"));
  SET_STRING_ELT(nms, 17, mkChar("dim_E"));
  SET_STRING_ELT(nms, 18, mkChar("dim_E_1"));
  SET_STRING_ELT(nms, 19, mkChar("dim_E_2"));
  SET_STRING_ELT(nms, 20, mkChar("dim_epTB"));
  SET_STRING_ELT(nms, 21, mkChar("dim_epTB_1"));
  SET_STRING_ELT(nms, 22, mkChar("dim_epTB_2"));
  SET_STRING_ELT(nms, 23, mkChar("dim_Ereinfections"));
  SET_STRING_ELT(nms, 24, mkChar("dim_Ereinfections_1"));
  SET_STRING_ELT(nms, 25, mkChar("dim_Ereinfections_2"));
  SET_STRING_ELT(nms, 26, mkChar("dim_fastprogs"));
  SET_STRING_ELT(nms, 27, mkChar("dim_fastprogs_1"));
  SET_STRING_ELT(nms, 28, mkChar("dim_fastprogs_2"));
  SET_STRING_ELT(nms, 29, mkChar("dim_frac_ATT"));
  SET_STRING_ELT(nms, 30, mkChar("dim_frac_ATT_1"));
  SET_STRING_ELT(nms, 31, mkChar("dim_frac_ATT_2"));
  SET_STRING_ELT(nms, 32, mkChar("dim_frac_CD"));
  SET_STRING_ELT(nms, 33, mkChar("dim_frac_CD_1"));
  SET_STRING_ELT(nms, 34, mkChar("dim_frac_CD_2"));
  SET_STRING_ELT(nms, 35, mkChar("dim_frac_E"));
  SET_STRING_ELT(nms, 36, mkChar("dim_frac_E_1"));
  SET_STRING_ELT(nms, 37, mkChar("dim_frac_E_2"));
  SET_STRING_ELT(nms, 38, mkChar("dim_frac_epTB"));
  SET_STRING_ELT(nms, 39, mkChar("dim_frac_epTB_1"));
  SET_STRING_ELT(nms, 40, mkChar("dim_frac_epTB_2"));
  SET_STRING_ELT(nms, 41, mkChar("dim_frac_L"));
  SET_STRING_ELT(nms, 42, mkChar("dim_frac_L_1"));
  SET_STRING_ELT(nms, 43, mkChar("dim_frac_L_2"));
  SET_STRING_ELT(nms, 44, mkChar("dim_frac_lpTB"));
  SET_STRING_ELT(nms, 45, mkChar("dim_frac_lpTB_1"));
  SET_STRING_ELT(nms, 46, mkChar("dim_frac_lpTB_2"));
  SET_STRING_ELT(nms, 47, mkChar("dim_frac_SD"));
  SET_STRING_ELT(nms, 48, mkChar("dim_frac_SD_1"));
  SET_STRING_ELT(nms, 49, mkChar("dim_frac_SD_2"));
  SET_STRING_ELT(nms, 50, mkChar("dim_frac_U"));
  SET_STRING_ELT(nms, 51, mkChar("dim_frac_U_1"));
  SET_STRING_ELT(nms, 52, mkChar("dim_frac_U_2"));
  SET_STRING_ELT(nms, 53, mkChar("dim_hrv"));
  SET_STRING_ELT(nms, 54, mkChar("dim_infections"));
  SET_STRING_ELT(nms, 55, mkChar("dim_infections_1"));
  SET_STRING_ELT(nms, 56, mkChar("dim_infections_2"));
  SET_STRING_ELT(nms, 57, mkChar("dim_inflow_top"));
  SET_STRING_ELT(nms, 58, mkChar("dim_inflow_TPTv"));
  SET_STRING_ELT(nms, 59, mkChar("dim_inFM"));
  SET_STRING_ELT(nms, 60, mkChar("dim_inFM_1"));
  SET_STRING_ELT(nms, 61, mkChar("dim_inFM_2"));
  SET_STRING_ELT(nms, 62, mkChar("dim_L"));
  SET_STRING_ELT(nms, 63, mkChar("dim_L_1"));
  SET_STRING_ELT(nms, 64, mkChar("dim_L_2"));
  SET_STRING_ELT(nms, 65, mkChar("dim_lpTB"));
  SET_STRING_ELT(nms, 66, mkChar("dim_lpTB_1"));
  SET_STRING_ELT(nms, 67, mkChar("dim_lpTB_2"));
  SET_STRING_ELT(nms, 68, mkChar("dim_Lreinfections"));
  SET_STRING_ELT(nms, 69, mkChar("dim_Lreinfections_1"));
  SET_STRING_ELT(nms, 70, mkChar("dim_Lreinfections_2"));
  SET_STRING_ELT(nms, 71, mkChar("dim_moves_ATT"));
  SET_STRING_ELT(nms, 72, mkChar("dim_moves_ATT_1"));
  SET_STRING_ELT(nms, 73, mkChar("dim_moves_ATT_2"));
  SET_STRING_ELT(nms, 74, mkChar("dim_moves_CD"));
  SET_STRING_ELT(nms, 75, mkChar("dim_moves_CD_1"));
  SET_STRING_ELT(nms, 76, mkChar("dim_moves_CD_2"));
  SET_STRING_ELT(nms, 77, mkChar("dim_moves_E"));
  SET_STRING_ELT(nms, 78, mkChar("dim_moves_E_1"));
  SET_STRING_ELT(nms, 79, mkChar("dim_moves_E_2"));
  SET_STRING_ELT(nms, 80, mkChar("dim_moves_epTB"));
  SET_STRING_ELT(nms, 81, mkChar("dim_moves_epTB_1"));
  SET_STRING_ELT(nms, 82, mkChar("dim_moves_epTB_2"));
  SET_STRING_ELT(nms, 83, mkChar("dim_moves_L"));
  SET_STRING_ELT(nms, 84, mkChar("dim_moves_L_1"));
  SET_STRING_ELT(nms, 85, mkChar("dim_moves_L_2"));
  SET_STRING_ELT(nms, 86, mkChar("dim_moves_lpTB"));
  SET_STRING_ELT(nms, 87, mkChar("dim_moves_lpTB_1"));
  SET_STRING_ELT(nms, 88, mkChar("dim_moves_lpTB_2"));
  SET_STRING_ELT(nms, 89, mkChar("dim_moves_SD"));
  SET_STRING_ELT(nms, 90, mkChar("dim_moves_SD_1"));
  SET_STRING_ELT(nms, 91, mkChar("dim_moves_SD_2"));
  SET_STRING_ELT(nms, 92, mkChar("dim_moves_U"));
  SET_STRING_ELT(nms, 93, mkChar("dim_moves_U_1"));
  SET_STRING_ELT(nms, 94, mkChar("dim_moves_U_2"));
  SET_STRING_ELT(nms, 95, mkChar("dim_parm_ifrac_prevTPT"));
  SET_STRING_ELT(nms, 96, mkChar("dim_parm_init_PPD"));
  SET_STRING_ELT(nms, 97, mkChar("dim_ppop"));
  SET_STRING_ELT(nms, 98, mkChar("dim_ppop_1"));
  SET_STRING_ELT(nms, 99, mkChar("dim_ppop_2"));
  SET_STRING_ELT(nms, 100, mkChar("dim_Preinfections"));
  SET_STRING_ELT(nms, 101, mkChar("dim_Preinfections_1"));
  SET_STRING_ELT(nms, 102, mkChar("dim_Preinfections_2"));
  SET_STRING_ELT(nms, 103, mkChar("dim_qolrate"));
  SET_STRING_ELT(nms, 104, mkChar("dim_qolrate_1"));
  SET_STRING_ELT(nms, 105, mkChar("dim_qolrate_2"));
  SET_STRING_ELT(nms, 106, mkChar("dim_reinfections"));
  SET_STRING_ELT(nms, 107, mkChar("dim_reinfections_1"));
  SET_STRING_ELT(nms, 108, mkChar("dim_reinfections_2"));
  SET_STRING_ELT(nms, 109, mkChar("dim_relapses"));
  SET_STRING_ELT(nms, 110, mkChar("dim_relapses_1"));
  SET_STRING_ELT(nms, 111, mkChar("dim_relapses_2"));
  SET_STRING_ELT(nms, 112, mkChar("dim_rfv"));
  SET_STRING_ELT(nms, 113, mkChar("dim_SD"));
  SET_STRING_ELT(nms, 114, mkChar("dim_SD_1"));
  SET_STRING_ELT(nms, 115, mkChar("dim_SD_2"));
  SET_STRING_ELT(nms, 116, mkChar("dim_selfcures"));
  SET_STRING_ELT(nms, 117, mkChar("dim_selfcures_1"));
  SET_STRING_ELT(nms, 118, mkChar("dim_selfcures_2"));
  SET_STRING_ELT(nms, 119, mkChar("dim_slowprogs"));
  SET_STRING_ELT(nms, 120, mkChar("dim_slowprogs_1"));
  SET_STRING_ELT(nms, 121, mkChar("dim_slowprogs_2"));
  SET_STRING_ELT(nms, 122, mkChar("dim_stabilizations"));
  SET_STRING_ELT(nms, 123, mkChar("dim_stabilizations_1"));
  SET_STRING_ELT(nms, 124, mkChar("dim_stabilizations_2"));
  SET_STRING_ELT(nms, 125, mkChar("dim_tbmort"));
  SET_STRING_ELT(nms, 126, mkChar("dim_tbmort_1"));
  SET_STRING_ELT(nms, 127, mkChar("dim_tbmort_2"));
  SET_STRING_ELT(nms, 128, mkChar("dim_tbstops"));
  SET_STRING_ELT(nms, 129, mkChar("dim_tbstops_1"));
  SET_STRING_ELT(nms, 130, mkChar("dim_tbstops_2"));
  SET_STRING_ELT(nms, 131, mkChar("dim_tpt_E"));
  SET_STRING_ELT(nms, 132, mkChar("dim_tpt_E_1"));
  SET_STRING_ELT(nms, 133, mkChar("dim_tpt_E_2"));
  SET_STRING_ELT(nms, 134, mkChar("dim_tpt_epTB"));
  SET_STRING_ELT(nms, 135, mkChar("dim_tpt_epTB_1"));
  SET_STRING_ELT(nms, 136, mkChar("dim_tpt_epTB_2"));
  SET_STRING_ELT(nms, 137, mkChar("dim_tpt_L"));
  SET_STRING_ELT(nms, 138, mkChar("dim_tpt_L_1"));
  SET_STRING_ELT(nms, 139, mkChar("dim_tpt_L_2"));
  SET_STRING_ELT(nms, 140, mkChar("dim_tpt_lpTB"));
  SET_STRING_ELT(nms, 141, mkChar("dim_tpt_lpTB_1"));
  SET_STRING_ELT(nms, 142, mkChar("dim_tpt_lpTB_2"));
  SET_STRING_ELT(nms, 143, mkChar("dim_TPT_mid"));
  SET_STRING_ELT(nms, 144, mkChar("dim_TPT_top"));
  SET_STRING_ELT(nms, 145, mkChar("dim_U"));
  SET_STRING_ELT(nms, 146, mkChar("dim_U_1"));
  SET_STRING_ELT(nms, 147, mkChar("dim_U_2"));
  SET_STRING_ELT(nms, 148, mkChar("dim_worsens"));
  SET_STRING_ELT(nms, 149, mkChar("dim_worsens_1"));
  SET_STRING_ELT(nms, 150, mkChar("dim_worsens_2"));
  SET_STRING_ELT(nms, 151, mkChar("disc_rate"));
  SET_STRING_ELT(nms, 152, mkChar("drn"));
  SET_STRING_ELT(nms, 153, mkChar("eps"));
  SET_STRING_ELT(nms, 154, mkChar("Ereinfections"));
  SET_STRING_ELT(nms, 155, mkChar("fastprogs"));
  SET_STRING_ELT(nms, 156, mkChar("foi"));
  ...
  SET_STRING_ELT(nms, 165, mkChar("hrqol"));
  SET_STRING_ELT(nms, 166, mkChar("hrqolptb"));
  SET_STRING_ELT(nms, 167, mkChar("hrv"));
  SET_STRING_ELT(nms, 168, mkChar("infections"));
  SET_STRING_ELT(nms, 169, mkChar("inflow"));
  SET_STRING_ELT(nms, 170, mkChar("inflow_notx_L0"));
  SET_STRING_ELT(nms, 171, mkChar("inflow_notx_L1"));
  SET_STRING_ELT(nms, 172, mkChar("inflow_notx_no0"));
  SET_STRING_ELT(nms, 173, mkChar("inflow_notx_no1"));
  SET_STRING_ELT(nms, 174, mkChar("inflow_notx_TB0"));
  SET_STRING_ELT(nms, 175, mkChar("inflow_notx_TB1"));
  SET_STRING_ELT(nms, 176, mkChar("inflow_toATT_L0"));
  SET_STRING_ELT(nms, 177, mkChar("inflow_toATT_L1"));
  SET_STRING_ELT(nms, 178, mkChar("inflow_toATT_no0"));
  SET_STRING_ELT(nms, 179, mkChar("inflow_toATT_no1"));
  SET_STRING_ELT(nms, 180, mkChar("inflow_toATT_TB0"));
  SET_STRING_ELT(nms, 181, mkChar("inflow_toATT_TB1"));
  SET_STRING_ELT(nms, 182, mkChar("inflow_top"));
  SET_STRING_ELT(nms, 183, mkChar("inflow_toTPT_L0"));
  SET_STRING_ELT(nms, 184, mkChar("inflow_toTPT_L1"));
  SET_STRING_ELT(nms, 185, mkChar("inflow_toTPT_no0"));
  SET_STRING_ELT(nms, 186, mkChar("inflow_toTPT_no1"));
  SET_STRING_ELT(nms, 187, mkChar("inflow_toTPT_TB0"));
  SET_STRING_ELT(nms, 188, mkChar("inflow_toTPT_TB1"));
  SET_STRING_ELT(nms, 189, mkChar("inflow_TPTv"));
  SET_STRING_ELT(nms, 190, mkChar("inFM"));
  SET_STRING_ELT(nms, 191, mkChar("initial_ATT"));
  SET_STRING_ELT(nms, 192, mkChar("initial_C0inFM"));
  SET_STRING_ELT(nms, 193, mkChar("initial_cases"));
  SET_STRING_ELT(nms, 194, mkChar("initial_casesout"));
  SET_STRING_ELT(nms, 195, mkChar("initial_cATTfp"));
  SET_STRING_ELT(nms, 196, mkChar("initial_cATTtp"));
  SET_STRING_ELT(nms, 197, mkChar("initial_CC"));
  SET_STRING_ELT(nms, 198, mkChar("initial_CC0"));
  SET_STRING_ELT(nms, 199, mkChar("initial_CC0inflow"));
  SET_STRING_ELT(nms, 200, mkChar("initial_CC0inside"));
  SET_STRING_ELT(nms, 201, mkChar("initial_CC0outside"));
  SET_STRING_ELT(nms, 202, mkChar("initial_CD"));
  SET_STRING_ELT(nms, 203, mkChar("initial_cTPT"));
  SET_STRING_ELT(nms, 204, mkChar("initial_deaths"));
  SET_STRING_ELT(nms, 205, mkChar("initial_dLYL"));
  SET_STRING_ELT(nms, 206, mkChar("initial_E"));
  SET_STRING_ELT(nms, 207, mkChar("initial_epTB"));
  SET_STRING_ELT(nms, 208, mkChar("initial_L"));
  SET_STRING_ELT(nms, 209, mkChar("initial_lpTB"));
  SET_STRING_ELT(nms, 210, mkChar("initial_qoldec"));
  SET_STRING_ELT(nms, 211, mkChar("initial_SD"));
  SET_STRING_ELT(nms, 212, mkChar("initial_U"));
  SET_STRING_ELT(nms, 213, mkChar("int_time"));
  SET_STRING_ELT(nms, 214, mkChar("late_post_time"));
  SET_STRING_ELT(nms, 215, mkChar("LifeExp"));
  SET_STRING_ELT(nms, 216, mkChar("long_release"));
  SET_STRING_ELT(nms, 217, mkChar("long_short"));
  SET_STRING_ELT(nms, 218, mkChar("Lreinfections"));
  SET_STRING_ELT(nms, 219, mkChar("m"));
  SET_STRING_ELT(nms, 220, mkChar("mHR"));
  SET_STRING_ELT(nms, 221, mkChar("mort"));
  SET_STRING_ELT(nms, 222, mkChar("moves_ATT"));
  SET_STRING_ELT(nms, 223, mkChar("moves_CD"));
  SET_STRING_ELT(nms, 224, mkChar("moves_E"));
  SET_STRING_ELT(nms, 225, mkChar("moves_epTB"));
  SET_STRING_ELT(nms, 226, mkChar("moves_L"));
  SET_STRING_ELT(nms, 227, mkChar("moves_lpTB"));
  SET_STRING_ELT(nms, 228, mkChar("moves_SD"));
  SET_STRING_ELT(nms, 229, mkChar("moves_U"));
  SET_STRING_ELT(nms, 230, mkChar("NP"));
  SET_STRING_ELT(nms, 231, mkChar("NT"));
  SET_STRING_ELT(nms, 232, mkChar("offset_variable_ATT"));
  SET_STRING_ELT(nms, 233, mkChar("offset_variable_C0inFM"));
  SET_STRING_ELT(nms, 234, mkChar("offset_variable_CD"));
  SET_STRING_ELT(nms, 235, mkChar("offset_variable_E"));
  SET_STRING_ELT(nms, 236, mkChar("offset_variable_epTB"));
  SET_STRING_ELT(nms, 237, mkChar("offset_variable_L"));
  SET_STRING_ELT(nms, 238, mkChar("offset_variable_lpTB"));
  SET_STRING_ELT(nms, 239, mkChar("offset_variable_SD"));
  SET_STRING_ELT(nms, 240, mkChar("open_release"));
  SET_STRING_ELT(nms, 241, mkChar("parm_frac_ATT"));
  SET_STRING_ELT(nms, 242, mkChar("parm_frac_CD"));
  SET_STRING_ELT(nms, 243, mkChar("parm_frac_E"));
  SET_STRING_ELT(nms, 244, mkChar("parm_frac_epTB"));
  SET_STRING_ELT(nms, 245, mkChar("parm_frac_L"));
  SET_STRING_ELT(nms, 246, mkChar("parm_frac_lpTB"));
  SET_STRING_ELT(nms, 247, mkChar("parm_frac_SD"));
  SET_STRING_ELT(nms, 248, mkChar("parm_frac_U"));
  SET_STRING_ELT(nms, 249, mkChar("parm_ifrac_ATT"));
  SET_STRING_ELT(nms, 250, mkChar("parm_ifrac_CD"));
  SET_STRING_ELT(nms, 251, mkChar("parm_ifrac_E"));
  SET_STRING_ELT(nms, 252, mkChar("parm_ifrac_epTB"));
  SET_STRING_ELT(nms, 253, mkChar("parm_ifrac_L"));
  SET_STRING_ELT(nms, 254, mkChar("parm_ifrac_lpTB"));
  SET_STRING_ELT(nms, 255, mkChar("parm_ifrac_prevTPT"));
  SET_STRING_ELT(nms, 256, mkChar("parm_ifrac_SD"));
  SET_STRING_ELT(nms, 257, mkChar("parm_ifrac_U"));
  SET_STRING_ELT(nms, 258, mkChar("parm_init_PPD"));
  SET_STRING_ELT(nms, 259, mkChar("ppop"));
  SET_STRING_ELT(nms, 260, mkChar("Preinfections"));
  SET_STRING_ELT(nms, 261, mkChar("previous_remand"));
  SET_STRING_ELT(nms, 262, mkChar("prg"));
  SET_STRING_ELT(nms, 263, mkChar("ptn"));
  SET_STRING_ELT(nms, 264, mkChar("qolrate"));
  SET_STRING_ELT(nms, 265, mkChar("reinfections"));
  SET_STRING_ELT(nms, 266, mkChar("rel"));
  SET_STRING_ELT(nms, 267, mkChar("relapses"));
  SET_STRING_ELT(nms, 268, mkChar("remand_long"));
  SET_STRING_ELT(nms, 269, mkChar("remand_release"));
  SET_STRING_ELT(nms, 270, mkChar("remand_short"));
  SET_STRING_ELT(nms, 271, mkChar("rfv"));
  SET_STRING_ELT(nms, 272, mkChar("selfcures"));
  SET_STRING_ELT(nms, 273, mkChar("short_open"));
  SET_STRING_ELT(nms, 274, mkChar("short_release"));
  SET_STRING_ELT(nms, 275, mkChar("slowprogs"));
  SET_STRING_ELT(nms, 276, mkChar("stabilizations"));
  SET_STRING_ELT(nms, 277, mkChar("staticfoi"));
  SET_STRING_ELT(nms, 278, mkChar("stb"));
  SET_STRING_ELT(nms, 279, mkChar("tbmort"));
  SET_STRING_ELT(nms, 280, mkChar("tbstops"));
  SET_STRING_ELT(nms, 281, mkChar("tpt_drn"));
  SET_STRING_ELT(nms, 282, mkChar("tpt_E"));
  SET_STRING_ELT(nms, 283, mkChar("tpt_epTB"));
  SET_STRING_ELT(nms, 284, mkChar("tpt_L"));
  SET_STRING_ELT(nms, 285, mkChar("tpt_lpTB"));
  SET_STRING_ELT(nms, 286, mkChar("TPT_mid"));
  SET_STRING_ELT(nms, 287, mkChar("TPT_top"));
  SET_STRING_ELT(nms, 288, mkChar("tptHR"));
  SET_STRING_ELT(nms, 289, mkChar("txf"));
  SET_STRING_ELT(nms, 290, mkChar("uc_attout"));
  SET_STRING_ELT(nms, 291, mkChar("uc_attppd"));
  SET_STRING_ELT(nms, 292, mkChar("uc_entry_att_L"));
  SET_STRING_ELT(nms, 293, mkChar("uc_entry_att_no"));
  SET_STRING_ELT(nms, 294, mkChar("uc_entry_att_TB"));
  SET_STRING_ELT(nms, 295, mkChar("uc_entry_notx_L"));
  SET_STRING_ELT(nms, 296, mkChar("uc_entry_notx_no"));
  SET_STRING_ELT(nms, 297, mkChar("uc_entry_notx_TB"));
  SET_STRING_ELT(nms, 298, mkChar("uc_entry_tpt_L"));
  SET_STRING_ELT(nms, 299, mkChar("uc_entry_tpt_no"));
  SET_STRING_ELT(nms, 300, mkChar("uc_entry_tpt_TB"));
  SET_STRING_ELT(nms, 301, mkChar("worsens"));
  SET_STRING_ELT(nms, 302, mkChar("wsn"));
...
SEXP tbmod0_set_user(SEXP internal_p, SEXP user) {
  ...
  internal->hrqol = user_get_scalar_double(user, "hrqol", internal->hrqol, NA_REAL, NA_REAL);
  internal->hrqolptb = user_get_scalar_double(user, "hrqolptb", internal->hrqolptb, NA_REAL, NA_REAL);
  internal->inflow = user_get_scalar_double(user, "inflow", internal->inflow, NA_REAL, NA_REAL);
  internal->inflow_notx_L0 = user_get_scalar_double(user, "inflow_notx_L0", internal->inflow_notx_L0, NA_REAL, NA_REAL);
  internal->inflow_notx_L1 = user_get_scalar_double(user, "inflow_notx_L1", internal->inflow_notx_L1, NA_REAL, NA_REAL);
  internal->inflow_notx_no0 = user_get_scalar_double(user, "inflow_notx_no0", internal->inflow_notx_no0, NA_REAL, NA_REAL);
  internal->inflow_notx_no1 = user_get_scalar_double(user, "inflow_notx_no1", internal->inflow_notx_no1, NA_REAL, NA_REAL);
  internal->inflow_notx_TB0 = user_get_scalar_double(user, "inflow_notx_TB0", internal->inflow_notx_TB0, NA_REAL, NA_REAL);
  internal->inflow_notx_TB1 = user_get_scalar_double(user, "inflow_notx_TB1", internal->inflow_notx_TB1, NA_REAL, NA_REAL);
  internal->inflow_toATT_L0 = user_get_scalar_double(user, "inflow_toATT_L0", internal->inflow_toATT_L0, NA_REAL, NA_REAL);
  internal->inflow_toATT_L1 = user_get_scalar_double(user, "inflow_toATT_L1", internal->inflow_toATT_L1, NA_REAL, NA_REAL);
  internal->inflow_toATT_no0 = user_get_scalar_double(user, "inflow_toATT_no0", internal->inflow_toATT_no0, NA_REAL, NA_REAL);
  internal->inflow_toATT_no1 = user_get_scalar_double(user, "inflow_toATT_no1", internal->inflow_toATT_no1, NA_REAL, NA_REAL);
  ...
  internal->inflow_toTPT_no0 = user_get_scalar_double(user, "inflow_toTPT_no0", internal->inflow_toTPT_no0, NA_REAL, NA_REAL);
  internal->inflow_toTPT_no1 = user_get_scalar_double(user, "inflow_toTPT_no1", internal->inflow_toTPT_no1, NA_REAL, NA_REAL);
  internal->inflow_toTPT_TB0 = user_get_scalar_double(user, "inflow_toTPT_TB0", internal->inflow_toTPT_TB0, NA_REAL, NA_REAL);
  internal->inflow_toTPT_TB1 = user_get_scalar_double(user, "inflow_toTPT_TB1", internal->inflow_toTPT_TB1, NA_REAL, NA_REAL);
  ...
  internal->LifeExp = user_get_scalar_double(user, "LifeExp", internal->LifeExp, NA_REAL, NA_REAL);
  ...
  internal->uc_attout = user_get_scalar_double(user, "uc_attout", internal->uc_attout, NA_REAL, NA_REAL);
  internal->uc_attppd = user_get_scalar_double(user, "uc_attppd", internal->uc_attppd, NA_REAL, NA_REAL);
  internal->uc_entry_att_L = user_get_scalar_double(user, "uc_entry_att_L", internal->uc_entry_att_L, NA_REAL, NA_REAL);
  internal->uc_entry_att_no = user_get_scalar_double(user, "uc_entry_att_no", internal->uc_entry_att_no, NA_REAL, NA_REAL);
  internal->uc_entry_att_TB = user_get_scalar_double(user, "uc_entry_att_TB", internal->uc_entry_att_TB, NA_REAL, NA_REAL);
  internal->uc_entry_notx_L = user_get_scalar_double(user, "uc_entry_notx_L", internal->uc_entry_notx_L, NA_REAL, NA_REAL);
  internal->uc_entry_notx_no = user_get_scalar_double(user, "uc_entry_notx_no", internal->uc_entry_notx_no, NA_REAL, NA_REAL);
  internal->uc_entry_notx_TB = user_get_scalar_double(user, "uc_entry_notx_TB", internal->uc_entry_notx_TB, NA_REAL, NA_REAL);
  internal->uc_entry_tpt_L = user_get_scalar_double(user, "uc_entry_tpt_L", internal->uc_entry_tpt_L, NA_REAL, NA_REAL);
  internal->uc_entry_tpt_no = user_get_scalar_double(user, "uc_entry_tpt_no", internal->uc_entry_tpt_no, NA_REAL, NA_REAL);
  internal->uc_entry_tpt_TB = user_get_scalar_double(user, "uc_entry_tpt_TB", internal->uc_entry_tpt_TB, NA_REAL, NA_REAL);
...
SEXP tbmod0_metadata(SEXP internal_p) {
  ...
  int * dim_E = INTEGER(VECTOR_ELT(variable_length, 14));
  dim_E[0] = internal->dim_E_1;
  dim_E[1] = internal->dim_E_2;
  SET_VECTOR_ELT(variable_length, 15, allocVector(INTSXP, 2));
  int * dim_L = INTEGER(VECTOR_ELT(variable_length, 15));
  dim_L[0] = internal->dim_L_1;
  dim_L[1] = internal->dim_L_2;
  SET_VECTOR_ELT(variable_length, 16, allocVector(INTSXP, 2));
  int * dim_SD = INTEGER(VECTOR_ELT(variable_length, 16));
  dim_SD[0] = internal->dim_SD_1;
  dim_SD[1] = internal->dim_SD_2;
  SET_VECTOR_ELT(variable_length, 17, allocVector(INTSXP, 2));
  int * dim_CD = INTEGER(VECTOR_ELT(variable_length, 17));
  dim_CD[0] = internal->dim_CD_1;
  dim_CD[1] = internal->dim_CD_2;
  SET_VECTOR_ELT(variable_length, 18, allocVector(INTSXP, 2));
  int * dim_ATT = INTEGER(VECTOR_ELT(variable_length, 18));
  dim_ATT[0] = internal->dim_ATT_1;
  dim_ATT[1] = internal->dim_ATT_2;
  SET_VECTOR_ELT(variable_length, 19, allocVector(INTSXP, 2));
  int * dim_epTB = INTEGER(VECTOR_ELT(variable_length, 19));
  dim_epTB[0] = internal->dim_epTB_1;
  dim_epTB[1] = internal->dim_epTB_2;
  SET_VECTOR_ELT(variable_length, 20, allocVector(INTSXP, 2));
  int * dim_lpTB = INTEGER(VECTOR_ELT(variable_length, 20));
  dim_lpTB[0] = internal->dim_lpTB_1;
  dim_lpTB[1] = internal->dim_lpTB_2;
  SET_VECTOR_ELT(variable_length, 21, allocVector(INTSXP, 2));
  int * dim_C0inFM = INTEGER(VECTOR_ELT(variable_length, 21));
  dim_C0inFM[0] = internal->dim_C0inFM_1;
  dim_C0inFM[1] = internal->dim_C0inFM_2;
  SET_STRING_ELT(variable_names, 0, mkChar("CC0"));
  SET_STRING_ELT(variable_names, 1, mkChar("CC"));
  SET_STRING_ELT(variable_names, 2, mkChar("CC0inflow"));
  SET_STRING_ELT(variable_names, 3, mkChar("CC0inside"));
  SET_STRING_ELT(variable_names, 4, mkChar("CC0outside"));
  SET_STRING_ELT(variable_names, 5, mkChar("cATTtp"));
  SET_STRING_ELT(variable_names, 6, mkChar("cATTfp"));
  SET_STRING_ELT(variable_names, 7, mkChar("cTPT"));
  SET_STRING_ELT(variable_names, 8, mkChar("dLYL"));
  SET_STRING_ELT(variable_names, 9, mkChar("deaths"));
  SET_STRING_ELT(variable_names, 10, mkChar("qoldec"));
  SET_STRING_ELT(variable_names, 11, mkChar("cases"));
  SET_STRING_ELT(variable_names, 12, mkChar("casesout"));
  SET_STRING_ELT(variable_names, 13, mkChar("U"));
  SET_STRING_ELT(variable_names, 14, mkChar("E"));
  SET_STRING_ELT(variable_names, 15, mkChar("L"));
  SET_STRING_ELT(variable_names, 16, mkChar("SD"));
  SET_STRING_ELT(variable_names, 17, mkChar("CD"));
  SET_STRING_ELT(variable_names, 18, mkChar("ATT"));
  SET_STRING_ELT(variable_names, 19, mkChar("epTB"));
  SET_STRING_ELT(variable_names, 20, mkChar("lpTB"));
  SET_STRING_ELT(variable_names, 21, mkChar("C0inFM"));
  ...
  SET_STRING_ELT(output_names, 0, mkChar("notif100k"));
  SET_STRING_ELT(output_names, 1, mkChar("ppdpop"));
  SET_STRING_ELT(output_names, 2, mkChar("tbincout"));
  SET_STRING_ELT(output_names, 3, mkChar("tbincall"));
...
SEXP tbmod0_initial_conditions(SEXP internal_p, SEXP t_ptr) {
  tbmod0_internal *internal = tbmod0_get_internal(internal_p, 1);
  SEXP r_state = PROTECT(allocVector(REALSXP, internal->dim_ATT + internal->dim_C0inFM + internal->dim_CD + internal->dim_E + internal->dim_epTB + internal->dim_L + internal->dim_lpTB + internal->dim_SD + internal->dim_U + 13));
  double * state = REAL(r_state);
  state[0] = internal->initial_CC0;
  state[1] = internal->initial_CC;
  state[2] = internal->initial_CC0inflow;
  state[3] = internal->initial_CC0inside;
  state[4] = internal->initial_CC0outside;
  state[5] = internal->initial_cATTtp;
  state[6] = internal->initial_cATTfp;
  state[7] = internal->initial_cTPT;
  state[8] = internal->initial_dLYL;
  state[9] = internal->initial_deaths;
  state[10] = internal->initial_qoldec;
  state[11] = internal->initial_cases;
  state[12] = internal->initial_casesout;
  memcpy(state + 13, internal->initial_U, internal->dim_U * sizeof(double));
  ...
  memcpy(state + internal->offset_variable_C0inFM, internal->initial_C0inFM, internal->dim_C0inFM * sizeof(double));
  UNPROTECT(1);
  return r_state;
}
void tbmod0_rhs(tbmod0_internal* internal, double t, double * state, double * dstatedt, double * output) {
  ...
  double inflow_toNOTX_L = (t > internal->int_time ? internal->inflow_notx_L1 : internal->inflow_notx_L0);
  double inflow_toNOTX_no = (t > internal->int_time ? internal->inflow_notx_no1 : internal->inflow_notx_no0);
  double inflow_toNOTX_TB = (t > internal->int_time ? internal->inflow_notx_TB1 : internal->inflow_notx_TB0);
  ...
  double CCDinflow = internal->inflow * (internal->uc_entry_tpt_TB * (inflow_toTPT_TB) * (internal->parm_frac_SD + internal->parm_frac_CD) + internal->uc_entry_tpt_L * (inflow_toTPT_L) * (internal->parm_frac_E + internal->parm_frac_L + internal->parm_frac_epTB + internal->parm_frac_lpTB) + internal->uc_entry_tpt_no * (inflow_toTPT_no) * internal->parm_frac_U + internal->uc_entry_att_TB * (inflow_toATT_TB) * (internal->parm_frac_SD + internal->parm_frac_CD) + internal->uc_entry_att_L * (inflow_toATT_L) * (internal->parm_frac_E + internal->parm_frac_L + internal->parm_frac_epTB + internal->parm_frac_lpTB) + internal->uc_entry_att_no * (inflow_toATT_no) * internal->parm_frac_U + internal->uc_entry_notx_TB * (inflow_toNOTX_TB) * (internal->parm_frac_SD + internal->parm_frac_CD) + internal->uc_entry_notx_L * (inflow_toNOTX_L) * (internal->parm_frac_E + internal->parm_frac_L + internal->parm_frac_epTB + internal->parm_frac_lpTB) + internal->uc_entry_notx_no * (inflow_toNOTX_no) * internal->parm_frac_U);
  dstatedt[6] = internal->inflow * ((internal->parm_frac_L + internal->parm_frac_E + internal->parm_frac_epTB + internal->parm_frac_lpTB) * inflow_toATT_L + internal->parm_frac_U * inflow_toATT_no) * (t > internal->int_time ? 1 : 0);
  dstatedt[2] = CCDinflow * (t > internal->int_time ? 1 : 0);
  {
     int i = 1;
     internal->inflow_TPTv[i - 1] = inflow_toNOTX_L;
  }
  {
     int i = 2;
  ...
  }
  {
     int i = 1;
     int j = 1;
     internal->inFM[i - 1 + internal->dim_inFM_1 * (j - 1)] = (inflow_toATT_TB) * (internal->parm_frac_SD + internal->parm_frac_CD) * internal->inflow;
  }
  {
     int i = 1;
     int j = 2;
     internal->inFM[i - 1 + internal->dim_inFM_1 * (j - 1)] = (inflow_toATT_L) * (internal->parm_frac_E + internal->parm_frac_L + internal->parm_frac_epTB + internal->parm_frac_lpTB) * internal->inflow;
  }
  {
     int i = 1;
     int j = 3;
     internal->inFM[i - 1 + internal->dim_inFM_1 * (j - 1)] = (inflow_toATT_no) * internal->parm_frac_U * internal->inflow;
  }
  {
     int i = 2;
     int j = 1;
     internal->inFM[i - 1 + internal->dim_inFM_1 * (j - 1)] = (inflow_toTPT_TB) * (internal->parm_frac_SD + internal->parm_frac_CD) * internal->inflow;
  }
  {
     int i = 2;
     int j = 2;
     internal->inFM[i - 1 + internal->dim_inFM_1 * (j - 1)] = (inflow_toTPT_L) * (internal->parm_frac_E + internal->parm_frac_L + internal->parm_frac_epTB + internal->parm_frac_lpTB) * internal->inflow;
  }
  {
     int i = 2;
     int j = 3;
     internal->inFM[i - 1 + internal->dim_inFM_1 * (j - 1)] = (inflow_toTPT_no) * internal->parm_frac_U * internal->inflow;
  }
  {
     int i = 3;
     int j = 1;
     internal->inFM[i - 1 + internal->dim_inFM_1 * (j - 1)] = (inflow_toNOTX_TB) * (internal->parm_frac_SD + internal->parm_frac_CD) * internal->inflow;
  }
  {
     int i = 3;
     int j = 2;
     internal->inFM[i - 1 + internal->dim_inFM_1 * (j - 1)] = (inflow_toNOTX_L) * (internal->parm_frac_E + internal->parm_frac_L + internal->parm_frac_epTB + internal->parm_frac_lpTB) * internal->inflow;
  }
  {
     int i = 3;
     int j = 3;
     internal->inFM[i - 1 + internal->dim_inFM_1 * (j - 1)] = (inflow_toNOTX_no) * internal->parm_frac_U * internal->inflow;
  }
  for (int i = 1; i <= internal->dim_C0inFM_1; ++i) {
    for (int j = 1; j <= internal->dim_C0inFM_2; ++j) {
      dstatedt[internal->offset_variable_C0inFM + i - 1 + internal->dim_C0inFM_1 * (j - 1)] = internal->inFM[internal->dim_inFM_1 * (j - 1) + i - 1] * (t > internal->int_time ? 1 : 0);
    }
  }
  ...
  for (int i = 1; i <= internal->dim_frac_CD_1; ++i) {
    for (int j = 1; j <= internal->dim_frac_CD_2; ++j) {
      internal->frac_CD[i - 1 + internal->dim_frac_CD_1 * (j - 1)] = internal->parm_frac_CD * internal->inflow_top[i - 1] * (inflow_toNOTX_TB * internal->TPT_top[j - 1] + inflow_toTPT_TB * internal->TPT_mid[j - 1]);
    }
  }
  ...
  for (int i = 1; i <= internal->dim_frac_SD_1; ++i) {
    for (int j = 1; j <= internal->dim_frac_SD_2; ++j) {
      internal->frac_SD[i - 1 + internal->dim_frac_SD_1 * (j - 1)] = internal->parm_frac_SD * internal->inflow_top[i - 1] * (inflow_toNOTX_TB * internal->TPT_top[j - 1] + inflow_toTPT_TB * internal->TPT_mid[j - 1]);
    }
  }
  for (int i = 1; i <= internal->dim_frac_U_1; ++i) {
    for (int j = 1; j <= internal->dim_frac_U_2; ++j) {
      internal->frac_U[i - 1 + internal->dim_frac_U_1 * (j - 1)] = internal->parm_frac_U * internal->inflow_top[i - 1] * (inflow_toNOTX_no * internal->TPT_top[j - 1] + inflow_toTPT_no * internal->TPT_mid[j - 1]);
    }
  }
  {
     int i = 1;
  ...
  for (int i = 1; i <= internal->dim_qolrate_1; ++i) {
    for (int j = 1; j <= internal->dim_qolrate_2; ++j) {
      internal->qolrate[i - 1 + internal->dim_qolrate_1 * (j - 1)] = internal->hrqol * CD[internal->dim_CD_1 * (j - 1) + i - 1] + internal->hrqolptb * epTB[internal->dim_epTB_1 * (j - 1) + i - 1] + internal->hrqolptb * lpTB[internal->dim_lpTB_1 * (j - 1) + i - 1];
    }
  }
  ...
  for (int i = 1; i <= internal->dim_tbmort_1; ++i) {
    for (int j = 1; j <= internal->dim_tbmort_2; ++j) {
      internal->tbmort[i - 1 + internal->dim_tbmort_1 * (j - 1)] = internal->CFR * CD[internal->dim_CD_1 * (j - 1) + i - 1] / (double) internal->drn + internal->txf * ATT[internal->dim_ATT_1 * (j - 1) + i - 1] / (double) internal->att_time + (internal->mHR - 1) * internal->mort * epTB[internal->dim_epTB_1 * (j - 1) + i - 1] + (internal->mHR - 1) * internal->mort * lpTB[internal->dim_lpTB_1 * (j - 1) + i - 1];
    }
  }
  ...
  for (int i = 1; i <= internal->dim_tpt_E_1; ++i) {
    int j = 2;
    internal->tpt_E[i - 1 + internal->dim_tpt_E_1 * (j - 1)] = -(E[internal->dim_E_1 * 1 + i - 1]) / (double) internal->tpt_drn;
  }
  for (int i = 1; i <= internal->dim_tpt_E_1; ++i) {
    int j = 3;
    internal->tpt_E[i - 1 + internal->dim_tpt_E_1 * (j - 1)] = E[internal->dim_E_1 * 1 + i - 1] / (double) internal->tpt_drn;
  ...
  for (int i = 1; i <= internal->dim_tpt_epTB_1; ++i) {
    int j = 2;
    internal->tpt_epTB[i - 1 + internal->dim_tpt_epTB_1 * (j - 1)] = -(epTB[internal->dim_epTB_1 * 1 + i - 1]) / (double) internal->tpt_drn;
  }
  for (int i = 1; i <= internal->dim_tpt_epTB_1; ++i) {
    int j = 3;
    internal->tpt_epTB[i - 1 + internal->dim_tpt_epTB_1 * (j - 1)] = epTB[internal->dim_epTB_1 * 1 + i - 1] / (double) internal->tpt_drn;
  ...
  for (int i = 1; i <= internal->dim_tpt_L_1; ++i) {
    int j = 2;
    internal->tpt_L[i - 1 + internal->dim_tpt_L_1 * (j - 1)] = -(L[internal->dim_L_1 * 1 + i - 1]) / (double) internal->tpt_drn;
  }
  for (int i = 1; i <= internal->dim_tpt_L_1; ++i) {
    int j = 3;
    internal->tpt_L[i - 1 + internal->dim_tpt_L_1 * (j - 1)] = L[internal->dim_L_1 * 1 + i - 1] / (double) internal->tpt_drn;
  ...
  for (int i = 1; i <= internal->dim_tpt_lpTB_1; ++i) {
    int j = 2;
    internal->tpt_lpTB[i - 1 + internal->dim_tpt_lpTB_1 * (j - 1)] = -(lpTB[internal->dim_lpTB_1 * 1 + i - 1]) / (double) internal->tpt_drn;
  }
  for (int i = 1; i <= internal->dim_tpt_lpTB_1; ++i) {
    int j = 3;
    internal->tpt_lpTB[i - 1 + internal->dim_tpt_lpTB_1 * (j - 1)] = lpTB[internal->dim_lpTB_1 * 1 + i - 1] / (double) internal->tpt_drn;
  ...
  double CCDinside = internal->uc_attppd * odin_sum2(internal->detects, 0, 4, 0, internal->NT, internal->dim_detects_1);
  double CCDoutside = internal->m * internal->uc_attout * odin_sum2(internal->detects, 4, 5, 0, internal->NT, internal->dim_detects_1);
  ...
  dstatedt[11] = ((odin_sum2(internal->fastprogs, 4, 5, 0, internal->NT, internal->dim_fastprogs_1) + odin_sum2(internal->slowprogs, 4, 5, 0, internal->NT, internal->dim_slowprogs_1) + odin_sum2(internal->relapses, 4, 5, 0, internal->NT, internal->dim_relapses_1)) * (internal->m - 1) + (odin_sum1(internal->fastprogs, 0, internal->dim_fastprogs) + odin_sum1(internal->slowprogs, 0, internal->dim_slowprogs) + odin_sum1(internal->relapses, 0, internal->dim_relapses))) * (t > internal->int_time ? 1 : 0);
  dstatedt[12] = ((odin_sum2(internal->fastprogs, 4, 5, 0, internal->NT, internal->dim_fastprogs_1) + odin_sum2(internal->slowprogs, 4, 5, 0, internal->NT, internal->dim_slowprogs_1) + odin_sum2(internal->relapses, 4, 5, 0, internal->NT, internal->dim_relapses_1)) * internal->m) * (t > internal->int_time ? 1 : 0);
  dstatedt[5] = (odin_sum1(internal->detects, 0, internal->dim_detects) + internal->inflow * (internal->parm_frac_SD + internal->parm_frac_CD) * inflow_toATT_TB) * (t > internal->int_time ? 1 : 0);
  ...
  dstatedt[7] = (odin_sum2(internal->ppop, 0, internal->dim_ppop_1, 1, 2, internal->dim_ppop_1) / (double) internal->tpt_drn) * (t > internal->int_time ? 1 : 0);
  dstatedt[9] = (odin_sum1(internal->tbmort, 0, internal->dim_tbmort) + (internal->m - 1) * odin_sum2(internal->tbmort, 4, 5, 0, internal->NT, internal->dim_tbmort_1)) * (t > internal->int_time ? 1 : 0);
  dstatedt[8] = (odin_sum1(internal->tbmort, 0, internal->dim_tbmort) + (internal->m - 1) * odin_sum2(internal->tbmort, 4, 5, 0, internal->NT, internal->dim_tbmort_1)) * (1 - exp(-(internal->disc_rate) * internal->LifeExp)) / (double) (internal->disc_rate + 1.0000000000000001e-15) * (t > internal->int_time ? exp(-((t - internal->int_time)) * internal->disc_rate) : 0);
  ...
  dstatedt[10] = (odin_sum1(internal->qolrate, 0, internal->dim_qolrate) + (internal->m - 1) * odin_sum2(internal->qolrate, 4, 5, 0, internal->NT, internal->dim_qolrate_1)) * (t > internal->int_time ? exp(-((t - internal->int_time)) * internal->disc_rate) : 0);
  ...
  double CCD = CCDinflow + CCDinside + CCDoutside;
  dstatedt[3] = CCDinside * (t > internal->int_time ? 1 : 0);
  dstatedt[4] = CCDoutside * (t > internal->int_time ? 1 : 0);
  ...
  dstatedt[1] = CCD * (t > internal->int_time ? exp(-((t - internal->int_time)) * internal->disc_rate) : 0);
  dstatedt[0] = CCD * (t > internal->int_time ? 1 : 0);
  ...
  for (int i = 1; i <= internal->dim_U_1; ++i) {
    for (int j = 1; j <= internal->dim_U_2; ++j) {
      dstatedt[13 + i - 1 + internal->dim_U_1 * (j - 1)] = -(internal->infections[internal->dim_infections_1 * (j - 1) + i - 1]) - internal->mort * U[internal->dim_U_1 * (j - 1) + i - 1] + internal->inflow * internal->frac_U[internal->dim_frac_U_1 * (j - 1) + i - 1] + internal->moves_U[internal->dim_moves_U_1 * (j - 1) + i - 1];
    }
  }
  ...
  if (output) {
    output[0] = 100000 * odin_sum2(internal->detects, 0, 4, 0, internal->NT, internal->dim_detects_1) / (double) (odin_sum2(internal->ppop, 0, 4, 0, internal->NT, internal->dim_ppop_1) + 0.01);
    output[1] = odin_sum2(internal->ppop, 0, 4, 0, internal->NT, internal->dim_ppop_1);
    output[3] = (odin_sum2(internal->fastprogs, 4, 5, 0, internal->NT, internal->dim_fastprogs_1) + odin_sum2(internal->slowprogs, 4, 5, 0, internal->NT, internal->dim_slowprogs_1) + odin_sum2(internal->relapses, 4, 5, 0, internal->NT, internal->dim_relapses_1)) * (internal->m - 1) + (odin_sum1(internal->fastprogs, 0, internal->dim_fastprogs) + odin_sum1(internal->slowprogs, 0, internal->dim_slowprogs) + odin_sum1(internal->relapses, 0, internal->dim_relapses));
    output[2] = (odin_sum2(internal->fastprogs, 4, 5, 0, internal->NT, internal->dim_fastprogs_1) + odin_sum2(internal->slowprogs, 4, 5, 0, internal->NT, internal->dim_slowprogs_1) + odin_sum2(internal->relapses, 4, 5, 0, internal->NT, internal->dim_relapses_1)) * internal->m;
  }
}
void tbmod0_rhs_dde(size_t neq, double t, double * state, double * dstatedt, void * internal) {
...
void tbmod0_output_dde(size_t n_eq, double t, double * state, size_t n_output, double * output, void * internal_p) {
  tbmod0_internal *internal = (tbmod0_internal*) internal_p;
  double * U = state + 13;
  double * E = state + internal->offset_variable_E;
  double * L = state + internal->offset_variable_L;
  double * SD = state + internal->offset_variable_SD;
