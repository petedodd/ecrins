...
SEXP tbmod0_create(SEXP user) {
  ...
  internal->offset_variable_ATT = internal->dim_CD + internal->dim_E + internal->dim_L + internal->dim_SD + internal->dim_U + 10;
  internal->offset_variable_CD = internal->dim_E + internal->dim_L + internal->dim_SD + internal->dim_U + 10;
  internal->offset_variable_E = internal->dim_U + 10;
  internal->offset_variable_epTB = internal->dim_ATT + internal->dim_CD + internal->dim_E + internal->dim_L + internal->dim_SD + internal->dim_U + 10;
  internal->offset_variable_L = internal->dim_E + internal->dim_U + 10;
  internal->offset_variable_lpTB = internal->dim_ATT + internal->dim_CD + internal->dim_E + internal->dim_epTB + internal->dim_L + internal->dim_SD + internal->dim_U + 10;
  internal->offset_variable_SD = internal->dim_E + internal->dim_L + internal->dim_U + 10;
  for (int i = 1; i <= 4; ++i) {
    internal->rfv[i - 1] = 1;
  }
  {
...
SEXP tbmod0_contents(SEXP internal_p) {
  ...
  SEXP contents = PROTECT(allocVector(VECSXP, 291));
  ...
  SET_VECTOR_ELT(contents, 191, initial_CD);
  SET_VECTOR_ELT(contents, 192, ScalarReal(internal->initial_cTPT));
  SET_VECTOR_ELT(contents, 193, ScalarReal(internal->initial_deaths));
  SET_VECTOR_ELT(contents, 194, ScalarReal(internal->initial_dLYL));
  ...
  SET_VECTOR_ELT(contents, 195, initial_E);
  ...
  SET_VECTOR_ELT(contents, 196, initial_epTB);
  ...
  SET_VECTOR_ELT(contents, 197, initial_L);
  ...
  SET_VECTOR_ELT(contents, 198, initial_lpTB);
  SET_VECTOR_ELT(contents, 199, ScalarReal(internal->initial_qoldec));
  ...
  SET_VECTOR_ELT(contents, 200, initial_SD);
  ...
  SET_VECTOR_ELT(contents, 201, initial_U);
  SET_VECTOR_ELT(contents, 202, ScalarReal(internal->int_time));
  SET_VECTOR_ELT(contents, 203, ScalarReal(internal->late_post_time));
  SET_VECTOR_ELT(contents, 204, ScalarReal(internal->LifeExp));
  SET_VECTOR_ELT(contents, 205, ScalarReal(internal->long_release));
  SET_VECTOR_ELT(contents, 206, ScalarReal(internal->long_short));
  ...
  SET_VECTOR_ELT(contents, 207, Lreinfections);
  SET_VECTOR_ELT(contents, 208, ScalarReal(internal->m));
  SET_VECTOR_ELT(contents, 209, ScalarReal(internal->mHR));
  SET_VECTOR_ELT(contents, 210, ScalarReal(internal->mort));
  ...
  SET_VECTOR_ELT(contents, 211, moves_ATT);
  ...
  SET_VECTOR_ELT(contents, 212, moves_CD);
  ...
  SET_VECTOR_ELT(contents, 213, moves_E);
  ...
  SET_VECTOR_ELT(contents, 214, moves_epTB);
  ...
  SET_VECTOR_ELT(contents, 217, moves_SD);
  ...
  SET_VECTOR_ELT(contents, 218, moves_U);
  SET_VECTOR_ELT(contents, 219, ScalarInteger(internal->NP));
  SET_VECTOR_ELT(contents, 220, ScalarInteger(internal->NT));
  SET_VECTOR_ELT(contents, 221, ScalarInteger(internal->offset_variable_ATT));
  SET_VECTOR_ELT(contents, 222, ScalarInteger(internal->offset_variable_CD));
  SET_VECTOR_ELT(contents, 223, ScalarInteger(internal->offset_variable_E));
  SET_VECTOR_ELT(contents, 224, ScalarInteger(internal->offset_variable_epTB));
  SET_VECTOR_ELT(contents, 225, ScalarInteger(internal->offset_variable_L));
  SET_VECTOR_ELT(contents, 226, ScalarInteger(internal->offset_variable_lpTB));
  SET_VECTOR_ELT(contents, 227, ScalarInteger(internal->offset_variable_SD));
  SET_VECTOR_ELT(contents, 228, ScalarReal(internal->open_release));
  SET_VECTOR_ELT(contents, 229, ScalarReal(internal->parm_frac_ATT));
  SET_VECTOR_ELT(contents, 230, ScalarReal(internal->parm_frac_CD));
  SET_VECTOR_ELT(contents, 231, ScalarReal(internal->parm_frac_E));
  SET_VECTOR_ELT(contents, 232, ScalarReal(internal->parm_frac_epTB));
  SET_VECTOR_ELT(contents, 233, ScalarReal(internal->parm_frac_L));
  SET_VECTOR_ELT(contents, 234, ScalarReal(internal->parm_frac_lpTB));
  SET_VECTOR_ELT(contents, 235, ScalarReal(internal->parm_frac_SD));
  SET_VECTOR_ELT(contents, 236, ScalarReal(internal->parm_frac_U));
  SET_VECTOR_ELT(contents, 237, ScalarReal(internal->parm_ifrac_ATT));
  SET_VECTOR_ELT(contents, 238, ScalarReal(internal->parm_ifrac_CD));
  SET_VECTOR_ELT(contents, 239, ScalarReal(internal->parm_ifrac_E));
  SET_VECTOR_ELT(contents, 240, ScalarReal(internal->parm_ifrac_epTB));
  SET_VECTOR_ELT(contents, 241, ScalarReal(internal->parm_ifrac_L));
  SET_VECTOR_ELT(contents, 242, ScalarReal(internal->parm_ifrac_lpTB));
  ...
  SET_VECTOR_ELT(contents, 243, parm_ifrac_prevTPT);
  SET_VECTOR_ELT(contents, 244, ScalarReal(internal->parm_ifrac_SD));
  SET_VECTOR_ELT(contents, 245, ScalarReal(internal->parm_ifrac_U));
  ...
  SET_VECTOR_ELT(contents, 246, parm_init_PPD);
  ...
  SET_VECTOR_ELT(contents, 247, ppop);
  ...
  SET_VECTOR_ELT(contents, 248, Preinfections);
  SET_VECTOR_ELT(contents, 249, ScalarReal(internal->previous_remand));
  SET_VECTOR_ELT(contents, 250, ScalarReal(internal->prg));
  SET_VECTOR_ELT(contents, 251, ScalarReal(internal->ptn));
  ...
  SET_VECTOR_ELT(contents, 252, qolrate);
  ...
  SET_VECTOR_ELT(contents, 253, reinfections);
  SET_VECTOR_ELT(contents, 254, ScalarReal(internal->rel));
  ...
  SET_VECTOR_ELT(contents, 255, relapses);
  SET_VECTOR_ELT(contents, 256, ScalarReal(internal->remand_long));
  SET_VECTOR_ELT(contents, 257, ScalarReal(internal->remand_release));
  SET_VECTOR_ELT(contents, 258, ScalarReal(internal->remand_short));
  SEXP rfv = PROTECT(allocVector(REALSXP, internal->dim_rfv));
  memcpy(REAL(rfv), internal->rfv, internal->dim_rfv * sizeof(double));
  SET_VECTOR_ELT(contents, 259, rfv);
  ...
  SET_VECTOR_ELT(contents, 260, selfcures);
  SET_VECTOR_ELT(contents, 261, ScalarReal(internal->short_open));
  SET_VECTOR_ELT(contents, 262, ScalarReal(internal->short_release));
  ...
  SET_VECTOR_ELT(contents, 263, slowprogs);
  ...
  SET_VECTOR_ELT(contents, 264, stabilizations);
  SET_VECTOR_ELT(contents, 265, ScalarReal(internal->staticfoi));
  SET_VECTOR_ELT(contents, 266, ScalarReal(internal->stb));
  ...
  SET_VECTOR_ELT(contents, 267, tbmort);
  ...
  SET_VECTOR_ELT(contents, 268, tbstops);
  SET_VECTOR_ELT(contents, 269, ScalarReal(internal->tpt_drn));
  ...
  SET_VECTOR_ELT(contents, 270, tpt_E);
  ...
  SET_VECTOR_ELT(contents, 271, tpt_epTB);
  ...
  SET_VECTOR_ELT(contents, 272, tpt_L);
  ...
  SET_VECTOR_ELT(contents, 273, tpt_lpTB);
  ...
  SET_VECTOR_ELT(contents, 274, TPT_mid);
  ...
  SET_VECTOR_ELT(contents, 275, TPT_top);
  SET_VECTOR_ELT(contents, 276, ScalarReal(internal->tptHR));
  SET_VECTOR_ELT(contents, 277, ScalarReal(internal->txf));
  SET_VECTOR_ELT(contents, 278, ScalarReal(internal->uc_attout));
  SET_VECTOR_ELT(contents, 279, ScalarReal(internal->uc_attppd));
  SET_VECTOR_ELT(contents, 280, ScalarReal(internal->uc_entry_att_L));
  SET_VECTOR_ELT(contents, 281, ScalarReal(internal->uc_entry_att_no));
  SET_VECTOR_ELT(contents, 282, ScalarReal(internal->uc_entry_att_TB));
  SET_VECTOR_ELT(contents, 283, ScalarReal(internal->uc_entry_notx_L));
  SET_VECTOR_ELT(contents, 284, ScalarReal(internal->uc_entry_notx_no));
  SET_VECTOR_ELT(contents, 285, ScalarReal(internal->uc_entry_notx_TB));
  SET_VECTOR_ELT(contents, 286, ScalarReal(internal->uc_entry_tpt_L));
  SET_VECTOR_ELT(contents, 287, ScalarReal(internal->uc_entry_tpt_no));
  SET_VECTOR_ELT(contents, 288, ScalarReal(internal->uc_entry_tpt_TB));
  ...
  SET_VECTOR_ELT(contents, 289, worsens);
  SET_VECTOR_ELT(contents, 290, ScalarReal(internal->wsn));
  SEXP nms = PROTECT(allocVector(STRSXP, 291));
  ...
  SET_STRING_ELT(nms, 191, mkChar("initial_CD"));
  SET_STRING_ELT(nms, 192, mkChar("initial_cTPT"));
  SET_STRING_ELT(nms, 193, mkChar("initial_deaths"));
  SET_STRING_ELT(nms, 194, mkChar("initial_dLYL"));
  SET_STRING_ELT(nms, 195, mkChar("initial_E"));
  SET_STRING_ELT(nms, 196, mkChar("initial_epTB"));
  SET_STRING_ELT(nms, 197, mkChar("initial_L"));
  SET_STRING_ELT(nms, 198, mkChar("initial_lpTB"));
  SET_STRING_ELT(nms, 199, mkChar("initial_qoldec"));
  SET_STRING_ELT(nms, 200, mkChar("initial_SD"));
  SET_STRING_ELT(nms, 201, mkChar("initial_U"));
  SET_STRING_ELT(nms, 202, mkChar("int_time"));
  SET_STRING_ELT(nms, 203, mkChar("late_post_time"));
  SET_STRING_ELT(nms, 204, mkChar("LifeExp"));
  SET_STRING_ELT(nms, 205, mkChar("long_release"));
  SET_STRING_ELT(nms, 206, mkChar("long_short"));
  SET_STRING_ELT(nms, 207, mkChar("Lreinfections"));
  SET_STRING_ELT(nms, 208, mkChar("m"));
  SET_STRING_ELT(nms, 209, mkChar("mHR"));
  SET_STRING_ELT(nms, 210, mkChar("mort"));
  SET_STRING_ELT(nms, 211, mkChar("moves_ATT"));
  SET_STRING_ELT(nms, 212, mkChar("moves_CD"));
  SET_STRING_ELT(nms, 213, mkChar("moves_E"));
  SET_STRING_ELT(nms, 214, mkChar("moves_epTB"));
  SET_STRING_ELT(nms, 215, mkChar("moves_L"));
  SET_STRING_ELT(nms, 216, mkChar("moves_lpTB"));
  SET_STRING_ELT(nms, 217, mkChar("moves_SD"));
  SET_STRING_ELT(nms, 218, mkChar("moves_U"));
  SET_STRING_ELT(nms, 219, mkChar("NP"));
  SET_STRING_ELT(nms, 220, mkChar("NT"));
  SET_STRING_ELT(nms, 221, mkChar("offset_variable_ATT"));
  SET_STRING_ELT(nms, 222, mkChar("offset_variable_CD"));
  SET_STRING_ELT(nms, 223, mkChar("offset_variable_E"));
  SET_STRING_ELT(nms, 224, mkChar("offset_variable_epTB"));
  SET_STRING_ELT(nms, 225, mkChar("offset_variable_L"));
  SET_STRING_ELT(nms, 226, mkChar("offset_variable_lpTB"));
  SET_STRING_ELT(nms, 227, mkChar("offset_variable_SD"));
  SET_STRING_ELT(nms, 228, mkChar("open_release"));
  SET_STRING_ELT(nms, 229, mkChar("parm_frac_ATT"));
  SET_STRING_ELT(nms, 230, mkChar("parm_frac_CD"));
  SET_STRING_ELT(nms, 231, mkChar("parm_frac_E"));
  SET_STRING_ELT(nms, 232, mkChar("parm_frac_epTB"));
  SET_STRING_ELT(nms, 233, mkChar("parm_frac_L"));
  SET_STRING_ELT(nms, 234, mkChar("parm_frac_lpTB"));
  SET_STRING_ELT(nms, 235, mkChar("parm_frac_SD"));
  SET_STRING_ELT(nms, 236, mkChar("parm_frac_U"));
  SET_STRING_ELT(nms, 237, mkChar("parm_ifrac_ATT"));
  SET_STRING_ELT(nms, 238, mkChar("parm_ifrac_CD"));
  SET_STRING_ELT(nms, 239, mkChar("parm_ifrac_E"));
  SET_STRING_ELT(nms, 240, mkChar("parm_ifrac_epTB"));
  SET_STRING_ELT(nms, 241, mkChar("parm_ifrac_L"));
  SET_STRING_ELT(nms, 242, mkChar("parm_ifrac_lpTB"));
  SET_STRING_ELT(nms, 243, mkChar("parm_ifrac_prevTPT"));
  SET_STRING_ELT(nms, 244, mkChar("parm_ifrac_SD"));
  SET_STRING_ELT(nms, 245, mkChar("parm_ifrac_U"));
  SET_STRING_ELT(nms, 246, mkChar("parm_init_PPD"));
  SET_STRING_ELT(nms, 247, mkChar("ppop"));
  SET_STRING_ELT(nms, 248, mkChar("Preinfections"));
  SET_STRING_ELT(nms, 249, mkChar("previous_remand"));
  SET_STRING_ELT(nms, 250, mkChar("prg"));
  SET_STRING_ELT(nms, 251, mkChar("ptn"));
  SET_STRING_ELT(nms, 252, mkChar("qolrate"));
  SET_STRING_ELT(nms, 253, mkChar("reinfections"));
  SET_STRING_ELT(nms, 254, mkChar("rel"));
  SET_STRING_ELT(nms, 255, mkChar("relapses"));
  SET_STRING_ELT(nms, 256, mkChar("remand_long"));
  SET_STRING_ELT(nms, 257, mkChar("remand_release"));
  SET_STRING_ELT(nms, 258, mkChar("remand_short"));
  SET_STRING_ELT(nms, 259, mkChar("rfv"));
  SET_STRING_ELT(nms, 260, mkChar("selfcures"));
  SET_STRING_ELT(nms, 261, mkChar("short_open"));
  SET_STRING_ELT(nms, 262, mkChar("short_release"));
  SET_STRING_ELT(nms, 263, mkChar("slowprogs"));
  SET_STRING_ELT(nms, 264, mkChar("stabilizations"));
  SET_STRING_ELT(nms, 265, mkChar("staticfoi"));
  SET_STRING_ELT(nms, 266, mkChar("stb"));
  SET_STRING_ELT(nms, 267, mkChar("tbmort"));
  SET_STRING_ELT(nms, 268, mkChar("tbstops"));
  SET_STRING_ELT(nms, 269, mkChar("tpt_drn"));
  SET_STRING_ELT(nms, 270, mkChar("tpt_E"));
  SET_STRING_ELT(nms, 271, mkChar("tpt_epTB"));
  SET_STRING_ELT(nms, 272, mkChar("tpt_L"));
  SET_STRING_ELT(nms, 273, mkChar("tpt_lpTB"));
  SET_STRING_ELT(nms, 274, mkChar("TPT_mid"));
  SET_STRING_ELT(nms, 275, mkChar("TPT_top"));
  SET_STRING_ELT(nms, 276, mkChar("tptHR"));
  SET_STRING_ELT(nms, 277, mkChar("txf"));
  SET_STRING_ELT(nms, 278, mkChar("uc_attout"));
  SET_STRING_ELT(nms, 279, mkChar("uc_attppd"));
  SET_STRING_ELT(nms, 280, mkChar("uc_entry_att_L"));
  SET_STRING_ELT(nms, 281, mkChar("uc_entry_att_no"));
  SET_STRING_ELT(nms, 282, mkChar("uc_entry_att_TB"));
  SET_STRING_ELT(nms, 283, mkChar("uc_entry_notx_L"));
  SET_STRING_ELT(nms, 284, mkChar("uc_entry_notx_no"));
  SET_STRING_ELT(nms, 285, mkChar("uc_entry_notx_TB"));
  SET_STRING_ELT(nms, 286, mkChar("uc_entry_tpt_L"));
  SET_STRING_ELT(nms, 287, mkChar("uc_entry_tpt_no"));
  SET_STRING_ELT(nms, 288, mkChar("uc_entry_tpt_TB"));
  SET_STRING_ELT(nms, 289, mkChar("worsens"));
  SET_STRING_ELT(nms, 290, mkChar("wsn"));
...
SEXP tbmod0_metadata(SEXP internal_p) {
  ...
  SET_STRING_ELT(variable_names, 5, mkChar("dLYL"));
  SET_STRING_ELT(variable_names, 6, mkChar("deaths"));
  SET_STRING_ELT(variable_names, 7, mkChar("qoldec"));
  SET_STRING_ELT(variable_names, 8, mkChar("cases"));
  SET_STRING_ELT(variable_names, 9, mkChar("casesout"));
  SET_STRING_ELT(variable_names, 10, mkChar("U"));
  SET_STRING_ELT(variable_names, 11, mkChar("E"));
  SET_STRING_ELT(variable_names, 12, mkChar("L"));
  SET_STRING_ELT(variable_names, 13, mkChar("SD"));
  SET_STRING_ELT(variable_names, 14, mkChar("CD"));
  SET_STRING_ELT(variable_names, 15, mkChar("ATT"));
  SET_STRING_ELT(variable_names, 16, mkChar("epTB"));
  SET_STRING_ELT(variable_names, 17, mkChar("lpTB"));
...
SEXP tbmod0_initial_conditions(SEXP internal_p, SEXP t_ptr) {
  tbmod0_internal *internal = tbmod0_get_internal(internal_p, 1);
  SEXP r_state = PROTECT(allocVector(REALSXP, internal->dim_ATT + internal->dim_CD + internal->dim_E + internal->dim_epTB + internal->dim_L + internal->dim_lpTB + internal->dim_SD + internal->dim_U + 10));
  ...
  state[5] = internal->initial_dLYL;
  state[6] = internal->initial_deaths;
  state[7] = internal->initial_qoldec;
  state[8] = internal->initial_cases;
  state[9] = internal->initial_casesout;
  memcpy(state + 10, internal->initial_U, internal->dim_U * sizeof(double));
...
void tbmod0_rhs(tbmod0_internal* internal, double t, double * state, double * dstatedt, double * output) {
  ...
  dstatedt[8] = ((odin_sum2(internal->fastprogs, 4, 5, 0, internal->NT, internal->dim_fastprogs_1) + odin_sum2(internal->slowprogs, 4, 5, 0, internal->NT, internal->dim_slowprogs_1) + odin_sum2(internal->relapses, 4, 5, 0, internal->NT, internal->dim_relapses_1)) * (internal->m - 1) + (odin_sum1(internal->fastprogs, 0, internal->dim_fastprogs) + odin_sum1(internal->slowprogs, 0, internal->dim_slowprogs) + odin_sum1(internal->relapses, 0, internal->dim_relapses))) * (t > internal->int_time ? 1 : 0);
  dstatedt[9] = ((odin_sum2(internal->fastprogs, 4, 5, 0, internal->NT, internal->dim_fastprogs_1) + odin_sum2(internal->slowprogs, 4, 5, 0, internal->NT, internal->dim_slowprogs_1) + odin_sum2(internal->relapses, 4, 5, 0, internal->NT, internal->dim_relapses_1)) * internal->m) * (t > internal->int_time ? 1 : 0);
  dstatedt[2] = (odin_sum1(internal->detects, 0, internal->dim_detects) + internal->inflow * (internal->parm_frac_SD + internal->parm_frac_CD) * inflow_toATT_TB) * (t > internal->int_time ? 1 : 0);
  ...
  dstatedt[4] = (odin_sum2(internal->ppop, 0, internal->dim_ppop_1, 1, 2, internal->dim_ppop_1) / (double) internal->tpt_drn) * (t > internal->int_time ? 1 : 0);
  dstatedt[6] = (odin_sum1(internal->tbmort, 0, internal->dim_tbmort) + (internal->m - 1) * odin_sum2(internal->tbmort, 4, 5, 0, internal->NT, internal->dim_tbmort_1)) * (t > internal->int_time ? 1 : 0);
  dstatedt[5] = (odin_sum1(internal->tbmort, 0, internal->dim_tbmort) + (internal->m - 1) * odin_sum2(internal->tbmort, 4, 5, 0, internal->NT, internal->dim_tbmort_1)) * (1 - exp(-(internal->disc_rate) * internal->LifeExp)) / (double) (internal->disc_rate + 1.0000000000000001e-15) * (t > internal->int_time ? exp(-((t - internal->int_time)) * internal->disc_rate) : 0);
  ...
  dstatedt[7] = (odin_sum1(internal->qolrate, 0, internal->dim_qolrate) + (internal->m - 1) * odin_sum2(internal->qolrate, 4, 5, 0, internal->NT, internal->dim_qolrate_1)) * (t > internal->int_time ? exp(-((t - internal->int_time)) * internal->disc_rate) : 0);
  ...
  for (int i = 1; i <= internal->dim_U_1; ++i) {
    for (int j = 1; j <= internal->dim_U_2; ++j) {
      dstatedt[10 + i - 1 + internal->dim_U_1 * (j - 1)] = -(internal->infections[internal->dim_infections_1 * (j - 1) + i - 1]) - internal->mort * U[internal->dim_U_1 * (j - 1) + i - 1] + internal->inflow * internal->frac_U[internal->dim_frac_U_1 * (j - 1) + i - 1] + internal->moves_U[internal->dim_moves_U_1 * (j - 1) + i - 1];
    }
  }
