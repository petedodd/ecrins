...
SEXP tbmod0_contents(SEXP internal_p) {
  ...
  SEXP contents = PROTECT(allocVector(VECSXP, 261));
  ...
  SET_VECTOR_ELT(contents, 156, hrv);
  ...
  SET_VECTOR_ELT(contents, 157, infections);
  SET_VECTOR_ELT(contents, 158, ScalarReal(internal->inflow));
  SET_VECTOR_ELT(contents, 159, ScalarReal(internal->inflow_toATT_TB0));
  SET_VECTOR_ELT(contents, 160, ScalarReal(internal->inflow_toATT_TB1));
  ...
  SET_VECTOR_ELT(contents, 161, inflow_top);
  SET_VECTOR_ELT(contents, 162, ScalarReal(internal->inflow_toTPT_L0));
  SET_VECTOR_ELT(contents, 163, ScalarReal(internal->inflow_toTPT_L1));
  ...
  SET_VECTOR_ELT(contents, 164, inflow_TPTv);
  ...
  SET_VECTOR_ELT(contents, 165, initial_ATT);
  SET_VECTOR_ELT(contents, 166, ScalarReal(internal->initial_cATTfp));
  SET_VECTOR_ELT(contents, 167, ScalarReal(internal->initial_cATTtp));
  SET_VECTOR_ELT(contents, 168, ScalarReal(internal->initial_CC));
  SET_VECTOR_ELT(contents, 169, ScalarReal(internal->initial_CC0));
  ...
  SET_VECTOR_ELT(contents, 170, initial_CD);
  SET_VECTOR_ELT(contents, 171, ScalarReal(internal->initial_cTPT));
  SET_VECTOR_ELT(contents, 172, ScalarReal(internal->initial_deaths));
  SET_VECTOR_ELT(contents, 173, ScalarReal(internal->initial_dLYL));
  ...
  SET_VECTOR_ELT(contents, 174, initial_E);
  ...
  SET_VECTOR_ELT(contents, 175, initial_epTB);
  ...
  SET_VECTOR_ELT(contents, 176, initial_L);
  ...
  SET_VECTOR_ELT(contents, 177, initial_lpTB);
  SET_VECTOR_ELT(contents, 178, ScalarReal(internal->initial_qoldec));
  ...
  SET_VECTOR_ELT(contents, 179, initial_SD);
  ...
  SET_VECTOR_ELT(contents, 180, initial_U);
  SET_VECTOR_ELT(contents, 181, ScalarReal(internal->int_time));
  SET_VECTOR_ELT(contents, 182, ScalarReal(internal->late_post_time));
  SET_VECTOR_ELT(contents, 183, ScalarReal(internal->LifeExp));
  SET_VECTOR_ELT(contents, 184, ScalarReal(internal->long_release));
  SET_VECTOR_ELT(contents, 185, ScalarReal(internal->long_short));
  ...
  SET_VECTOR_ELT(contents, 186, Lreinfections);
  SET_VECTOR_ELT(contents, 187, ScalarReal(internal->mHR));
  SET_VECTOR_ELT(contents, 188, ScalarReal(internal->mort));
  ...
  SET_VECTOR_ELT(contents, 189, moves_ATT);
  ...
  SET_VECTOR_ELT(contents, 190, moves_CD);
  ...
  SET_VECTOR_ELT(contents, 191, moves_E);
  ...
  SET_VECTOR_ELT(contents, 192, moves_epTB);
  ...
  SET_VECTOR_ELT(contents, 193, moves_L);
  ...
  SET_VECTOR_ELT(contents, 194, moves_lpTB);
  ...
  SET_VECTOR_ELT(contents, 195, moves_SD);
  ...
  SET_VECTOR_ELT(contents, 196, moves_U);
  ...
  SET_VECTOR_ELT(contents, 201, ScalarInteger(internal->offset_variable_E));
  SET_VECTOR_ELT(contents, 202, ScalarInteger(internal->offset_variable_epTB));
  SET_VECTOR_ELT(contents, 203, ScalarInteger(internal->offset_variable_L));
  SET_VECTOR_ELT(contents, 204, ScalarInteger(internal->offset_variable_lpTB));
  SET_VECTOR_ELT(contents, 205, ScalarInteger(internal->offset_variable_SD));
  SET_VECTOR_ELT(contents, 206, ScalarReal(internal->open_release));
  SET_VECTOR_ELT(contents, 207, ScalarReal(internal->parm_frac_ATT));
  SET_VECTOR_ELT(contents, 208, ScalarReal(internal->parm_frac_CD));
  SET_VECTOR_ELT(contents, 209, ScalarReal(internal->parm_frac_E));
  SET_VECTOR_ELT(contents, 210, ScalarReal(internal->parm_frac_epTB));
  SET_VECTOR_ELT(contents, 211, ScalarReal(internal->parm_frac_L));
  SET_VECTOR_ELT(contents, 212, ScalarReal(internal->parm_frac_lpTB));
  SET_VECTOR_ELT(contents, 213, ScalarReal(internal->parm_frac_SD));
  SET_VECTOR_ELT(contents, 214, ScalarReal(internal->parm_frac_U));
  SET_VECTOR_ELT(contents, 215, ScalarReal(internal->parm_ifrac_ATT));
  SET_VECTOR_ELT(contents, 216, ScalarReal(internal->parm_ifrac_CD));
  SET_VECTOR_ELT(contents, 217, ScalarReal(internal->parm_ifrac_E));
  SET_VECTOR_ELT(contents, 218, ScalarReal(internal->parm_ifrac_epTB));
  SET_VECTOR_ELT(contents, 219, ScalarReal(internal->parm_ifrac_L));
  SET_VECTOR_ELT(contents, 220, ScalarReal(internal->parm_ifrac_lpTB));
  ...
  SET_VECTOR_ELT(contents, 221, parm_ifrac_prevTPT);
  SET_VECTOR_ELT(contents, 222, ScalarReal(internal->parm_ifrac_SD));
  SET_VECTOR_ELT(contents, 223, ScalarReal(internal->parm_ifrac_U));
  ...
  SET_VECTOR_ELT(contents, 224, parm_init_PPD);
  ...
  SET_VECTOR_ELT(contents, 225, ppop);
  ...
  SET_VECTOR_ELT(contents, 226, Preinfections);
  SET_VECTOR_ELT(contents, 227, ScalarReal(internal->previous_remand));
  SET_VECTOR_ELT(contents, 228, ScalarReal(internal->prg));
  SET_VECTOR_ELT(contents, 229, ScalarReal(internal->ptn));
  ...
  SET_VECTOR_ELT(contents, 230, reinfections);
  SET_VECTOR_ELT(contents, 231, ScalarReal(internal->rel));
  ...
  SET_VECTOR_ELT(contents, 232, relapses);
  SET_VECTOR_ELT(contents, 233, ScalarReal(internal->remand_long));
  SET_VECTOR_ELT(contents, 234, ScalarReal(internal->remand_release));
  SET_VECTOR_ELT(contents, 235, ScalarReal(internal->remand_short));
  SEXP rfv = PROTECT(allocVector(REALSXP, internal->dim_rfv));
  memcpy(REAL(rfv), internal->rfv, internal->dim_rfv * sizeof(double));
  SET_VECTOR_ELT(contents, 236, rfv);
  ...
  SET_VECTOR_ELT(contents, 237, selfcures);
  SET_VECTOR_ELT(contents, 238, ScalarReal(internal->short_open));
  SET_VECTOR_ELT(contents, 239, ScalarReal(internal->short_release));
  ...
  SET_VECTOR_ELT(contents, 240, slowprogs);
  ...
  SET_VECTOR_ELT(contents, 241, stabilizations);
  SET_VECTOR_ELT(contents, 242, ScalarReal(internal->staticfoi));
  SET_VECTOR_ELT(contents, 243, ScalarReal(internal->stb));
  ...
  SET_VECTOR_ELT(contents, 244, tbmort);
  ...
  SET_VECTOR_ELT(contents, 245, tbstops);
  SET_VECTOR_ELT(contents, 246, ScalarReal(internal->tpt_drn));
  ...
  SET_VECTOR_ELT(contents, 247, tpt_E);
  ...
  SET_VECTOR_ELT(contents, 248, tpt_epTB);
  ...
  SET_VECTOR_ELT(contents, 249, tpt_L);
  ...
  SET_VECTOR_ELT(contents, 250, tpt_lpTB);
  ...
  SET_VECTOR_ELT(contents, 251, TPT_top);
  SET_VECTOR_ELT(contents, 252, ScalarReal(internal->tptHR));
  SET_VECTOR_ELT(contents, 253, ScalarReal(internal->txf));
  SET_VECTOR_ELT(contents, 254, ScalarReal(internal->uc_attout));
  SET_VECTOR_ELT(contents, 255, ScalarReal(internal->uc_attppd));
  SET_VECTOR_ELT(contents, 256, ScalarReal(internal->uc_attscreen));
  SET_VECTOR_ELT(contents, 257, ScalarReal(internal->uc_screening));
  SET_VECTOR_ELT(contents, 258, ScalarReal(internal->uc_tpt));
  ...
  SET_VECTOR_ELT(contents, 259, worsens);
  SET_VECTOR_ELT(contents, 260, ScalarReal(internal->wsn));
  SEXP nms = PROTECT(allocVector(STRSXP, 261));
  ...
  SET_STRING_ELT(nms, 156, mkChar("hrv"));
  SET_STRING_ELT(nms, 157, mkChar("infections"));
  SET_STRING_ELT(nms, 158, mkChar("inflow"));
  SET_STRING_ELT(nms, 159, mkChar("inflow_toATT_TB0"));
  SET_STRING_ELT(nms, 160, mkChar("inflow_toATT_TB1"));
  SET_STRING_ELT(nms, 161, mkChar("inflow_top"));
  SET_STRING_ELT(nms, 162, mkChar("inflow_toTPT_L0"));
  SET_STRING_ELT(nms, 163, mkChar("inflow_toTPT_L1"));
  SET_STRING_ELT(nms, 164, mkChar("inflow_TPTv"));
  SET_STRING_ELT(nms, 165, mkChar("initial_ATT"));
  SET_STRING_ELT(nms, 166, mkChar("initial_cATTfp"));
  SET_STRING_ELT(nms, 167, mkChar("initial_cATTtp"));
  SET_STRING_ELT(nms, 168, mkChar("initial_CC"));
  SET_STRING_ELT(nms, 169, mkChar("initial_CC0"));
  SET_STRING_ELT(nms, 170, mkChar("initial_CD"));
  SET_STRING_ELT(nms, 171, mkChar("initial_cTPT"));
  SET_STRING_ELT(nms, 172, mkChar("initial_deaths"));
  SET_STRING_ELT(nms, 173, mkChar("initial_dLYL"));
  SET_STRING_ELT(nms, 174, mkChar("initial_E"));
  SET_STRING_ELT(nms, 175, mkChar("initial_epTB"));
  SET_STRING_ELT(nms, 176, mkChar("initial_L"));
  SET_STRING_ELT(nms, 177, mkChar("initial_lpTB"));
  SET_STRING_ELT(nms, 178, mkChar("initial_qoldec"));
  SET_STRING_ELT(nms, 179, mkChar("initial_SD"));
  SET_STRING_ELT(nms, 180, mkChar("initial_U"));
  SET_STRING_ELT(nms, 181, mkChar("int_time"));
  SET_STRING_ELT(nms, 182, mkChar("late_post_time"));
  SET_STRING_ELT(nms, 183, mkChar("LifeExp"));
  SET_STRING_ELT(nms, 184, mkChar("long_release"));
  SET_STRING_ELT(nms, 185, mkChar("long_short"));
  SET_STRING_ELT(nms, 186, mkChar("Lreinfections"));
  SET_STRING_ELT(nms, 187, mkChar("mHR"));
  SET_STRING_ELT(nms, 188, mkChar("mort"));
  SET_STRING_ELT(nms, 189, mkChar("moves_ATT"));
  SET_STRING_ELT(nms, 190, mkChar("moves_CD"));
  SET_STRING_ELT(nms, 191, mkChar("moves_E"));
  SET_STRING_ELT(nms, 192, mkChar("moves_epTB"));
  SET_STRING_ELT(nms, 193, mkChar("moves_L"));
  SET_STRING_ELT(nms, 194, mkChar("moves_lpTB"));
  SET_STRING_ELT(nms, 195, mkChar("moves_SD"));
  SET_STRING_ELT(nms, 196, mkChar("moves_U"));
  ...
  SET_STRING_ELT(nms, 201, mkChar("offset_variable_E"));
  SET_STRING_ELT(nms, 202, mkChar("offset_variable_epTB"));
  SET_STRING_ELT(nms, 203, mkChar("offset_variable_L"));
  SET_STRING_ELT(nms, 204, mkChar("offset_variable_lpTB"));
  SET_STRING_ELT(nms, 205, mkChar("offset_variable_SD"));
  SET_STRING_ELT(nms, 206, mkChar("open_release"));
  SET_STRING_ELT(nms, 207, mkChar("parm_frac_ATT"));
  SET_STRING_ELT(nms, 208, mkChar("parm_frac_CD"));
  SET_STRING_ELT(nms, 209, mkChar("parm_frac_E"));
  SET_STRING_ELT(nms, 210, mkChar("parm_frac_epTB"));
  SET_STRING_ELT(nms, 211, mkChar("parm_frac_L"));
  SET_STRING_ELT(nms, 212, mkChar("parm_frac_lpTB"));
  SET_STRING_ELT(nms, 213, mkChar("parm_frac_SD"));
  SET_STRING_ELT(nms, 214, mkChar("parm_frac_U"));
  SET_STRING_ELT(nms, 215, mkChar("parm_ifrac_ATT"));
  SET_STRING_ELT(nms, 216, mkChar("parm_ifrac_CD"));
  SET_STRING_ELT(nms, 217, mkChar("parm_ifrac_E"));
  SET_STRING_ELT(nms, 218, mkChar("parm_ifrac_epTB"));
  SET_STRING_ELT(nms, 219, mkChar("parm_ifrac_L"));
  SET_STRING_ELT(nms, 220, mkChar("parm_ifrac_lpTB"));
  SET_STRING_ELT(nms, 221, mkChar("parm_ifrac_prevTPT"));
  SET_STRING_ELT(nms, 222, mkChar("parm_ifrac_SD"));
  SET_STRING_ELT(nms, 223, mkChar("parm_ifrac_U"));
  SET_STRING_ELT(nms, 224, mkChar("parm_init_PPD"));
  SET_STRING_ELT(nms, 225, mkChar("ppop"));
  SET_STRING_ELT(nms, 226, mkChar("Preinfections"));
  SET_STRING_ELT(nms, 227, mkChar("previous_remand"));
  SET_STRING_ELT(nms, 228, mkChar("prg"));
  SET_STRING_ELT(nms, 229, mkChar("ptn"));
  SET_STRING_ELT(nms, 230, mkChar("reinfections"));
  SET_STRING_ELT(nms, 231, mkChar("rel"));
  SET_STRING_ELT(nms, 232, mkChar("relapses"));
  SET_STRING_ELT(nms, 233, mkChar("remand_long"));
  SET_STRING_ELT(nms, 234, mkChar("remand_release"));
  SET_STRING_ELT(nms, 235, mkChar("remand_short"));
  SET_STRING_ELT(nms, 236, mkChar("rfv"));
  SET_STRING_ELT(nms, 237, mkChar("selfcures"));
  SET_STRING_ELT(nms, 238, mkChar("short_open"));
  SET_STRING_ELT(nms, 239, mkChar("short_release"));
  SET_STRING_ELT(nms, 240, mkChar("slowprogs"));
  SET_STRING_ELT(nms, 241, mkChar("stabilizations"));
  SET_STRING_ELT(nms, 242, mkChar("staticfoi"));
  SET_STRING_ELT(nms, 243, mkChar("stb"));
  SET_STRING_ELT(nms, 244, mkChar("tbmort"));
  SET_STRING_ELT(nms, 245, mkChar("tbstops"));
  SET_STRING_ELT(nms, 246, mkChar("tpt_drn"));
  SET_STRING_ELT(nms, 247, mkChar("tpt_E"));
  SET_STRING_ELT(nms, 248, mkChar("tpt_epTB"));
  SET_STRING_ELT(nms, 249, mkChar("tpt_L"));
  SET_STRING_ELT(nms, 250, mkChar("tpt_lpTB"));
  SET_STRING_ELT(nms, 251, mkChar("TPT_top"));
  SET_STRING_ELT(nms, 252, mkChar("tptHR"));
  SET_STRING_ELT(nms, 253, mkChar("txf"));
  SET_STRING_ELT(nms, 254, mkChar("uc_attout"));
  SET_STRING_ELT(nms, 255, mkChar("uc_attppd"));
  SET_STRING_ELT(nms, 256, mkChar("uc_attscreen"));
  SET_STRING_ELT(nms, 257, mkChar("uc_screening"));
  SET_STRING_ELT(nms, 258, mkChar("uc_tpt"));
  SET_STRING_ELT(nms, 259, mkChar("worsens"));
  SET_STRING_ELT(nms, 260, mkChar("wsn"));
...
void tbmod0_rhs(tbmod0_internal* internal, double t, double * state, double * dstatedt, double * output) {
  ...
  dstatedt[2] = 0;
  dstatedt[4] = 0;
  dstatedt[7] = internal->hrqol * odin_sum1(CD, 0, internal->dim_CD) * (t > internal->int_time ? exp(-((t - internal->int_time)) * internal->disc_rate) : 0);
