...
SEXP tbmod0_create(SEXP user) {
  ...
  internal->uc_attscreen = 1;
  internal->uc_screening = 1;
  internal->uc_tpt = 1;
...
SEXP tbmod0_contents(SEXP internal_p) {
  ...
  SET_VECTOR_ELT(contents, 137, ScalarInteger(internal->dim_TPT_top));
  SET_VECTOR_ELT(contents, 138, ScalarInteger(internal->dim_U));
  SET_VECTOR_ELT(contents, 139, ScalarInteger(internal->dim_U_1));
  SET_VECTOR_ELT(contents, 140, ScalarInteger(internal->dim_U_2));
  SET_VECTOR_ELT(contents, 141, ScalarInteger(internal->dim_worsens));
  SET_VECTOR_ELT(contents, 142, ScalarInteger(internal->dim_worsens_1));
  SET_VECTOR_ELT(contents, 143, ScalarInteger(internal->dim_worsens_2));
  SET_VECTOR_ELT(contents, 144, ScalarReal(internal->disc_rate));
  SET_VECTOR_ELT(contents, 145, ScalarReal(internal->drn));
  SET_VECTOR_ELT(contents, 146, ScalarReal(internal->eps));
  ...
  SET_VECTOR_ELT(contents, 147, Ereinfections);
  ...
  SET_VECTOR_ELT(contents, 148, fastprogs);
  SET_VECTOR_ELT(contents, 149, ScalarReal(internal->foi));
  ...
  SET_VECTOR_ELT(contents, 150, frac_ATT);
  ...
  SET_VECTOR_ELT(contents, 151, frac_CD);
  ...
  SET_VECTOR_ELT(contents, 152, frac_E);
  ...
  SET_VECTOR_ELT(contents, 153, frac_epTB);
  ...
  SET_VECTOR_ELT(contents, 154, frac_L);
  ...
  SET_VECTOR_ELT(contents, 155, frac_lpTB);
  ...
  SET_VECTOR_ELT(contents, 156, frac_SD);
  ...
  SET_VECTOR_ELT(contents, 157, frac_U);
  SET_VECTOR_ELT(contents, 158, ScalarReal(internal->hrqol));
  SET_VECTOR_ELT(contents, 159, ScalarReal(internal->hrqolptb));
  SEXP hrv = PROTECT(allocVector(REALSXP, internal->dim_hrv));
  memcpy(REAL(hrv), internal->hrv, internal->dim_hrv * sizeof(double));
  SET_VECTOR_ELT(contents, 160, hrv);
  ...
  SET_VECTOR_ELT(contents, 161, infections);
  SET_VECTOR_ELT(contents, 162, ScalarReal(internal->inflow));
  SET_VECTOR_ELT(contents, 163, ScalarReal(internal->inflow_toATT_TB0));
  SET_VECTOR_ELT(contents, 164, ScalarReal(internal->inflow_toATT_TB1));
  ...
  SET_VECTOR_ELT(contents, 165, inflow_top);
  SET_VECTOR_ELT(contents, 166, ScalarReal(internal->inflow_toTPT_L0));
  SET_VECTOR_ELT(contents, 167, ScalarReal(internal->inflow_toTPT_L1));
  ...
  SET_VECTOR_ELT(contents, 168, inflow_TPTv);
  ...
  SET_VECTOR_ELT(contents, 169, initial_ATT);
  SET_VECTOR_ELT(contents, 170, ScalarReal(internal->initial_cATTfp));
  SET_VECTOR_ELT(contents, 171, ScalarReal(internal->initial_cATTtp));
  SET_VECTOR_ELT(contents, 172, ScalarReal(internal->initial_CC));
  SET_VECTOR_ELT(contents, 173, ScalarReal(internal->initial_CC0));
  ...
  SET_VECTOR_ELT(contents, 174, initial_CD);
  SET_VECTOR_ELT(contents, 175, ScalarReal(internal->initial_cTPT));
  SET_VECTOR_ELT(contents, 176, ScalarReal(internal->initial_deaths));
  SET_VECTOR_ELT(contents, 177, ScalarReal(internal->initial_dLYL));
  ...
  SET_VECTOR_ELT(contents, 178, initial_E);
  ...
  SET_VECTOR_ELT(contents, 179, initial_epTB);
  ...
  SET_VECTOR_ELT(contents, 180, initial_L);
  ...
  SET_VECTOR_ELT(contents, 181, initial_lpTB);
  SET_VECTOR_ELT(contents, 182, ScalarReal(internal->initial_qoldec));
  ...
  SET_VECTOR_ELT(contents, 183, initial_SD);
  ...
  SET_VECTOR_ELT(contents, 184, initial_U);
  SET_VECTOR_ELT(contents, 185, ScalarReal(internal->int_time));
  SET_VECTOR_ELT(contents, 186, ScalarReal(internal->late_post_time));
  SET_VECTOR_ELT(contents, 187, ScalarReal(internal->LifeExp));
  SET_VECTOR_ELT(contents, 188, ScalarReal(internal->long_release));
  SET_VECTOR_ELT(contents, 189, ScalarReal(internal->long_short));
  ...
  SET_VECTOR_ELT(contents, 190, Lreinfections);
  SET_VECTOR_ELT(contents, 191, ScalarReal(internal->mHR));
  SET_VECTOR_ELT(contents, 192, ScalarReal(internal->mort));
  ...
  SET_VECTOR_ELT(contents, 193, moves_ATT);
  ...
  SET_VECTOR_ELT(contents, 194, moves_CD);
  ...
  SET_VECTOR_ELT(contents, 195, moves_E);
  ...
  SET_VECTOR_ELT(contents, 196, moves_epTB);
  ...
  SET_VECTOR_ELT(contents, 197, moves_L);
  ...
  SET_VECTOR_ELT(contents, 198, moves_lpTB);
  ...
  SET_VECTOR_ELT(contents, 199, moves_SD);
  ...
  SET_VECTOR_ELT(contents, 200, moves_U);
  SET_VECTOR_ELT(contents, 201, ScalarReal(internal->mult));
  SET_VECTOR_ELT(contents, 202, ScalarInteger(internal->NP));
  SET_VECTOR_ELT(contents, 203, ScalarInteger(internal->NT));
  SET_VECTOR_ELT(contents, 204, ScalarInteger(internal->offset_variable_ATT));
  SET_VECTOR_ELT(contents, 205, ScalarInteger(internal->offset_variable_CD));
  SET_VECTOR_ELT(contents, 206, ScalarInteger(internal->offset_variable_E));
  SET_VECTOR_ELT(contents, 207, ScalarInteger(internal->offset_variable_epTB));
  SET_VECTOR_ELT(contents, 208, ScalarInteger(internal->offset_variable_L));
  SET_VECTOR_ELT(contents, 209, ScalarInteger(internal->offset_variable_lpTB));
  SET_VECTOR_ELT(contents, 210, ScalarInteger(internal->offset_variable_SD));
  SET_VECTOR_ELT(contents, 211, ScalarReal(internal->open_release));
  SET_VECTOR_ELT(contents, 212, ScalarReal(internal->parm_frac_ATT));
  SET_VECTOR_ELT(contents, 213, ScalarReal(internal->parm_frac_CD));
  SET_VECTOR_ELT(contents, 214, ScalarReal(internal->parm_frac_E));
  SET_VECTOR_ELT(contents, 215, ScalarReal(internal->parm_frac_epTB));
  SET_VECTOR_ELT(contents, 216, ScalarReal(internal->parm_frac_L));
  SET_VECTOR_ELT(contents, 217, ScalarReal(internal->parm_frac_lpTB));
  SET_VECTOR_ELT(contents, 218, ScalarReal(internal->parm_frac_SD));
  SET_VECTOR_ELT(contents, 219, ScalarReal(internal->parm_frac_U));
  SET_VECTOR_ELT(contents, 220, ScalarReal(internal->parm_ifrac_ATT));
  SET_VECTOR_ELT(contents, 221, ScalarReal(internal->parm_ifrac_CD));
  SET_VECTOR_ELT(contents, 222, ScalarReal(internal->parm_ifrac_E));
  SET_VECTOR_ELT(contents, 223, ScalarReal(internal->parm_ifrac_epTB));
  SET_VECTOR_ELT(contents, 224, ScalarReal(internal->parm_ifrac_L));
  SET_VECTOR_ELT(contents, 225, ScalarReal(internal->parm_ifrac_lpTB));
  ...
  SET_VECTOR_ELT(contents, 226, parm_ifrac_prevTPT);
  SET_VECTOR_ELT(contents, 227, ScalarReal(internal->parm_ifrac_SD));
  SET_VECTOR_ELT(contents, 228, ScalarReal(internal->parm_ifrac_U));
  ...
  SET_VECTOR_ELT(contents, 229, parm_init_PPD);
  ...
  SET_VECTOR_ELT(contents, 230, ppop);
  ...
  SET_VECTOR_ELT(contents, 231, Preinfections);
  SET_VECTOR_ELT(contents, 232, ScalarReal(internal->previous_remand));
  SET_VECTOR_ELT(contents, 233, ScalarReal(internal->prg));
  SET_VECTOR_ELT(contents, 234, ScalarReal(internal->ptn));
  ...
  SET_VECTOR_ELT(contents, 235, qolrate);
  ...
  SET_VECTOR_ELT(contents, 236, reinfections);
  SET_VECTOR_ELT(contents, 237, ScalarReal(internal->rel));
  ...
  SET_VECTOR_ELT(contents, 238, relapses);
  SET_VECTOR_ELT(contents, 239, ScalarReal(internal->remand_long));
  SET_VECTOR_ELT(contents, 240, ScalarReal(internal->remand_release));
  SET_VECTOR_ELT(contents, 241, ScalarReal(internal->remand_short));
  SEXP rfv = PROTECT(allocVector(REALSXP, internal->dim_rfv));
  memcpy(REAL(rfv), internal->rfv, internal->dim_rfv * sizeof(double));
  SET_VECTOR_ELT(contents, 242, rfv);
  ...
  SET_VECTOR_ELT(contents, 243, selfcures);
  SET_VECTOR_ELT(contents, 244, ScalarReal(internal->short_open));
  SET_VECTOR_ELT(contents, 245, ScalarReal(internal->short_release));
  ...
  SET_VECTOR_ELT(contents, 246, slowprogs);
  ...
  SET_VECTOR_ELT(contents, 247, stabilizations);
  SET_VECTOR_ELT(contents, 248, ScalarReal(internal->staticfoi));
  SET_VECTOR_ELT(contents, 249, ScalarReal(internal->stb));
  ...
  SET_VECTOR_ELT(contents, 250, tbmort);
  ...
  SET_VECTOR_ELT(contents, 251, tbstops);
  SET_VECTOR_ELT(contents, 252, ScalarReal(internal->tpt_drn));
  ...
  SET_VECTOR_ELT(contents, 253, tpt_E);
  ...
  SET_VECTOR_ELT(contents, 254, tpt_epTB);
  ...
  SET_VECTOR_ELT(contents, 255, tpt_L);
  ...
  SET_VECTOR_ELT(contents, 256, tpt_lpTB);
  ...
  SET_VECTOR_ELT(contents, 257, TPT_top);
  SET_VECTOR_ELT(contents, 258, ScalarReal(internal->tptHR));
  SET_VECTOR_ELT(contents, 259, ScalarReal(internal->txf));
  SET_VECTOR_ELT(contents, 260, ScalarReal(internal->uc_attout));
  SET_VECTOR_ELT(contents, 261, ScalarReal(internal->uc_attppd));
  SET_VECTOR_ELT(contents, 262, ScalarReal(internal->uc_attscreen));
  SET_VECTOR_ELT(contents, 263, ScalarReal(internal->uc_screening));
  SET_VECTOR_ELT(contents, 264, ScalarReal(internal->uc_tpt));
  ...
  SET_VECTOR_ELT(contents, 265, worsens);
  SET_VECTOR_ELT(contents, 266, ScalarReal(internal->wsn));
  ...
  SET_STRING_ELT(nms, 137, mkChar("dim_TPT_top"));
  SET_STRING_ELT(nms, 138, mkChar("dim_U"));
  SET_STRING_ELT(nms, 139, mkChar("dim_U_1"));
  SET_STRING_ELT(nms, 140, mkChar("dim_U_2"));
  SET_STRING_ELT(nms, 141, mkChar("dim_worsens"));
  SET_STRING_ELT(nms, 142, mkChar("dim_worsens_1"));
  SET_STRING_ELT(nms, 143, mkChar("dim_worsens_2"));
  SET_STRING_ELT(nms, 144, mkChar("disc_rate"));
  SET_STRING_ELT(nms, 145, mkChar("drn"));
  SET_STRING_ELT(nms, 146, mkChar("eps"));
  SET_STRING_ELT(nms, 147, mkChar("Ereinfections"));
  SET_STRING_ELT(nms, 148, mkChar("fastprogs"));
  SET_STRING_ELT(nms, 149, mkChar("foi"));
  SET_STRING_ELT(nms, 150, mkChar("frac_ATT"));
  SET_STRING_ELT(nms, 151, mkChar("frac_CD"));
  SET_STRING_ELT(nms, 152, mkChar("frac_E"));
  SET_STRING_ELT(nms, 153, mkChar("frac_epTB"));
  SET_STRING_ELT(nms, 154, mkChar("frac_L"));
  SET_STRING_ELT(nms, 155, mkChar("frac_lpTB"));
  SET_STRING_ELT(nms, 156, mkChar("frac_SD"));
  SET_STRING_ELT(nms, 157, mkChar("frac_U"));
  SET_STRING_ELT(nms, 158, mkChar("hrqol"));
  SET_STRING_ELT(nms, 159, mkChar("hrqolptb"));
  SET_STRING_ELT(nms, 160, mkChar("hrv"));
  SET_STRING_ELT(nms, 161, mkChar("infections"));
  SET_STRING_ELT(nms, 162, mkChar("inflow"));
  SET_STRING_ELT(nms, 163, mkChar("inflow_toATT_TB0"));
  SET_STRING_ELT(nms, 164, mkChar("inflow_toATT_TB1"));
  SET_STRING_ELT(nms, 165, mkChar("inflow_top"));
  SET_STRING_ELT(nms, 166, mkChar("inflow_toTPT_L0"));
  SET_STRING_ELT(nms, 167, mkChar("inflow_toTPT_L1"));
  SET_STRING_ELT(nms, 168, mkChar("inflow_TPTv"));
  SET_STRING_ELT(nms, 169, mkChar("initial_ATT"));
  SET_STRING_ELT(nms, 170, mkChar("initial_cATTfp"));
  SET_STRING_ELT(nms, 171, mkChar("initial_cATTtp"));
  SET_STRING_ELT(nms, 172, mkChar("initial_CC"));
  SET_STRING_ELT(nms, 173, mkChar("initial_CC0"));
  SET_STRING_ELT(nms, 174, mkChar("initial_CD"));
  SET_STRING_ELT(nms, 175, mkChar("initial_cTPT"));
  SET_STRING_ELT(nms, 176, mkChar("initial_deaths"));
  SET_STRING_ELT(nms, 177, mkChar("initial_dLYL"));
  SET_STRING_ELT(nms, 178, mkChar("initial_E"));
  SET_STRING_ELT(nms, 179, mkChar("initial_epTB"));
  SET_STRING_ELT(nms, 180, mkChar("initial_L"));
  SET_STRING_ELT(nms, 181, mkChar("initial_lpTB"));
  SET_STRING_ELT(nms, 182, mkChar("initial_qoldec"));
  SET_STRING_ELT(nms, 183, mkChar("initial_SD"));
  SET_STRING_ELT(nms, 184, mkChar("initial_U"));
  SET_STRING_ELT(nms, 185, mkChar("int_time"));
  SET_STRING_ELT(nms, 186, mkChar("late_post_time"));
  SET_STRING_ELT(nms, 187, mkChar("LifeExp"));
  SET_STRING_ELT(nms, 188, mkChar("long_release"));
  SET_STRING_ELT(nms, 189, mkChar("long_short"));
  SET_STRING_ELT(nms, 190, mkChar("Lreinfections"));
  SET_STRING_ELT(nms, 191, mkChar("mHR"));
  SET_STRING_ELT(nms, 192, mkChar("mort"));
  SET_STRING_ELT(nms, 193, mkChar("moves_ATT"));
  SET_STRING_ELT(nms, 194, mkChar("moves_CD"));
  SET_STRING_ELT(nms, 195, mkChar("moves_E"));
  SET_STRING_ELT(nms, 196, mkChar("moves_epTB"));
  SET_STRING_ELT(nms, 197, mkChar("moves_L"));
  SET_STRING_ELT(nms, 198, mkChar("moves_lpTB"));
  SET_STRING_ELT(nms, 199, mkChar("moves_SD"));
  SET_STRING_ELT(nms, 200, mkChar("moves_U"));
  SET_STRING_ELT(nms, 201, mkChar("mult"));
  SET_STRING_ELT(nms, 202, mkChar("NP"));
  SET_STRING_ELT(nms, 203, mkChar("NT"));
  SET_STRING_ELT(nms, 204, mkChar("offset_variable_ATT"));
  SET_STRING_ELT(nms, 205, mkChar("offset_variable_CD"));
  SET_STRING_ELT(nms, 206, mkChar("offset_variable_E"));
  SET_STRING_ELT(nms, 207, mkChar("offset_variable_epTB"));
  SET_STRING_ELT(nms, 208, mkChar("offset_variable_L"));
  SET_STRING_ELT(nms, 209, mkChar("offset_variable_lpTB"));
  SET_STRING_ELT(nms, 210, mkChar("offset_variable_SD"));
  SET_STRING_ELT(nms, 211, mkChar("open_release"));
  SET_STRING_ELT(nms, 212, mkChar("parm_frac_ATT"));
  SET_STRING_ELT(nms, 213, mkChar("parm_frac_CD"));
  SET_STRING_ELT(nms, 214, mkChar("parm_frac_E"));
  SET_STRING_ELT(nms, 215, mkChar("parm_frac_epTB"));
  SET_STRING_ELT(nms, 216, mkChar("parm_frac_L"));
  SET_STRING_ELT(nms, 217, mkChar("parm_frac_lpTB"));
  SET_STRING_ELT(nms, 218, mkChar("parm_frac_SD"));
  SET_STRING_ELT(nms, 219, mkChar("parm_frac_U"));
  SET_STRING_ELT(nms, 220, mkChar("parm_ifrac_ATT"));
  SET_STRING_ELT(nms, 221, mkChar("parm_ifrac_CD"));
  SET_STRING_ELT(nms, 222, mkChar("parm_ifrac_E"));
  SET_STRING_ELT(nms, 223, mkChar("parm_ifrac_epTB"));
  SET_STRING_ELT(nms, 224, mkChar("parm_ifrac_L"));
  SET_STRING_ELT(nms, 225, mkChar("parm_ifrac_lpTB"));
  SET_STRING_ELT(nms, 226, mkChar("parm_ifrac_prevTPT"));
  SET_STRING_ELT(nms, 227, mkChar("parm_ifrac_SD"));
  SET_STRING_ELT(nms, 228, mkChar("parm_ifrac_U"));
  SET_STRING_ELT(nms, 229, mkChar("parm_init_PPD"));
  SET_STRING_ELT(nms, 230, mkChar("ppop"));
  SET_STRING_ELT(nms, 231, mkChar("Preinfections"));
  SET_STRING_ELT(nms, 232, mkChar("previous_remand"));
  SET_STRING_ELT(nms, 233, mkChar("prg"));
  SET_STRING_ELT(nms, 234, mkChar("ptn"));
  SET_STRING_ELT(nms, 235, mkChar("qolrate"));
  SET_STRING_ELT(nms, 236, mkChar("reinfections"));
  SET_STRING_ELT(nms, 237, mkChar("rel"));
  SET_STRING_ELT(nms, 238, mkChar("relapses"));
  SET_STRING_ELT(nms, 239, mkChar("remand_long"));
  SET_STRING_ELT(nms, 240, mkChar("remand_release"));
  SET_STRING_ELT(nms, 241, mkChar("remand_short"));
  SET_STRING_ELT(nms, 242, mkChar("rfv"));
  SET_STRING_ELT(nms, 243, mkChar("selfcures"));
  SET_STRING_ELT(nms, 244, mkChar("short_open"));
  SET_STRING_ELT(nms, 245, mkChar("short_release"));
  SET_STRING_ELT(nms, 246, mkChar("slowprogs"));
  SET_STRING_ELT(nms, 247, mkChar("stabilizations"));
  SET_STRING_ELT(nms, 248, mkChar("staticfoi"));
  SET_STRING_ELT(nms, 249, mkChar("stb"));
  SET_STRING_ELT(nms, 250, mkChar("tbmort"));
  SET_STRING_ELT(nms, 251, mkChar("tbstops"));
  SET_STRING_ELT(nms, 252, mkChar("tpt_drn"));
  SET_STRING_ELT(nms, 253, mkChar("tpt_E"));
  SET_STRING_ELT(nms, 254, mkChar("tpt_epTB"));
  SET_STRING_ELT(nms, 255, mkChar("tpt_L"));
  SET_STRING_ELT(nms, 256, mkChar("tpt_lpTB"));
  SET_STRING_ELT(nms, 257, mkChar("TPT_top"));
  SET_STRING_ELT(nms, 258, mkChar("tptHR"));
  SET_STRING_ELT(nms, 259, mkChar("txf"));
  SET_STRING_ELT(nms, 260, mkChar("uc_attout"));
  SET_STRING_ELT(nms, 261, mkChar("uc_attppd"));
  SET_STRING_ELT(nms, 262, mkChar("uc_attscreen"));
  SET_STRING_ELT(nms, 263, mkChar("uc_screening"));
  SET_STRING_ELT(nms, 264, mkChar("uc_tpt"));
  SET_STRING_ELT(nms, 265, mkChar("worsens"));
  SET_STRING_ELT(nms, 266, mkChar("wsn"));
...
SEXP tbmod0_set_user(SEXP internal_p, SEXP user) {
  ...
  internal->mult = user_get_scalar_double(user, "mult", internal->mult, NA_REAL, NA_REAL);
  ...
  internal->uc_attscreen = user_get_scalar_double(user, "uc_attscreen", internal->uc_attscreen, NA_REAL, NA_REAL);
  internal->uc_screening = user_get_scalar_double(user, "uc_screening", internal->uc_screening, NA_REAL, NA_REAL);
  internal->uc_tpt = user_get_scalar_double(user, "uc_tpt", internal->uc_tpt, NA_REAL, NA_REAL);
...
void tbmod0_rhs(tbmod0_internal* internal, double t, double * state, double * dstatedt, double * output) {
  ...
  double att_frac = (internal->parm_frac_SD + internal->parm_frac_CD) * inflow_toATT_TB;
  double scr_frac = inflow_toTPT_L;
  double tpt_frac = (internal->parm_frac_E + internal->parm_frac_L + internal->parm_frac_epTB + internal->parm_frac_lpTB) * inflow_toTPT_L;
  {
     int i = 1;
  ...
  dstatedt[1] = ((internal->uc_screening * scr_frac + internal->uc_tpt * tpt_frac + internal->uc_attscreen * att_frac) * internal->inflow + internal->uc_attppd * odin_sum2(internal->detects, 0, 4, 0, internal->NT, internal->dim_detects_1) + internal->mult * internal->uc_attout * odin_sum2(internal->detects, 4, 5, 0, internal->NT, internal->dim_detects_1)) * (t > internal->int_time ? exp(-((t - internal->int_time)) * internal->disc_rate) : 0);
  dstatedt[0] = ((internal->uc_screening * scr_frac + internal->uc_tpt * tpt_frac + internal->uc_attscreen * att_frac) * internal->inflow + internal->uc_attppd * odin_sum2(internal->detects, 0, 4, 0, internal->NT, internal->dim_detects_1) + internal->mult * internal->uc_attout * odin_sum2(internal->detects, 4, 5, 0, internal->NT, internal->dim_detects_1)) * (t > internal->int_time ? 1 : 0);
  ...
  dstatedt[6] = (odin_sum1(internal->tbmort, 0, internal->dim_tbmort) + (internal->mult - 1) * odin_sum2(internal->tbmort, 4, 5, 0, internal->NT, internal->dim_tbmort_1)) * (t > internal->int_time ? 1 : 0);
  dstatedt[5] = (odin_sum1(internal->tbmort, 0, internal->dim_tbmort) + (internal->mult - 1) * odin_sum2(internal->tbmort, 4, 5, 0, internal->NT, internal->dim_tbmort_1)) * (1 - exp(-(internal->disc_rate) * internal->LifeExp)) / (double) (internal->disc_rate + 1.0000000000000001e-15) * (t > internal->int_time ? exp(-((t - internal->int_time)) * internal->disc_rate) : 0);
  ...
  dstatedt[7] = (odin_sum1(internal->qolrate, 0, internal->dim_qolrate) + (internal->mult - 1) * odin_sum2(internal->qolrate, 4, 5, 0, internal->NT, internal->dim_qolrate_1)) * (t > internal->int_time ? exp(-((t - internal->int_time)) * internal->disc_rate) : 0);
  ...
  if (output) {
    ...
    output[3] = (odin_sum2(internal->fastprogs, 4, 5, 0, internal->NT, internal->dim_fastprogs_1) + odin_sum2(internal->slowprogs, 4, 5, 0, internal->NT, internal->dim_slowprogs_1) + odin_sum2(internal->relapses, 4, 5, 0, internal->NT, internal->dim_relapses_1)) * (internal->mult - 1) + (odin_sum1(internal->fastprogs, 0, internal->dim_fastprogs) + odin_sum1(internal->slowprogs, 0, internal->dim_slowprogs) + odin_sum1(internal->relapses, 0, internal->dim_relapses));
    output[2] = (odin_sum2(internal->fastprogs, 4, 5, 0, internal->NT, internal->dim_fastprogs_1) + odin_sum2(internal->slowprogs, 4, 5, 0, internal->NT, internal->dim_slowprogs_1) + odin_sum2(internal->relapses, 4, 5, 0, internal->NT, internal->dim_relapses_1)) * internal->mult;
  }
}
void tbmod0_rhs_dde(size_t neq, double t, double * state, double * dstatedt, void * internal) {
