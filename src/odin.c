...
SEXP tbmod0_contents(SEXP internal_p) {
  ...
  SEXP contents = PROTECT(allocVector(VECSXP, 294));
  ...
  SET_VECTOR_ELT(contents, 97, ScalarInteger(internal->dim_qolrate));
  SET_VECTOR_ELT(contents, 98, ScalarInteger(internal->dim_qolrate_1));
  SET_VECTOR_ELT(contents, 99, ScalarInteger(internal->dim_qolrate_2));
  SET_VECTOR_ELT(contents, 100, ScalarInteger(internal->dim_reinfections));
  SET_VECTOR_ELT(contents, 101, ScalarInteger(internal->dim_reinfections_1));
  SET_VECTOR_ELT(contents, 102, ScalarInteger(internal->dim_reinfections_2));
  SET_VECTOR_ELT(contents, 103, ScalarInteger(internal->dim_relapses));
  SET_VECTOR_ELT(contents, 104, ScalarInteger(internal->dim_relapses_1));
  SET_VECTOR_ELT(contents, 105, ScalarInteger(internal->dim_relapses_2));
  SET_VECTOR_ELT(contents, 106, ScalarInteger(internal->dim_rfv));
  SET_VECTOR_ELT(contents, 107, ScalarInteger(internal->dim_SD));
  SET_VECTOR_ELT(contents, 108, ScalarInteger(internal->dim_SD_1));
  SET_VECTOR_ELT(contents, 109, ScalarInteger(internal->dim_SD_2));
  SET_VECTOR_ELT(contents, 110, ScalarInteger(internal->dim_selfcures));
  SET_VECTOR_ELT(contents, 111, ScalarInteger(internal->dim_selfcures_1));
  SET_VECTOR_ELT(contents, 112, ScalarInteger(internal->dim_selfcures_2));
  SET_VECTOR_ELT(contents, 113, ScalarInteger(internal->dim_slowprogs));
  SET_VECTOR_ELT(contents, 114, ScalarInteger(internal->dim_slowprogs_1));
  SET_VECTOR_ELT(contents, 115, ScalarInteger(internal->dim_slowprogs_2));
  SET_VECTOR_ELT(contents, 116, ScalarInteger(internal->dim_stabilizations));
  SET_VECTOR_ELT(contents, 117, ScalarInteger(internal->dim_stabilizations_1));
  SET_VECTOR_ELT(contents, 118, ScalarInteger(internal->dim_stabilizations_2));
  SET_VECTOR_ELT(contents, 119, ScalarInteger(internal->dim_tbmort));
  SET_VECTOR_ELT(contents, 120, ScalarInteger(internal->dim_tbmort_1));
  SET_VECTOR_ELT(contents, 121, ScalarInteger(internal->dim_tbmort_2));
  SET_VECTOR_ELT(contents, 122, ScalarInteger(internal->dim_tbstops));
  SET_VECTOR_ELT(contents, 123, ScalarInteger(internal->dim_tbstops_1));
  SET_VECTOR_ELT(contents, 124, ScalarInteger(internal->dim_tbstops_2));
  SET_VECTOR_ELT(contents, 125, ScalarInteger(internal->dim_tpt_E));
  SET_VECTOR_ELT(contents, 126, ScalarInteger(internal->dim_tpt_E_1));
  SET_VECTOR_ELT(contents, 127, ScalarInteger(internal->dim_tpt_E_2));
  SET_VECTOR_ELT(contents, 128, ScalarInteger(internal->dim_tpt_epTB));
  SET_VECTOR_ELT(contents, 129, ScalarInteger(internal->dim_tpt_epTB_1));
  SET_VECTOR_ELT(contents, 130, ScalarInteger(internal->dim_tpt_epTB_2));
  SET_VECTOR_ELT(contents, 131, ScalarInteger(internal->dim_tpt_L));
  SET_VECTOR_ELT(contents, 132, ScalarInteger(internal->dim_tpt_L_1));
  SET_VECTOR_ELT(contents, 133, ScalarInteger(internal->dim_tpt_L_2));
  SET_VECTOR_ELT(contents, 134, ScalarInteger(internal->dim_tpt_lpTB));
  SET_VECTOR_ELT(contents, 135, ScalarInteger(internal->dim_tpt_lpTB_1));
  SET_VECTOR_ELT(contents, 136, ScalarInteger(internal->dim_tpt_lpTB_2));
  SET_VECTOR_ELT(contents, 137, ScalarInteger(internal->dim_TPT_mid));
  SET_VECTOR_ELT(contents, 138, ScalarInteger(internal->dim_TPT_top));
  ...
  SET_VECTOR_ELT(contents, 142, ScalarInteger(internal->dim_worsens));
  SET_VECTOR_ELT(contents, 143, ScalarInteger(internal->dim_worsens_1));
  SET_VECTOR_ELT(contents, 144, ScalarInteger(internal->dim_worsens_2));
  SET_VECTOR_ELT(contents, 145, ScalarReal(internal->disc_rate));
  SET_VECTOR_ELT(contents, 146, ScalarReal(internal->drn));
  SET_VECTOR_ELT(contents, 147, ScalarReal(internal->eps));
  ...
  SET_VECTOR_ELT(contents, 148, Ereinfections);
  ...
  SET_VECTOR_ELT(contents, 149, fastprogs);
  SET_VECTOR_ELT(contents, 150, ScalarReal(internal->foi));
  ...
  SET_VECTOR_ELT(contents, 151, frac_ATT);
  ...
  SET_VECTOR_ELT(contents, 152, frac_CD);
  ...
  SET_VECTOR_ELT(contents, 153, frac_E);
  ...
  SET_VECTOR_ELT(contents, 154, frac_epTB);
  ...
  SET_VECTOR_ELT(contents, 155, frac_L);
  ...
  SET_VECTOR_ELT(contents, 156, frac_lpTB);
  ...
  SET_VECTOR_ELT(contents, 157, frac_SD);
  ...
  SET_VECTOR_ELT(contents, 158, frac_U);
  SET_VECTOR_ELT(contents, 159, ScalarReal(internal->hrqol));
  SET_VECTOR_ELT(contents, 160, ScalarReal(internal->hrqolptb));
  SEXP hrv = PROTECT(allocVector(REALSXP, internal->dim_hrv));
  memcpy(REAL(hrv), internal->hrv, internal->dim_hrv * sizeof(double));
  SET_VECTOR_ELT(contents, 161, hrv);
  ...
  SET_VECTOR_ELT(contents, 162, infections);
  SET_VECTOR_ELT(contents, 163, ScalarReal(internal->inflow));
  SET_VECTOR_ELT(contents, 164, ScalarReal(internal->inflow_notx_L0));
  SET_VECTOR_ELT(contents, 165, ScalarReal(internal->inflow_notx_L1));
  SET_VECTOR_ELT(contents, 166, ScalarReal(internal->inflow_notx_no0));
  SET_VECTOR_ELT(contents, 167, ScalarReal(internal->inflow_notx_no1));
  SET_VECTOR_ELT(contents, 168, ScalarReal(internal->inflow_notx_TB0));
  SET_VECTOR_ELT(contents, 169, ScalarReal(internal->inflow_notx_TB1));
  SET_VECTOR_ELT(contents, 170, ScalarReal(internal->inflow_toATT_L0));
  SET_VECTOR_ELT(contents, 171, ScalarReal(internal->inflow_toATT_L1));
  SET_VECTOR_ELT(contents, 172, ScalarReal(internal->inflow_toATT_no0));
  SET_VECTOR_ELT(contents, 173, ScalarReal(internal->inflow_toATT_no1));
  SET_VECTOR_ELT(contents, 174, ScalarReal(internal->inflow_toATT_TB0));
  SET_VECTOR_ELT(contents, 175, ScalarReal(internal->inflow_toATT_TB1));
  ...
  SET_VECTOR_ELT(contents, 176, inflow_top);
  SET_VECTOR_ELT(contents, 177, ScalarReal(internal->inflow_toTPT_L0));
  SET_VECTOR_ELT(contents, 178, ScalarReal(internal->inflow_toTPT_L1));
  SET_VECTOR_ELT(contents, 179, ScalarReal(internal->inflow_toTPT_no0));
  SET_VECTOR_ELT(contents, 180, ScalarReal(internal->inflow_toTPT_no1));
  SET_VECTOR_ELT(contents, 181, ScalarReal(internal->inflow_toTPT_TB0));
  SET_VECTOR_ELT(contents, 182, ScalarReal(internal->inflow_toTPT_TB1));
  ...
  SET_VECTOR_ELT(contents, 183, inflow_TPTv);
  ...
  SET_VECTOR_ELT(contents, 184, initial_ATT);
  SET_VECTOR_ELT(contents, 185, ScalarReal(internal->initial_cases));
  SET_VECTOR_ELT(contents, 186, ScalarReal(internal->initial_casesout));
  SET_VECTOR_ELT(contents, 187, ScalarReal(internal->initial_cATTfp));
  SET_VECTOR_ELT(contents, 188, ScalarReal(internal->initial_cATTtp));
  SET_VECTOR_ELT(contents, 189, ScalarReal(internal->initial_CC));
  SET_VECTOR_ELT(contents, 190, ScalarReal(internal->initial_CC0));
  SET_VECTOR_ELT(contents, 191, ScalarReal(internal->initial_CC0inflow));
  SET_VECTOR_ELT(contents, 192, ScalarReal(internal->initial_CC0inside));
  SET_VECTOR_ELT(contents, 193, ScalarReal(internal->initial_CC0outside));
  ...
  SET_VECTOR_ELT(contents, 194, initial_CD);
  SET_VECTOR_ELT(contents, 195, ScalarReal(internal->initial_cTPT));
  SET_VECTOR_ELT(contents, 196, ScalarReal(internal->initial_deaths));
  SET_VECTOR_ELT(contents, 197, ScalarReal(internal->initial_dLYL));
  ...
  SET_VECTOR_ELT(contents, 198, initial_E);
  ...
  SET_VECTOR_ELT(contents, 199, initial_epTB);
  ...
  SET_VECTOR_ELT(contents, 200, initial_L);
  ...
  SET_VECTOR_ELT(contents, 201, initial_lpTB);
  SET_VECTOR_ELT(contents, 202, ScalarReal(internal->initial_qoldec));
  ...
  SET_VECTOR_ELT(contents, 203, initial_SD);
  ...
  SET_VECTOR_ELT(contents, 204, initial_U);
  SET_VECTOR_ELT(contents, 205, ScalarReal(internal->int_time));
  SET_VECTOR_ELT(contents, 206, ScalarReal(internal->late_post_time));
  SET_VECTOR_ELT(contents, 207, ScalarReal(internal->LifeExp));
  SET_VECTOR_ELT(contents, 208, ScalarReal(internal->long_release));
  SET_VECTOR_ELT(contents, 209, ScalarReal(internal->long_short));
  ...
  SET_VECTOR_ELT(contents, 210, Lreinfections);
  SET_VECTOR_ELT(contents, 211, ScalarReal(internal->m));
  SET_VECTOR_ELT(contents, 212, ScalarReal(internal->mHR));
  SET_VECTOR_ELT(contents, 213, ScalarReal(internal->mort));
  ...
  SET_VECTOR_ELT(contents, 214, moves_ATT);
  ...
  SET_VECTOR_ELT(contents, 215, moves_CD);
  ...
  SET_VECTOR_ELT(contents, 216, moves_E);
  ...
  SET_VECTOR_ELT(contents, 217, moves_epTB);
  ...
  SET_VECTOR_ELT(contents, 218, moves_L);
  ...
  SET_VECTOR_ELT(contents, 219, moves_lpTB);
  ...
  SET_VECTOR_ELT(contents, 220, moves_SD);
  ...
  SET_VECTOR_ELT(contents, 221, moves_U);
  SET_VECTOR_ELT(contents, 222, ScalarInteger(internal->NP));
  SET_VECTOR_ELT(contents, 223, ScalarInteger(internal->NT));
  SET_VECTOR_ELT(contents, 224, ScalarInteger(internal->offset_variable_ATT));
  SET_VECTOR_ELT(contents, 225, ScalarInteger(internal->offset_variable_CD));
  SET_VECTOR_ELT(contents, 226, ScalarInteger(internal->offset_variable_E));
  SET_VECTOR_ELT(contents, 227, ScalarInteger(internal->offset_variable_epTB));
  SET_VECTOR_ELT(contents, 228, ScalarInteger(internal->offset_variable_L));
  SET_VECTOR_ELT(contents, 229, ScalarInteger(internal->offset_variable_lpTB));
  SET_VECTOR_ELT(contents, 230, ScalarInteger(internal->offset_variable_SD));
  SET_VECTOR_ELT(contents, 231, ScalarReal(internal->open_release));
  SET_VECTOR_ELT(contents, 232, ScalarReal(internal->parm_frac_ATT));
  SET_VECTOR_ELT(contents, 233, ScalarReal(internal->parm_frac_CD));
  SET_VECTOR_ELT(contents, 234, ScalarReal(internal->parm_frac_E));
  SET_VECTOR_ELT(contents, 235, ScalarReal(internal->parm_frac_epTB));
  SET_VECTOR_ELT(contents, 236, ScalarReal(internal->parm_frac_L));
  SET_VECTOR_ELT(contents, 237, ScalarReal(internal->parm_frac_lpTB));
  SET_VECTOR_ELT(contents, 238, ScalarReal(internal->parm_frac_SD));
  SET_VECTOR_ELT(contents, 239, ScalarReal(internal->parm_frac_U));
  SET_VECTOR_ELT(contents, 240, ScalarReal(internal->parm_ifrac_ATT));
  SET_VECTOR_ELT(contents, 241, ScalarReal(internal->parm_ifrac_CD));
  SET_VECTOR_ELT(contents, 242, ScalarReal(internal->parm_ifrac_E));
  SET_VECTOR_ELT(contents, 243, ScalarReal(internal->parm_ifrac_epTB));
  SET_VECTOR_ELT(contents, 244, ScalarReal(internal->parm_ifrac_L));
  SET_VECTOR_ELT(contents, 245, ScalarReal(internal->parm_ifrac_lpTB));
  ...
  SET_VECTOR_ELT(contents, 246, parm_ifrac_prevTPT);
  SET_VECTOR_ELT(contents, 247, ScalarReal(internal->parm_ifrac_SD));
  SET_VECTOR_ELT(contents, 248, ScalarReal(internal->parm_ifrac_U));
  ...
  SET_VECTOR_ELT(contents, 249, parm_init_PPD);
  ...
  SET_VECTOR_ELT(contents, 250, ppop);
  ...
  SET_VECTOR_ELT(contents, 251, Preinfections);
  SET_VECTOR_ELT(contents, 252, ScalarReal(internal->previous_remand));
  SET_VECTOR_ELT(contents, 253, ScalarReal(internal->prg));
  SET_VECTOR_ELT(contents, 254, ScalarReal(internal->ptn));
  ...
  SET_VECTOR_ELT(contents, 255, qolrate);
  ...
  SET_VECTOR_ELT(contents, 257, ScalarReal(internal->rel));
  ...
  SET_VECTOR_ELT(contents, 258, relapses);
  SET_VECTOR_ELT(contents, 259, ScalarReal(internal->remand_long));
  SET_VECTOR_ELT(contents, 260, ScalarReal(internal->remand_release));
  SET_VECTOR_ELT(contents, 261, ScalarReal(internal->remand_short));
  SEXP rfv = PROTECT(allocVector(REALSXP, internal->dim_rfv));
  memcpy(REAL(rfv), internal->rfv, internal->dim_rfv * sizeof(double));
  SET_VECTOR_ELT(contents, 262, rfv);
  ...
  SET_VECTOR_ELT(contents, 263, selfcures);
  SET_VECTOR_ELT(contents, 264, ScalarReal(internal->short_open));
  SET_VECTOR_ELT(contents, 265, ScalarReal(internal->short_release));
  ...
  SET_VECTOR_ELT(contents, 266, slowprogs);
  ...
  SET_VECTOR_ELT(contents, 267, stabilizations);
  SET_VECTOR_ELT(contents, 268, ScalarReal(internal->staticfoi));
  SET_VECTOR_ELT(contents, 269, ScalarReal(internal->stb));
  ...
  SET_VECTOR_ELT(contents, 270, tbmort);
  ...
  SET_VECTOR_ELT(contents, 271, tbstops);
  SET_VECTOR_ELT(contents, 272, ScalarReal(internal->tpt_drn));
  ...
  SET_VECTOR_ELT(contents, 273, tpt_E);
  ...
  SET_VECTOR_ELT(contents, 274, tpt_epTB);
  ...
  SET_VECTOR_ELT(contents, 275, tpt_L);
  ...
  SET_VECTOR_ELT(contents, 276, tpt_lpTB);
  ...
  SET_VECTOR_ELT(contents, 277, TPT_mid);
  ...
  SET_VECTOR_ELT(contents, 278, TPT_top);
  SET_VECTOR_ELT(contents, 279, ScalarReal(internal->tptHR));
  SET_VECTOR_ELT(contents, 280, ScalarReal(internal->txf));
  SET_VECTOR_ELT(contents, 281, ScalarReal(internal->uc_attout));
  SET_VECTOR_ELT(contents, 282, ScalarReal(internal->uc_attppd));
  SET_VECTOR_ELT(contents, 283, ScalarReal(internal->uc_entry_att_L));
  SET_VECTOR_ELT(contents, 284, ScalarReal(internal->uc_entry_att_no));
  SET_VECTOR_ELT(contents, 285, ScalarReal(internal->uc_entry_att_TB));
  SET_VECTOR_ELT(contents, 286, ScalarReal(internal->uc_entry_notx_L));
  SET_VECTOR_ELT(contents, 287, ScalarReal(internal->uc_entry_notx_no));
  SET_VECTOR_ELT(contents, 288, ScalarReal(internal->uc_entry_notx_TB));
  SET_VECTOR_ELT(contents, 289, ScalarReal(internal->uc_entry_tpt_L));
  SET_VECTOR_ELT(contents, 290, ScalarReal(internal->uc_entry_tpt_no));
  SET_VECTOR_ELT(contents, 291, ScalarReal(internal->uc_entry_tpt_TB));
  ...
  SET_VECTOR_ELT(contents, 292, worsens);
  SET_VECTOR_ELT(contents, 293, ScalarReal(internal->wsn));
  SEXP nms = PROTECT(allocVector(STRSXP, 294));
  ...
  SET_STRING_ELT(nms, 97, mkChar("dim_qolrate"));
  SET_STRING_ELT(nms, 98, mkChar("dim_qolrate_1"));
  SET_STRING_ELT(nms, 99, mkChar("dim_qolrate_2"));
  SET_STRING_ELT(nms, 100, mkChar("dim_reinfections"));
  SET_STRING_ELT(nms, 101, mkChar("dim_reinfections_1"));
  SET_STRING_ELT(nms, 102, mkChar("dim_reinfections_2"));
  SET_STRING_ELT(nms, 103, mkChar("dim_relapses"));
  SET_STRING_ELT(nms, 104, mkChar("dim_relapses_1"));
  SET_STRING_ELT(nms, 105, mkChar("dim_relapses_2"));
  SET_STRING_ELT(nms, 106, mkChar("dim_rfv"));
  SET_STRING_ELT(nms, 107, mkChar("dim_SD"));
  SET_STRING_ELT(nms, 108, mkChar("dim_SD_1"));
  SET_STRING_ELT(nms, 109, mkChar("dim_SD_2"));
  SET_STRING_ELT(nms, 110, mkChar("dim_selfcures"));
  SET_STRING_ELT(nms, 111, mkChar("dim_selfcures_1"));
  SET_STRING_ELT(nms, 112, mkChar("dim_selfcures_2"));
  SET_STRING_ELT(nms, 113, mkChar("dim_slowprogs"));
  SET_STRING_ELT(nms, 114, mkChar("dim_slowprogs_1"));
  SET_STRING_ELT(nms, 115, mkChar("dim_slowprogs_2"));
  SET_STRING_ELT(nms, 116, mkChar("dim_stabilizations"));
  SET_STRING_ELT(nms, 117, mkChar("dim_stabilizations_1"));
  SET_STRING_ELT(nms, 118, mkChar("dim_stabilizations_2"));
  SET_STRING_ELT(nms, 119, mkChar("dim_tbmort"));
  SET_STRING_ELT(nms, 120, mkChar("dim_tbmort_1"));
  SET_STRING_ELT(nms, 121, mkChar("dim_tbmort_2"));
  SET_STRING_ELT(nms, 122, mkChar("dim_tbstops"));
  SET_STRING_ELT(nms, 123, mkChar("dim_tbstops_1"));
  SET_STRING_ELT(nms, 124, mkChar("dim_tbstops_2"));
  SET_STRING_ELT(nms, 125, mkChar("dim_tpt_E"));
  SET_STRING_ELT(nms, 126, mkChar("dim_tpt_E_1"));
  SET_STRING_ELT(nms, 127, mkChar("dim_tpt_E_2"));
  SET_STRING_ELT(nms, 128, mkChar("dim_tpt_epTB"));
  SET_STRING_ELT(nms, 129, mkChar("dim_tpt_epTB_1"));
  SET_STRING_ELT(nms, 130, mkChar("dim_tpt_epTB_2"));
  SET_STRING_ELT(nms, 131, mkChar("dim_tpt_L"));
  SET_STRING_ELT(nms, 132, mkChar("dim_tpt_L_1"));
  SET_STRING_ELT(nms, 133, mkChar("dim_tpt_L_2"));
  SET_STRING_ELT(nms, 134, mkChar("dim_tpt_lpTB"));
  SET_STRING_ELT(nms, 135, mkChar("dim_tpt_lpTB_1"));
  SET_STRING_ELT(nms, 136, mkChar("dim_tpt_lpTB_2"));
  SET_STRING_ELT(nms, 137, mkChar("dim_TPT_mid"));
  SET_STRING_ELT(nms, 138, mkChar("dim_TPT_top"));
  SET_STRING_ELT(nms, 139, mkChar("dim_U"));
  SET_STRING_ELT(nms, 140, mkChar("dim_U_1"));
  SET_STRING_ELT(nms, 141, mkChar("dim_U_2"));
  SET_STRING_ELT(nms, 142, mkChar("dim_worsens"));
  SET_STRING_ELT(nms, 143, mkChar("dim_worsens_1"));
  SET_STRING_ELT(nms, 144, mkChar("dim_worsens_2"));
  SET_STRING_ELT(nms, 145, mkChar("disc_rate"));
  SET_STRING_ELT(nms, 146, mkChar("drn"));
  SET_STRING_ELT(nms, 147, mkChar("eps"));
  SET_STRING_ELT(nms, 148, mkChar("Ereinfections"));
  SET_STRING_ELT(nms, 149, mkChar("fastprogs"));
  SET_STRING_ELT(nms, 150, mkChar("foi"));
  SET_STRING_ELT(nms, 151, mkChar("frac_ATT"));
  SET_STRING_ELT(nms, 152, mkChar("frac_CD"));
  SET_STRING_ELT(nms, 153, mkChar("frac_E"));
  SET_STRING_ELT(nms, 154, mkChar("frac_epTB"));
  SET_STRING_ELT(nms, 155, mkChar("frac_L"));
  SET_STRING_ELT(nms, 156, mkChar("frac_lpTB"));
  SET_STRING_ELT(nms, 157, mkChar("frac_SD"));
  SET_STRING_ELT(nms, 158, mkChar("frac_U"));
  SET_STRING_ELT(nms, 159, mkChar("hrqol"));
  SET_STRING_ELT(nms, 160, mkChar("hrqolptb"));
  SET_STRING_ELT(nms, 161, mkChar("hrv"));
  SET_STRING_ELT(nms, 162, mkChar("infections"));
  SET_STRING_ELT(nms, 163, mkChar("inflow"));
  SET_STRING_ELT(nms, 164, mkChar("inflow_notx_L0"));
  SET_STRING_ELT(nms, 165, mkChar("inflow_notx_L1"));
  SET_STRING_ELT(nms, 166, mkChar("inflow_notx_no0"));
  SET_STRING_ELT(nms, 167, mkChar("inflow_notx_no1"));
  SET_STRING_ELT(nms, 168, mkChar("inflow_notx_TB0"));
  SET_STRING_ELT(nms, 169, mkChar("inflow_notx_TB1"));
  SET_STRING_ELT(nms, 170, mkChar("inflow_toATT_L0"));
  SET_STRING_ELT(nms, 171, mkChar("inflow_toATT_L1"));
  SET_STRING_ELT(nms, 172, mkChar("inflow_toATT_no0"));
  SET_STRING_ELT(nms, 173, mkChar("inflow_toATT_no1"));
  SET_STRING_ELT(nms, 174, mkChar("inflow_toATT_TB0"));
  SET_STRING_ELT(nms, 175, mkChar("inflow_toATT_TB1"));
  SET_STRING_ELT(nms, 176, mkChar("inflow_top"));
  SET_STRING_ELT(nms, 177, mkChar("inflow_toTPT_L0"));
  SET_STRING_ELT(nms, 178, mkChar("inflow_toTPT_L1"));
  SET_STRING_ELT(nms, 179, mkChar("inflow_toTPT_no0"));
  SET_STRING_ELT(nms, 180, mkChar("inflow_toTPT_no1"));
  SET_STRING_ELT(nms, 181, mkChar("inflow_toTPT_TB0"));
  SET_STRING_ELT(nms, 182, mkChar("inflow_toTPT_TB1"));
  SET_STRING_ELT(nms, 183, mkChar("inflow_TPTv"));
  SET_STRING_ELT(nms, 184, mkChar("initial_ATT"));
  SET_STRING_ELT(nms, 185, mkChar("initial_cases"));
  SET_STRING_ELT(nms, 186, mkChar("initial_casesout"));
  SET_STRING_ELT(nms, 187, mkChar("initial_cATTfp"));
  SET_STRING_ELT(nms, 188, mkChar("initial_cATTtp"));
  SET_STRING_ELT(nms, 189, mkChar("initial_CC"));
  SET_STRING_ELT(nms, 190, mkChar("initial_CC0"));
  SET_STRING_ELT(nms, 191, mkChar("initial_CC0inflow"));
  SET_STRING_ELT(nms, 192, mkChar("initial_CC0inside"));
  SET_STRING_ELT(nms, 193, mkChar("initial_CC0outside"));
  SET_STRING_ELT(nms, 194, mkChar("initial_CD"));
  SET_STRING_ELT(nms, 195, mkChar("initial_cTPT"));
  SET_STRING_ELT(nms, 196, mkChar("initial_deaths"));
  SET_STRING_ELT(nms, 197, mkChar("initial_dLYL"));
  SET_STRING_ELT(nms, 198, mkChar("initial_E"));
  SET_STRING_ELT(nms, 199, mkChar("initial_epTB"));
  SET_STRING_ELT(nms, 200, mkChar("initial_L"));
  SET_STRING_ELT(nms, 201, mkChar("initial_lpTB"));
  SET_STRING_ELT(nms, 202, mkChar("initial_qoldec"));
  SET_STRING_ELT(nms, 203, mkChar("initial_SD"));
  SET_STRING_ELT(nms, 204, mkChar("initial_U"));
  SET_STRING_ELT(nms, 205, mkChar("int_time"));
  SET_STRING_ELT(nms, 206, mkChar("late_post_time"));
  SET_STRING_ELT(nms, 207, mkChar("LifeExp"));
  SET_STRING_ELT(nms, 208, mkChar("long_release"));
  SET_STRING_ELT(nms, 209, mkChar("long_short"));
  SET_STRING_ELT(nms, 210, mkChar("Lreinfections"));
  SET_STRING_ELT(nms, 211, mkChar("m"));
  SET_STRING_ELT(nms, 212, mkChar("mHR"));
  SET_STRING_ELT(nms, 213, mkChar("mort"));
  SET_STRING_ELT(nms, 214, mkChar("moves_ATT"));
  SET_STRING_ELT(nms, 215, mkChar("moves_CD"));
  SET_STRING_ELT(nms, 216, mkChar("moves_E"));
  SET_STRING_ELT(nms, 217, mkChar("moves_epTB"));
  SET_STRING_ELT(nms, 218, mkChar("moves_L"));
  SET_STRING_ELT(nms, 219, mkChar("moves_lpTB"));
  SET_STRING_ELT(nms, 220, mkChar("moves_SD"));
  SET_STRING_ELT(nms, 221, mkChar("moves_U"));
  SET_STRING_ELT(nms, 222, mkChar("NP"));
  SET_STRING_ELT(nms, 223, mkChar("NT"));
  SET_STRING_ELT(nms, 224, mkChar("offset_variable_ATT"));
  SET_STRING_ELT(nms, 225, mkChar("offset_variable_CD"));
  SET_STRING_ELT(nms, 226, mkChar("offset_variable_E"));
  SET_STRING_ELT(nms, 227, mkChar("offset_variable_epTB"));
  SET_STRING_ELT(nms, 228, mkChar("offset_variable_L"));
  SET_STRING_ELT(nms, 229, mkChar("offset_variable_lpTB"));
  SET_STRING_ELT(nms, 230, mkChar("offset_variable_SD"));
  SET_STRING_ELT(nms, 231, mkChar("open_release"));
  SET_STRING_ELT(nms, 232, mkChar("parm_frac_ATT"));
  SET_STRING_ELT(nms, 233, mkChar("parm_frac_CD"));
  SET_STRING_ELT(nms, 234, mkChar("parm_frac_E"));
  SET_STRING_ELT(nms, 235, mkChar("parm_frac_epTB"));
  SET_STRING_ELT(nms, 236, mkChar("parm_frac_L"));
  SET_STRING_ELT(nms, 237, mkChar("parm_frac_lpTB"));
  SET_STRING_ELT(nms, 238, mkChar("parm_frac_SD"));
  SET_STRING_ELT(nms, 239, mkChar("parm_frac_U"));
  SET_STRING_ELT(nms, 240, mkChar("parm_ifrac_ATT"));
  SET_STRING_ELT(nms, 241, mkChar("parm_ifrac_CD"));
  SET_STRING_ELT(nms, 242, mkChar("parm_ifrac_E"));
  SET_STRING_ELT(nms, 243, mkChar("parm_ifrac_epTB"));
  SET_STRING_ELT(nms, 244, mkChar("parm_ifrac_L"));
  SET_STRING_ELT(nms, 245, mkChar("parm_ifrac_lpTB"));
  SET_STRING_ELT(nms, 246, mkChar("parm_ifrac_prevTPT"));
  SET_STRING_ELT(nms, 247, mkChar("parm_ifrac_SD"));
  SET_STRING_ELT(nms, 248, mkChar("parm_ifrac_U"));
  SET_STRING_ELT(nms, 249, mkChar("parm_init_PPD"));
  SET_STRING_ELT(nms, 250, mkChar("ppop"));
  SET_STRING_ELT(nms, 251, mkChar("Preinfections"));
  SET_STRING_ELT(nms, 252, mkChar("previous_remand"));
  SET_STRING_ELT(nms, 253, mkChar("prg"));
  SET_STRING_ELT(nms, 254, mkChar("ptn"));
  SET_STRING_ELT(nms, 255, mkChar("qolrate"));
  SET_STRING_ELT(nms, 256, mkChar("reinfections"));
  SET_STRING_ELT(nms, 257, mkChar("rel"));
  SET_STRING_ELT(nms, 258, mkChar("relapses"));
  SET_STRING_ELT(nms, 259, mkChar("remand_long"));
  SET_STRING_ELT(nms, 260, mkChar("remand_release"));
  SET_STRING_ELT(nms, 261, mkChar("remand_short"));
  SET_STRING_ELT(nms, 262, mkChar("rfv"));
  SET_STRING_ELT(nms, 263, mkChar("selfcures"));
  SET_STRING_ELT(nms, 264, mkChar("short_open"));
  SET_STRING_ELT(nms, 265, mkChar("short_release"));
  SET_STRING_ELT(nms, 266, mkChar("slowprogs"));
  SET_STRING_ELT(nms, 267, mkChar("stabilizations"));
  SET_STRING_ELT(nms, 268, mkChar("staticfoi"));
  SET_STRING_ELT(nms, 269, mkChar("stb"));
  SET_STRING_ELT(nms, 270, mkChar("tbmort"));
  SET_STRING_ELT(nms, 271, mkChar("tbstops"));
  SET_STRING_ELT(nms, 272, mkChar("tpt_drn"));
  SET_STRING_ELT(nms, 273, mkChar("tpt_E"));
  SET_STRING_ELT(nms, 274, mkChar("tpt_epTB"));
  SET_STRING_ELT(nms, 275, mkChar("tpt_L"));
  SET_STRING_ELT(nms, 276, mkChar("tpt_lpTB"));
  SET_STRING_ELT(nms, 277, mkChar("TPT_mid"));
  SET_STRING_ELT(nms, 278, mkChar("TPT_top"));
  SET_STRING_ELT(nms, 279, mkChar("tptHR"));
  SET_STRING_ELT(nms, 280, mkChar("txf"));
  SET_STRING_ELT(nms, 281, mkChar("uc_attout"));
  SET_STRING_ELT(nms, 282, mkChar("uc_attppd"));
  SET_STRING_ELT(nms, 283, mkChar("uc_entry_att_L"));
  SET_STRING_ELT(nms, 284, mkChar("uc_entry_att_no"));
  SET_STRING_ELT(nms, 285, mkChar("uc_entry_att_TB"));
  SET_STRING_ELT(nms, 286, mkChar("uc_entry_notx_L"));
  SET_STRING_ELT(nms, 287, mkChar("uc_entry_notx_no"));
  SET_STRING_ELT(nms, 288, mkChar("uc_entry_notx_TB"));
  SET_STRING_ELT(nms, 289, mkChar("uc_entry_tpt_L"));
  SET_STRING_ELT(nms, 290, mkChar("uc_entry_tpt_no"));
  SET_STRING_ELT(nms, 291, mkChar("uc_entry_tpt_TB"));
  SET_STRING_ELT(nms, 292, mkChar("worsens"));
  SET_STRING_ELT(nms, 293, mkChar("wsn"));
...
SEXP tbmod0_metadata(SEXP internal_p) {
  ...
  SEXP variable_length = PROTECT(allocVector(VECSXP, 21));
  SEXP variable_names = PROTECT(allocVector(STRSXP, 21));
...
SEXP tbmod0_initial_conditions(SEXP internal_p, SEXP t_ptr) {
  tbmod0_internal *internal = tbmod0_get_internal(internal_p, 1);
  SEXP r_state = PROTECT(allocVector(REALSXP, internal->dim_ATT + internal->dim_CD + internal->dim_E + internal->dim_epTB + internal->dim_L + internal->dim_lpTB + internal->dim_SD + internal->dim_U + 13));
