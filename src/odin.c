...
SEXP tbmod0_contents(SEXP internal_p) {
  ...
  SEXP contents = PROTECT(allocVector(VECSXP, 270));
  ...
  SET_VECTOR_ELT(contents, 163, ScalarReal(internal->inflow_LTBI));
  SET_VECTOR_ELT(contents, 164, ScalarReal(internal->inflow_rest));
  SET_VECTOR_ELT(contents, 165, ScalarReal(internal->inflow_TBD));
  SET_VECTOR_ELT(contents, 166, ScalarReal(internal->inflow_toATT_TB0));
  SET_VECTOR_ELT(contents, 167, ScalarReal(internal->inflow_toATT_TB1));
  ...
  SET_VECTOR_ELT(contents, 168, inflow_top);
  SET_VECTOR_ELT(contents, 169, ScalarReal(internal->inflow_toTPT_L0));
  SET_VECTOR_ELT(contents, 170, ScalarReal(internal->inflow_toTPT_L1));
  ...
  SET_VECTOR_ELT(contents, 171, inflow_TPTv);
  ...
  SET_VECTOR_ELT(contents, 172, initial_ATT);
  SET_VECTOR_ELT(contents, 173, ScalarReal(internal->initial_cATTfp));
  SET_VECTOR_ELT(contents, 174, ScalarReal(internal->initial_cATTtp));
  SET_VECTOR_ELT(contents, 175, ScalarReal(internal->initial_CC));
  SET_VECTOR_ELT(contents, 176, ScalarReal(internal->initial_CC0));
  ...
  SET_VECTOR_ELT(contents, 177, initial_CD);
  SET_VECTOR_ELT(contents, 178, ScalarReal(internal->initial_cTPT));
  SET_VECTOR_ELT(contents, 179, ScalarReal(internal->initial_deaths));
  SET_VECTOR_ELT(contents, 180, ScalarReal(internal->initial_dLYL));
  ...
  SET_VECTOR_ELT(contents, 181, initial_E);
  ...
  SET_VECTOR_ELT(contents, 182, initial_epTB);
  ...
  SET_VECTOR_ELT(contents, 183, initial_L);
  ...
  SET_VECTOR_ELT(contents, 184, initial_lpTB);
  SET_VECTOR_ELT(contents, 185, ScalarReal(internal->initial_qoldec));
  ...
  SET_VECTOR_ELT(contents, 186, initial_SD);
  ...
  SET_VECTOR_ELT(contents, 187, initial_U);
  SET_VECTOR_ELT(contents, 188, ScalarReal(internal->int_time));
  SET_VECTOR_ELT(contents, 189, ScalarReal(internal->late_post_time));
  SET_VECTOR_ELT(contents, 190, ScalarReal(internal->LifeExp));
  SET_VECTOR_ELT(contents, 191, ScalarReal(internal->long_release));
  SET_VECTOR_ELT(contents, 192, ScalarReal(internal->long_short));
  ...
  SET_VECTOR_ELT(contents, 193, Lreinfections);
  SET_VECTOR_ELT(contents, 194, ScalarReal(internal->m));
  SET_VECTOR_ELT(contents, 195, ScalarReal(internal->mHR));
  SET_VECTOR_ELT(contents, 196, ScalarReal(internal->mort));
  ...
  SET_VECTOR_ELT(contents, 197, moves_ATT);
  ...
  SET_VECTOR_ELT(contents, 198, moves_CD);
  ...
  SET_VECTOR_ELT(contents, 201, moves_L);
  ...
  SET_VECTOR_ELT(contents, 202, moves_lpTB);
  ...
  SET_VECTOR_ELT(contents, 203, moves_SD);
  ...
  SET_VECTOR_ELT(contents, 204, moves_U);
  SET_VECTOR_ELT(contents, 205, ScalarInteger(internal->NP));
  SET_VECTOR_ELT(contents, 206, ScalarInteger(internal->NT));
  SET_VECTOR_ELT(contents, 207, ScalarInteger(internal->offset_variable_ATT));
  SET_VECTOR_ELT(contents, 208, ScalarInteger(internal->offset_variable_CD));
  SET_VECTOR_ELT(contents, 209, ScalarInteger(internal->offset_variable_E));
  SET_VECTOR_ELT(contents, 210, ScalarInteger(internal->offset_variable_epTB));
  SET_VECTOR_ELT(contents, 211, ScalarInteger(internal->offset_variable_L));
  SET_VECTOR_ELT(contents, 212, ScalarInteger(internal->offset_variable_lpTB));
  SET_VECTOR_ELT(contents, 213, ScalarInteger(internal->offset_variable_SD));
  SET_VECTOR_ELT(contents, 214, ScalarReal(internal->open_release));
  SET_VECTOR_ELT(contents, 215, ScalarReal(internal->parm_frac_ATT));
  SET_VECTOR_ELT(contents, 216, ScalarReal(internal->parm_frac_CD));
  SET_VECTOR_ELT(contents, 217, ScalarReal(internal->parm_frac_E));
  SET_VECTOR_ELT(contents, 218, ScalarReal(internal->parm_frac_epTB));
  SET_VECTOR_ELT(contents, 219, ScalarReal(internal->parm_frac_L));
  SET_VECTOR_ELT(contents, 220, ScalarReal(internal->parm_frac_lpTB));
  SET_VECTOR_ELT(contents, 221, ScalarReal(internal->parm_frac_SD));
  SET_VECTOR_ELT(contents, 222, ScalarReal(internal->parm_frac_U));
  SET_VECTOR_ELT(contents, 223, ScalarReal(internal->parm_ifrac_ATT));
  SET_VECTOR_ELT(contents, 224, ScalarReal(internal->parm_ifrac_CD));
  SET_VECTOR_ELT(contents, 225, ScalarReal(internal->parm_ifrac_E));
  SET_VECTOR_ELT(contents, 226, ScalarReal(internal->parm_ifrac_epTB));
  SET_VECTOR_ELT(contents, 227, ScalarReal(internal->parm_ifrac_L));
  SET_VECTOR_ELT(contents, 228, ScalarReal(internal->parm_ifrac_lpTB));
  ...
  SET_VECTOR_ELT(contents, 229, parm_ifrac_prevTPT);
  SET_VECTOR_ELT(contents, 230, ScalarReal(internal->parm_ifrac_SD));
  SET_VECTOR_ELT(contents, 231, ScalarReal(internal->parm_ifrac_U));
  ...
  SET_VECTOR_ELT(contents, 232, parm_init_PPD);
  ...
  SET_VECTOR_ELT(contents, 233, ppop);
  ...
  SET_VECTOR_ELT(contents, 234, Preinfections);
  SET_VECTOR_ELT(contents, 235, ScalarReal(internal->previous_remand));
  SET_VECTOR_ELT(contents, 236, ScalarReal(internal->prg));
  SET_VECTOR_ELT(contents, 237, ScalarReal(internal->ptn));
  ...
  SET_VECTOR_ELT(contents, 238, qolrate);
  ...
  SET_VECTOR_ELT(contents, 239, reinfections);
  SET_VECTOR_ELT(contents, 240, ScalarReal(internal->rel));
  ...
  SET_VECTOR_ELT(contents, 241, relapses);
  SET_VECTOR_ELT(contents, 242, ScalarReal(internal->remand_long));
  SET_VECTOR_ELT(contents, 243, ScalarReal(internal->remand_release));
  SET_VECTOR_ELT(contents, 244, ScalarReal(internal->remand_short));
  SEXP rfv = PROTECT(allocVector(REALSXP, internal->dim_rfv));
  memcpy(REAL(rfv), internal->rfv, internal->dim_rfv * sizeof(double));
  SET_VECTOR_ELT(contents, 245, rfv);
  ...
  SET_VECTOR_ELT(contents, 251, ScalarReal(internal->staticfoi));
  SET_VECTOR_ELT(contents, 252, ScalarReal(internal->stb));
  ...
  SET_VECTOR_ELT(contents, 253, tbmort);
  ...
  SET_VECTOR_ELT(contents, 254, tbstops);
  SET_VECTOR_ELT(contents, 255, ScalarReal(internal->tpt_drn));
  ...
  SET_VECTOR_ELT(contents, 256, tpt_E);
  ...
  SET_VECTOR_ELT(contents, 257, tpt_epTB);
  ...
  SET_VECTOR_ELT(contents, 258, tpt_L);
  ...
  SET_VECTOR_ELT(contents, 259, tpt_lpTB);
  ...
  SET_VECTOR_ELT(contents, 260, TPT_top);
  SET_VECTOR_ELT(contents, 261, ScalarReal(internal->tptHR));
  SET_VECTOR_ELT(contents, 262, ScalarReal(internal->txf));
  SET_VECTOR_ELT(contents, 263, ScalarReal(internal->uc_attout));
  SET_VECTOR_ELT(contents, 264, ScalarReal(internal->uc_attppd));
  SET_VECTOR_ELT(contents, 265, ScalarReal(internal->uc_attscreen));
  SET_VECTOR_ELT(contents, 266, ScalarReal(internal->uc_screening));
  SET_VECTOR_ELT(contents, 267, ScalarReal(internal->uc_tpt));
  ...
  SET_VECTOR_ELT(contents, 268, worsens);
  SET_VECTOR_ELT(contents, 269, ScalarReal(internal->wsn));
  SEXP nms = PROTECT(allocVector(STRSXP, 270));
  ...
  SET_STRING_ELT(nms, 163, mkChar("inflow_LTBI"));
  SET_STRING_ELT(nms, 164, mkChar("inflow_rest"));
  SET_STRING_ELT(nms, 165, mkChar("inflow_TBD"));
  SET_STRING_ELT(nms, 166, mkChar("inflow_toATT_TB0"));
  SET_STRING_ELT(nms, 167, mkChar("inflow_toATT_TB1"));
  SET_STRING_ELT(nms, 168, mkChar("inflow_top"));
  SET_STRING_ELT(nms, 169, mkChar("inflow_toTPT_L0"));
  SET_STRING_ELT(nms, 170, mkChar("inflow_toTPT_L1"));
  SET_STRING_ELT(nms, 171, mkChar("inflow_TPTv"));
  SET_STRING_ELT(nms, 172, mkChar("initial_ATT"));
  SET_STRING_ELT(nms, 173, mkChar("initial_cATTfp"));
  SET_STRING_ELT(nms, 174, mkChar("initial_cATTtp"));
  SET_STRING_ELT(nms, 175, mkChar("initial_CC"));
  SET_STRING_ELT(nms, 176, mkChar("initial_CC0"));
  SET_STRING_ELT(nms, 177, mkChar("initial_CD"));
  SET_STRING_ELT(nms, 178, mkChar("initial_cTPT"));
  SET_STRING_ELT(nms, 179, mkChar("initial_deaths"));
  SET_STRING_ELT(nms, 180, mkChar("initial_dLYL"));
  SET_STRING_ELT(nms, 181, mkChar("initial_E"));
  SET_STRING_ELT(nms, 182, mkChar("initial_epTB"));
  SET_STRING_ELT(nms, 183, mkChar("initial_L"));
  SET_STRING_ELT(nms, 184, mkChar("initial_lpTB"));
  SET_STRING_ELT(nms, 185, mkChar("initial_qoldec"));
  SET_STRING_ELT(nms, 186, mkChar("initial_SD"));
  SET_STRING_ELT(nms, 187, mkChar("initial_U"));
  SET_STRING_ELT(nms, 188, mkChar("int_time"));
  SET_STRING_ELT(nms, 189, mkChar("late_post_time"));
  SET_STRING_ELT(nms, 190, mkChar("LifeExp"));
  SET_STRING_ELT(nms, 191, mkChar("long_release"));
  SET_STRING_ELT(nms, 192, mkChar("long_short"));
  SET_STRING_ELT(nms, 193, mkChar("Lreinfections"));
  SET_STRING_ELT(nms, 194, mkChar("m"));
  SET_STRING_ELT(nms, 195, mkChar("mHR"));
  SET_STRING_ELT(nms, 196, mkChar("mort"));
  SET_STRING_ELT(nms, 197, mkChar("moves_ATT"));
  SET_STRING_ELT(nms, 198, mkChar("moves_CD"));
  SET_STRING_ELT(nms, 199, mkChar("moves_E"));
  SET_STRING_ELT(nms, 200, mkChar("moves_epTB"));
  SET_STRING_ELT(nms, 201, mkChar("moves_L"));
  SET_STRING_ELT(nms, 202, mkChar("moves_lpTB"));
  SET_STRING_ELT(nms, 203, mkChar("moves_SD"));
  SET_STRING_ELT(nms, 204, mkChar("moves_U"));
  SET_STRING_ELT(nms, 205, mkChar("NP"));
  SET_STRING_ELT(nms, 206, mkChar("NT"));
  SET_STRING_ELT(nms, 207, mkChar("offset_variable_ATT"));
  SET_STRING_ELT(nms, 208, mkChar("offset_variable_CD"));
  SET_STRING_ELT(nms, 209, mkChar("offset_variable_E"));
  SET_STRING_ELT(nms, 210, mkChar("offset_variable_epTB"));
  SET_STRING_ELT(nms, 211, mkChar("offset_variable_L"));
  SET_STRING_ELT(nms, 212, mkChar("offset_variable_lpTB"));
  SET_STRING_ELT(nms, 213, mkChar("offset_variable_SD"));
  SET_STRING_ELT(nms, 214, mkChar("open_release"));
  SET_STRING_ELT(nms, 215, mkChar("parm_frac_ATT"));
  SET_STRING_ELT(nms, 216, mkChar("parm_frac_CD"));
  SET_STRING_ELT(nms, 217, mkChar("parm_frac_E"));
  SET_STRING_ELT(nms, 218, mkChar("parm_frac_epTB"));
  SET_STRING_ELT(nms, 219, mkChar("parm_frac_L"));
  SET_STRING_ELT(nms, 220, mkChar("parm_frac_lpTB"));
  SET_STRING_ELT(nms, 221, mkChar("parm_frac_SD"));
  SET_STRING_ELT(nms, 222, mkChar("parm_frac_U"));
  SET_STRING_ELT(nms, 223, mkChar("parm_ifrac_ATT"));
  SET_STRING_ELT(nms, 224, mkChar("parm_ifrac_CD"));
  SET_STRING_ELT(nms, 225, mkChar("parm_ifrac_E"));
  SET_STRING_ELT(nms, 226, mkChar("parm_ifrac_epTB"));
  SET_STRING_ELT(nms, 227, mkChar("parm_ifrac_L"));
  SET_STRING_ELT(nms, 228, mkChar("parm_ifrac_lpTB"));
  SET_STRING_ELT(nms, 229, mkChar("parm_ifrac_prevTPT"));
  SET_STRING_ELT(nms, 230, mkChar("parm_ifrac_SD"));
  SET_STRING_ELT(nms, 231, mkChar("parm_ifrac_U"));
  SET_STRING_ELT(nms, 232, mkChar("parm_init_PPD"));
  SET_STRING_ELT(nms, 233, mkChar("ppop"));
  SET_STRING_ELT(nms, 234, mkChar("Preinfections"));
  SET_STRING_ELT(nms, 235, mkChar("previous_remand"));
  SET_STRING_ELT(nms, 236, mkChar("prg"));
  SET_STRING_ELT(nms, 237, mkChar("ptn"));
  SET_STRING_ELT(nms, 238, mkChar("qolrate"));
  SET_STRING_ELT(nms, 239, mkChar("reinfections"));
  SET_STRING_ELT(nms, 240, mkChar("rel"));
  SET_STRING_ELT(nms, 241, mkChar("relapses"));
  SET_STRING_ELT(nms, 242, mkChar("remand_long"));
  SET_STRING_ELT(nms, 243, mkChar("remand_release"));
  SET_STRING_ELT(nms, 244, mkChar("remand_short"));
  SET_STRING_ELT(nms, 245, mkChar("rfv"));
  ...
  SET_STRING_ELT(nms, 251, mkChar("staticfoi"));
  SET_STRING_ELT(nms, 252, mkChar("stb"));
  SET_STRING_ELT(nms, 253, mkChar("tbmort"));
  SET_STRING_ELT(nms, 254, mkChar("tbstops"));
  SET_STRING_ELT(nms, 255, mkChar("tpt_drn"));
  SET_STRING_ELT(nms, 256, mkChar("tpt_E"));
  SET_STRING_ELT(nms, 257, mkChar("tpt_epTB"));
  SET_STRING_ELT(nms, 258, mkChar("tpt_L"));
  SET_STRING_ELT(nms, 259, mkChar("tpt_lpTB"));
  SET_STRING_ELT(nms, 260, mkChar("TPT_top"));
  SET_STRING_ELT(nms, 261, mkChar("tptHR"));
  SET_STRING_ELT(nms, 262, mkChar("txf"));
  SET_STRING_ELT(nms, 263, mkChar("uc_attout"));
  SET_STRING_ELT(nms, 264, mkChar("uc_attppd"));
  SET_STRING_ELT(nms, 265, mkChar("uc_attscreen"));
  SET_STRING_ELT(nms, 266, mkChar("uc_screening"));
  SET_STRING_ELT(nms, 267, mkChar("uc_tpt"));
  SET_STRING_ELT(nms, 268, mkChar("worsens"));
  SET_STRING_ELT(nms, 269, mkChar("wsn"));
...
SEXP tbmod0_set_user(SEXP internal_p, SEXP user) {
  ...
  internal->inflow_LTBI = (internal->parm_frac_E + internal->parm_frac_L + internal->parm_frac_epTB + internal->parm_frac_lpTB);
  internal->inflow_TBD = (internal->parm_frac_SD + internal->parm_frac_CD);
  {
     int i = 1;
     internal->hrv[i - 1] = 1;
  }
  ...
  internal->inflow_rest = (1 - internal->inflow_TBD - internal->inflow_LTBI - internal->parm_frac_ATT);
...
void tbmod0_rhs(tbmod0_internal* internal, double t, double * state, double * dstatedt, double * output) {
  ...
  dstatedt[1] = (((internal->uc_screening + internal->uc_tpt * internal->inflow_LTBI) * inflow_toTPT_L + internal->uc_attscreen * internal->inflow_TBD * inflow_toATT_TB) * internal->inflow + internal->uc_attppd * odin_sum2(internal->detects, 0, 4, 0, internal->NT, internal->dim_detects_1) + internal->m * internal->uc_attout * odin_sum2(internal->detects, 4, 5, 0, internal->NT, internal->dim_detects_1)) * (t > internal->int_time ? exp(-((t - internal->int_time)) * internal->disc_rate) : 0);
  dstatedt[0] = (((internal->uc_screening + internal->uc_tpt * internal->inflow_LTBI) * inflow_toTPT_L + internal->uc_attscreen * internal->inflow_TBD * inflow_toATT_TB) * internal->inflow + internal->uc_attppd * odin_sum2(internal->detects, 0, 4, 0, internal->NT, internal->dim_detects_1) + internal->m * internal->uc_attout * odin_sum2(internal->detects, 4, 5, 0, internal->NT, internal->dim_detects_1)) * (t > internal->int_time ? 1 : 0);
